...
const services = [
  ...
  { title: "Climatisation", href: "/climatisation", icon: <Wind className="w-4 h-4" /> },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-muted-foreground text-sm">(25 avis Google)</span>
              </div>
        ...
        <div className="py-6 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-muted-foreground text-sm">
              © 2025 <span className="font-semibold">ClimGO</span>. Tous droits réservés. • Spécialiste climatisation & chauffage Gironde & Landes
            </div>
