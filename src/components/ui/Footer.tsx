...
const services = [
  ...
  { title: "Eau chaude sanitaire", href: "/thermodynamique", icon: <Droplet className="w-4 h-4" /> },
  { title: "Dépannage", href: "/contact", icon: <FileText className="w-4 h-4" /> },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/pompe-a-chaleur" className="flex items-center justify-center md:justify-start space-x-3 text-sm hover:text-primary transition-colors">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
