...
export default function HeroSection({
  title = 'ClimGO',
  subtitle = "Installateur de pompe à chaleur\nChauffage & climatisation",
  ctaLabel = 'Devis',
  ctaHref = '/contact',
}: Props) {
  ...
  // Note: Les effets de scroll ont été temporairement désactivés pour éviter l'erreur d'hydratation
  // Ils pourront être réactivés plus tard avec une approche différente

  return (
    <section
      ref={ref}
      className="relative h-[90vh] min-h-[500px] sm:min-h-[600px] md:min-h-[640px] w-full overflow-hidden bg-white dark:bg-black text-black dark:text-white"
