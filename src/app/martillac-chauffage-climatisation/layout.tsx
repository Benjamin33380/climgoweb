...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'chauffage martillac', 'climatisation martillac', 'pompe à chaleur martillac',
    'chauffagiste martillac 33650', 'plombier chauffagiste martillac',
    
    // Services spécifiques
    'installation pompe à chaleur martillac', 'dépannage chauffage martillac',
    'entretien climatisation martillac', 'réparation PAC martillac',
    
    // Urgences
    'chauffagiste urgence martillac', 'dépannage 24h martillac',
    
    // Certifications
    'artisan RGE martillac', 'qualipac martillac'
  ].join(', '),
  ...
  openGraph: {
    ...
    url: 'https://climgo.fr/martillac-chauffage-climatisation',
  ...
  other: {
    ...
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://climgo.fr/martillac-chauffage-climatisation',
  ...
  alternates: {
    canonical: 'https://climgo.fr/martillac-chauffage-climatisation',
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Expert chauffage et climatisation à Martillac. Installation, dépannage et entretien de systèmes de chauffage et pompes à chaleur.",
              "url": "https://climgo.fr/martillac-chauffage-climatisation",
              ...
              "makesOffer": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Installation de pompes à chaleur air/eau et air/air à Martillac"
                  },
                  "price": "8000",
                  "priceCurrency": "EUR"
                },
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Service de dépannage chauffage 24h/7j à Martillac"
                  },
                  "price": "120",
                  "priceCurrency": "EUR"
                }
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Quel est le prix d'une pompe à chaleur à Martillac ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Le prix d'une pompe à chaleur à Martillac varie entre 8 000€ et 15 000€. ClimGO vous propose un devis gratuit et vous accompagne pour les aides financières."
                  }
                },
                {
                  "@type": "Question",
                  "name": "ClimGO intervient-il en urgence à Martillac ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO propose un service d'urgence 24h/7j à Martillac. Contactez-nous au 07 66 46 00 08 pour une intervention rapide."
                  }
                }
              ]
            })
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 3,
                  "name": "Martillac",
                  "item": "https://climgo.fr/martillac-chauffage-climatisation"
                }
              ]
            })
          }}
