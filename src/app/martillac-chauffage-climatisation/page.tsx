...
export default function Martillac() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Martillac - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Martillac, au cœur des vignes et de l'innovation viticole
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Située entre Bordeaux et les grands châteaux du Sud-Ouest</strong>, Martillac est une commune qui allie tradition et modernité.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nos installations de chauffage et de climatisation s'intègrent parfaitement à l'<strong className="text-gray-900 dark:text-white">architecture locale</strong>, que vous soyez dans le centre, proche du domaine de Cheval Blanc ou dans les zones pavillonnaires environnantes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Chaque intervention est pensée pour <strong className="text-gray-900 dark:text-white">optimiser le confort de votre logement</strong> tout en respectant le cadre résidentiel et les performances énergétiques exigées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nichée au cœur des <strong className="text-gray-900 dark:text-white">prestigieux vignobles des Graves</strong>, Martillac offre un cadre paisible et authentique à ses habitants.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située à seulement <strong className="text-gray-900 dark:text-white">20 minutes de Bordeaux</strong>, la ville séduit autant les amateurs de nature que les familles recherchant un environnement calme.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Martillac se développe autour d'un <strong className="text-gray-900 dark:text-white">tissu résidentiel varié</strong>, entre chais anciens rénovés, maisons traditionnelles et nouvelles zones pavillonnaires.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Vignobles Prestigieux</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Nichée au cœur des prestigieux vignobles des Graves, Martillac offre un cadre paisible et authentique. Située à 20 minutes de Bordeaux, elle séduit amateurs de nature et familles.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Tissu Résidentiel Varié</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Martillac se développe autour d'un tissu résidentiel varié : chais anciens rénovés, maisons traditionnelles et nouvelles zones pavillonnaires proches du centre ou du Château Smith Haut Lafitte.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Territoire Couvert</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Installations Sur Mesure</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Nos installations de chauffage et climatisation s'intègrent parfaitement à l'architecture locale. Chaque intervention optimise le confort tout en respectant le cadre résidentiel.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune viticole entre tradition et modernité
                    </h3>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples d'installations réalisées à Martillac
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Avenue de la Brède :</strong> installation PAC air/air dans maison en pierre avec isolation intérieure.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Lotissement Les Graves :</strong> pose plancher chauffant connecté avec pompe à chaleur air/eau.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Chemin des Vignes :</strong> remplacement chauffe-eau électrique par modèle thermodynamique nouvelle génération.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une expertise en phase avec le territoire martillacais
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Entre <strong className="text-gray-900 dark:text-white">humidité matinale des vignes et variations thermiques</strong>, nous adaptons nos installations aux exigences spécifiques du climat martillacais.
                      </p>
                      <p>
                        L'esthétique locale étant un enjeu majeur, nous privilégions des <strong className="text-gray-900 dark:text-white">installations sobres, efficaces et silencieuses</strong>, parfaitement intégrées aux façades typiques de la région.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Vous avez un projet à Martillac ?
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Que vous soyez <strong className="text-gray-900 dark:text-white">viticulteur, propriétaire d'un bien ancien ou acquéreur d'une maison neuve</strong>, ClimGO vous accompagne pour optimiser votre confort thermique.
                      </p>
                      <p>
                        Contactez-nous pour une <strong className="text-gray-900 dark:text-white">étude personnalisée sur Martillac et ses alentours</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Martillac ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Martillac - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4 group-hover:text-[#0ea5e9] dark:group-hover:text-[#38bdf8] transition-colors">
                    Acteur Local Réactif
                  </h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire appel à ClimGO à Martillac, c'est choisir un <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">acteur local réactif et expérimenté dans le confort thermique</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">Pompes à chaleur, climatisation, chauffe-eau</strong>… Nous adaptons chaque projet aux besoins du secteur résidentiel local.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité avec Martillac nous permet une <strong className="text-[#2563EB] dark:text-[#60A5FA]">rapidité d'intervention et un suivi optimal</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Maisons traditionnelles, constructions récentes ou rénovations</strong> : nous couvrons l'ensemble du territoire de Martillac.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Martillac
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Martillac</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Martillac,France&zoom=13&center=44.7114,-0.5481`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Martillac, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Martillac et ses quartiers"
