  ...
  return (
    <main className="px-0">
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <p><strong>Lotissement des Coteaux :</strong> climatisation gainable pour villa contemporaine avec régulation multizone.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue du Stade :</strong> remplacement chauffe-eau électrique par modèle thermodynamique dans maison des années 90.</p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-6xl mx-auto mb-12 sm:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Choisir ClimGO à Saint-Loubès, c'est bénéficier d'une <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">expertise locale et d'équipements adaptés aux spécificités</strong> de votre commune.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos installations s'adaptent aux <strong className="text-[#059669] dark:text-[#10B981]">spécificités climatiques de la rive droite de la Garonne</strong> et aux exigences modernes de confort.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité avec Saint-Loubès nous permet une <strong className="text-[#2563EB] dark:text-[#60A5FA]">réactivité optimale pour vos projets et dépannages</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Des <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">maisons traditionnelles aux constructions RT2012</strong>, nous proposons des solutions thermiques sur mesure.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Saint-Loubès</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat 
        ...
        subtitle="Nos réponses à vos préoccupations les plus courantes sur le chauffage et la climatisation à Saint-Loubès"
        faqs={[
          {
          ...
          },
          {
            ...
            answer: "Oui. Du centre historique aux nouveaux lotissements, nous couvrons toute la commune avec réactivité. ClimGO intervient du centre-ville aux nouveaux quartiers résidentiels."
          },
          {
            question: "Comment adaptez-vous vos installations au climat de la rive droite ?",
            answer: "Nos installations s'adaptent aux spécificités climatiques de la rive droite de la Garonne et aux exigences modernes de confort. Nous prenons en compte l'exposition et les variations d'humidité pour dimensionner parfaitement vos équipements."
          }
        ]}
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Saint-Loubès,France&zoom=13&center=44.9186,-0.3311`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Saint-Loubès, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Saint-Loubès et ses quartiers"
