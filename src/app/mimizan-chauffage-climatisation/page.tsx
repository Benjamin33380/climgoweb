  ...
  return (
    <main className="px-0">
      ...
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Mimizan, entre plages océanes et forêt landaise
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Station balnéaire prisée</strong> de la côte landaise, Mimizan allie dynamisme côtier et douceur de vivre au cœur des Landes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Du <strong className="text-gray-900 dark:text-white">front de mer</strong> aux lotissements boisés, ClimGO adapte ses solutions aux habitations variées de Mimizan, qu'elles soient récentes ou anciennes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nous tenons compte des <strong className="text-gray-900 dark:text-white">spécificités salines et climatiques</strong> propres à la façade Atlantique pour garantir des installations fiables et durables.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située au cœur des Landes, <strong className="text-gray-900 dark:text-white">Mimizan</strong> séduit par son cadre naturel exceptionnel, entre pins maritimes, plages de sable fin et étangs paisibles.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  La commune compte environ <strong className="text-gray-900 dark:text-white">7 000 habitants</strong> et attire chaque année de nouveaux résidents et vacanciers grâce à son cadre de vie privilégié.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient aussi bien dans le <strong className="text-gray-900 dark:text-white">centre de Mimizan-Bourg</strong> que dans les quartiers résidentiels proches de Mimizan-Plage ou de la route de Bias.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  À Mimizan, l'<strong className="text-gray-900 dark:text-white">humidité de l'air et le vent marin</strong> exigent des équipements résistants à la corrosion et un entretien rigoureux pour garantir la durabilité.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Station Balnéaire</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Interventions dans tous les quartiers : Mimizan-Bourg, Mimizan-Plage, route de Bias. Solutions adaptées au dynamisme côtier et à la douceur de vivre landaise.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Habitat Côtier</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Maisons de ville, résidences secondaires, lotissements proches de l'océan : nos solutions s'adaptent parfaitement avec attention aux performances énergétiques.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Équipements résistants à la corrosion et entretien rigoureux. PAC sélectionnées pour leur fiabilité en bord de mer et face aux amplitudes thermiques.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Savoir-faire éprouvé alliant expertise technique et connaissance du territoire. Grande réactivité, suivi rigoureux et réalisations soignées.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un cadre de vie entre forêt et océan
                    </h3>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions à Mimizan
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue des Goëlands :</strong> climatisation gainable résidence secondaire proche plage.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Avenue de Woolsack :</strong> remplacement cumulus par chauffe-eau thermodynamique performant.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Quartier du lac :</strong> entretien annuel climatisations murales logements saisonniers.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une expertise adaptée au climat landais
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        À Mimizan, l'<strong className="text-gray-900 dark:text-white">humidité de l'air et le vent marin</strong> exigent des équipements résistants à la corrosion et un entretien rigoureux.
                      </p>
                      <p>
                        Nos <strong className="text-gray-900 dark:text-white">PAC sont sélectionnées</strong> pour leur fiabilité en bord de mer et nous anticipons les fortes amplitudes thermiques.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Votre projet confort à Mimizan ?
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Que ce soit pour votre <strong className="text-gray-900 dark:text-white">résidence principale</strong>, une location saisonnière ou une maison de vacances, ClimGO est votre partenaire de confiance.
                      </p>
                      <p>
                        Contactez-nous pour un <strong className="text-gray-900 dark:text-white">devis personnalisé</strong> et adapté à vos besoins locaux à Mimizan.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Mimizan ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Mimizan - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">Savoir-faire éprouvé</strong> alliant expertise technique et connaissance du territoire. Adaptation parfaite au <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">dynamisme côtier</strong> landais.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Équipements fiables</strong> et performants, compatibles avec les spécificités thermiques des <strong className="text-gray-900 dark:text-gray-300">logements landais</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Équipements résistants</strong> à la corrosion et entretien rigoureux. PAC sélectionnées pour leur <strong className="text-gray-900 dark:text-gray-300">fiabilité en bord de mer</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Installés à proximité</strong>, nous garantissons une grande réactivité, un <strong className="text-gray-900 dark:text-gray-300">suivi rigoureux</strong> et des réalisations soignées à Mimizan.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Mimizan
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Mimizan</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="mimizan" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Mimizan,France&zoom=12&center=44.2122,-1.2942`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Mimizan, Landes"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Mimizan et ses quartiers"
