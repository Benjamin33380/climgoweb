            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Nichée entre l'<strong className="text-gray-900 dark:text-white">océan Atlantique et le bassin d'Arcachon</strong>, Lège-Cap-Ferret offre un cadre de vie exceptionnel.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Entre <strong className="text-gray-900 dark:text-white">villas en bois, cabanes ostréicoles et maisons d'architecte</strong>, nous adaptons chaque projet thermique à l'environnement marin et forestier.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  De <strong className="text-gray-900 dark:text-white">Claouey au Cap Ferret</strong>, en passant par Le Canon ou La Vigne, nous accompagnons les résidences principales comme secondaires.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Lège-Cap-Ferret, <strong className="text-gray-900 dark:text-white">joyau de la côte girondine</strong>, attire aussi bien les résidents permanents que les vacanciers en quête d'authenticité.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec ses <strong className="text-gray-900 dark:text-white">villages ostréicoles, ses plages océanes</strong> et son cadre naturel unique, la commune connaît un essor maîtrisé.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient sur toute la presqu'île : du <strong className="text-gray-900 dark:text-white">Grand Crohot à Claouey</strong>, du Four au Canon jusqu'au mythique Cap-Ferret.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Le <strong className="text-gray-900 dark:text-white">climat océanique et l'air salin</strong> imposent des précautions particulières pour préserver la durabilité des installations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Presqu'île Prisée</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Habitat Authentique</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Contraintes Marines</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Expertise Littoral</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Nous respectons scrupuleusement les <strong className="text-gray-900 dark:text-white">règles d'urbanisme locales</strong>, et proposons des solutions intégrées discrètes pour ne pas dénaturer les façades.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous avez un projet de <strong className="text-gray-900 dark:text-white">rénovation, de location saisonnière</strong> ou de résidence principale à Lège-Cap-Ferret ?
                      </p>
                      <p>
                        Contactez-nous pour une <strong className="text-gray-900 dark:text-white">étude personnalisée</strong>. Notre équipe s'adapte à vos contraintes avec sérieux et discrétion.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Connaissance parfaite des <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">spécificités du littoral</strong>. Contraintes liées au sel, au vent et aux normes environnementales locales.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">Isolation renforcée, appareils silencieux</strong> et matériaux résistants aux embruns. Qualité et longévité de chaque installation.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Respect scrupuleux des <strong className="text-[#2563EB] dark:text-[#60A5FA]">règles d'urbanisme locales</strong>. Solutions intégrées discrètes pour ne pas dénaturer façades ou toitures en zone sensible.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Grâce à notre <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">proximité</strong>, nous intervenons rapidement à Claouey, Grand Piquey, Le Canon, ou Cap Ferret pour toute installation ou dépannage.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Lège-Cap-Ferret</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
