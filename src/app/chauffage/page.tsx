    ...
    <div className="min-h-screen bg-[#F8F9F4] dark:bg-black dark:bg-black text-[#03144A] dark:text-white dark:text-white">
            ...
            <div className="md:hidden space-y-6 px-4">
              {solutions.map((solution, index) => (
                <div key={index} className="bg-white dark:bg-gray-900 rounded-2xl border border-[#03144A] dark:border-white/20 overflow-hidden shadow-lg">
                  <div className="w-full h-40 relative bg-gradient-to-br from-[#DC2626]/5 to-[#03144A]/5">
                    <Image
                      src={solution.image}
                      alt={solution.title}
                      fill
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        <p className="text-[#DC2626] text-sm font-medium">{solution.subtitle}</p>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-4">
                      {solution.features.slice(0, 4).map((feature, i) => (
                        <div key={i} className="flex items-center text-xs text-[#03144A] dark:text-white/70">
                          <div className="w-1.5 h-1.5 bg-[#DC2626] rounded-full mr-2 flex-shrink-0"></div>
                          <span>{feature}</span>
                        </div>
                      ))}
                    </div>
      ...
      <section className="py-12 md:py-24 relative">
        <div className="max-w-4xl mx-auto text-center px-4 md:px-6">
          <div className="bg-gradient-to-br from-[#DC2626]/5 to-[#03144A]/5 dark:from-[#DC2626]/10 dark:to-[#03144A]/10 rounded-2xl md:rounded-3xl p-8 md:p-16 border border-[#03144A] dark:border-white/20 backdrop-blur-sm shadow-xl">
            ...
            <Link
              href="/contact"
              className="inline-block px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-[#03144A] to-[#DC2626] rounded-full text-[#F8F9F4] font-medium transition-all duration-300 hover:scale-105 text-sm md:text-base"
            >
