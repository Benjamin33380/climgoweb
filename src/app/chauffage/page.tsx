                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                          ...
                          <div className="p-12 lg:p-16">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Link
                                href="/contact"
                                className="group px-8 py-3 bg-gradient-to-r from-[#03144A] to-[#FF8C00] rounded-full text-[#F8F9F4] font-medium transition-all duration-300 hover:scale-105"
                              >
                                Devis gratuit
                              </Link>
                            </div>
                ...
                {solutions.map((_, i) => (
                  <button
                    ...
                    className={`w-4 h-4 rounded-full ${
                      i === currentIndex ? 'bg-[#FF8C00]' : 'bg-[#03144A]/30'
            ...
            <div className="md:hidden space-y-6 px-4">
              {solutions.map((solution, index) => (
                <div key={index} className="bg-white dark:bg-gray-900 rounded-2xl border border-[#03144A] dark:border-white/20 overflow-hidden shadow-lg">
                  <div className="w-full h-40 relative bg-gradient-to-br from-[#FF8C00]/5 to-[#03144A]/5">
                    <Image
                      src={solution.image}
                      alt={solution.title}
                      fill
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        <p className="text-[#FF8C00] text-sm font-medium">{solution.subtitle}</p>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-4">
                      {solution.features.slice(0, 4).map((feature, i) => (
                        <div key={i} className="flex items-center text-xs text-[#03144A] dark:text-white/70">
                          <div className="w-1.5 h-1.5 bg-[#FF8C00] rounded-full mr-2 flex-shrink-0"></div>
                          <span>{feature}</span>
                        </div>
                      ))}
                    </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {advantages.map((advantage, index) => (
              <div
                key={index}
                className="group text-center p-8 rounded-2xl bg-[#F8F9F4] dark:bg-black border border-[#03144A] dark:border-white/20 hover:border-[#FF8C00]/50 transition-all duration-300 hover:bg-[#FF8C00]/5"
              >
      ...
      <section className="py-12 md:py-24 relative">
        <div className="max-w-4xl mx-auto text-center px-4 md:px-6">
          <div className="bg-gradient-to-br from-[#FF8C00]/5 to-[#03144A]/5 dark:from-[#FF8C00]/10 dark:to-[#03144A]/10 rounded-2xl md:rounded-3xl p-8 md:p-16 border border-[#03144A] dark:border-white/20 backdrop-blur-sm shadow-xl">
            ...
            <Link
              href="/contact"
              className="inline-block px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-[#03144A] to-[#FF8C00] rounded-full text-[#F8F9F4] font-medium transition-all duration-300 hover:scale-105 text-sm md:text-base"
            >
