...
export default function Begles() {
  ...
  return (
    <main className="px-0">
        ...
        <div className="relative z-10 flex h-full items-center">
          ...
          >
            ...
            <p className="text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl text-white/90 sm:text-black/90 dark:text-white/90 mb-3 sm:mb-4 md:mb-6 lg:mb-8 leading-relaxed max-w-[280px] sm:max-w-sm md:max-w-lg lg:max-w-none whitespace-pre-line">
              Ville dynamique aux portes de Bordeaux{'\n'}pour un confort thermique maîtrisé
            </p>
      ...
      {/* Section Bègles - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Bègles, ville dynamique et confort thermique maîtrisé
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Bègles est une <strong className="text-gray-900 dark:text-white">commune dynamique située en proche banlieue de Bordeaux</strong>, connue pour son mélange d'urbanisme moderne et de quartiers historiques.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Ses habitations variées nécessitent des <strong className="text-gray-900 dark:text-white">solutions de chauffage et de climatisation adaptées</strong>. Que vous soyez situé près du centre-ville, de la Gare ou du quartier Saint-Bruno.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située aux portes de Bordeaux, Bègles est une <strong className="text-gray-900 dark:text-white">ville en constante mutation</strong>, entre habitat ancien en pierre bordelaise et programmes immobiliers modernes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">ZAC des Sècheries, quartier Terre Sud</strong>, ligne de tram C, établissements scolaires (Lycée Vaclav Havel, écoles Albert Camus), équipements culturels (Le Carré-Colonnes).
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Attire de plus en plus de <strong className="text-gray-900 dark:text-white">jeunes familles et de professionnels</strong> en quête de confort urbain. Échoppes proches gare de Bègles, résidences neuves parc de Mussonville.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Entre <strong className="text-gray-900 dark:text-white">mitoyenneté forte, petits jardins</strong> et fortes amplitudes thermiques, chaque installation à Bègles demande un diagnostic précis.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  PAC fixées sur <strong className="text-gray-900 dark:text-white">plots ou supports muraux</strong> pour limiter nuisances sonores, unités intérieures choisies pour discrétion et efficacité énergétique.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Commune Urbaine Multiples Visages</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Ville en constante mutation : habitat ancien pierre bordelaise, programmes immobiliers modernes ZAC Sècheries, quartier Terre Sud. Tram C, établissements scolaires, équipements culturels.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Population Dynamique</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Attire jeunes familles et professionnels en quête confort urbain. Résidences étudiantes, maisons familiales, logements collectifs. Échoppes proches gare, résidences neuves parc Mussonville, centre commercial Rives d'Arcin.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Contraintes Urbaines</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Mitoyenneté forte, petits jardins, fortes amplitudes thermiques : diagnostic précis nécessaire. PAC fixées plots ou supports muraux limiter nuisances sonores. Unités intérieures discrétion efficacité énergétique.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Entreprise engagée comprend particularités climatiques architecturales commune. Équipements sélectionnés garantir efficacité, discrétion, durabilité. Proximité rigueur : service rapide, finitions propres, accompagnement administratif complet.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune urbaine aux visages multiples
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Connue pour sa ligne de tram C, ses établissements scolaires, ses <strong className="text-gray-900 dark:text-white">équipements culturels</strong> (Le Carré-Colonnes).
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Chantiers réalisés récemment à Bègles
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue Léon Gambetta :</strong> PAC air/eau maison de ville en pierre, circuit radiateurs existant.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Quartier Terre Sud :</strong> climatisation gainable logement T4 neuf RT2012, coffrage discret.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Avenue Salvador Allende :</strong> maintenance système split Mitsubishi avec nettoyage complet.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Des solutions pensées pour le tissu urbain béglais
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Entre <strong className="text-gray-900 dark:text-white">mitoyenneté forte, petits jardins</strong> et fortes amplitudes thermiques, chaque installation à Bègles demande un diagnostic précis.
                      ...
                      <p>
                        Nos équipes adaptent les solutions selon l'orientation, l'espace disponible et les <strong className="text-gray-900 dark:text-white">habitudes de vie</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Et votre projet à Bègles, on en parle ?
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous envisagez de moderniser votre système de chauffage, d'ajouter une <strong className="text-gray-900 dark:text-white">climatisation réversible</strong> ou de remplacer un chauffe-eau ?
                      </p>
                      <p>
                        Faites appel à ClimGO. Un <strong className="text-gray-900 dark:text-white">technicien peut se déplacer rapidement</strong> pour évaluer les besoins sur place.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Bègles ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Bègles - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Entreprise engagée qui comprend les <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">particularités climatiques et architecturales</strong> de la commune de Bègles.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    PAC fixées sur <strong className="text-gray-900 dark:text-gray-300">plots ou supports muraux</strong> pour limiter nuisances sonores. Unités intérieures choisies pour discrétion.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité et notre rigueur font la différence : <strong className="text-gray-900 dark:text-gray-300">service rapide, finitions propres, accompagnement administratif complet</strong>.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Bègles
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Bègles</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="begles" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Bègles,France&zoom=13&center=44.8072,-0.5496`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Bègles, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Bègles et ses quartiers"
