      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-50 dark:bg-background">
        <div className="container mx-auto px-4 xs:px-5 sm:px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 gap-6 sm:gap-8 max-w-2xl mx-auto">
            ...
            <Link
              href="#"
              className="block group relative bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-black dark:hover:border-white hover:-translate-y-2 h-[300px] sm:h-[320px] cursor-pointer"
            >
