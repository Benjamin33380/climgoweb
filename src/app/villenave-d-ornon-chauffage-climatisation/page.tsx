...
export default function VillenaveDornon() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Villenave-d'Ornon - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Chauffage Climatisation Villenave-d&apos;Ornon - ClimGO Bordeaux Métropole
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Située aux portes de <strong className="text-gray-900 dark:text-white">Bordeaux</strong>, <strong className="text-gray-900 dark:text-white">Villenave-d'Ornon</strong> combine zones pavillonnaires, habitat collectif et dynamique économique. Une commune en pleine évolution qui demande des solutions thermiques sur mesure.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que ce soit autour du <strong className="text-gray-900 dark:text-white">vieux bourg</strong>, du quartier <strong className="text-gray-900 dark:text-white">Chambéry</strong> ou des nouveaux lotissements, ClimGO adapte chaque installation à l'environnement urbain de Villenave-d'Ornon.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nous apportons des solutions de confort hautement efficaces, discrètes et compatibles avec les <strong className="text-gray-900 dark:text-white">normes locales</strong>, tout en garantissant un accompagnement complet.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Notre expertise nous permet de maîtriser les <strong className="text-gray-900 dark:text-white">contraintes urbaines</strong> spécifiques : densité de population, réglementations de copropriété et optimisation énergétique des logements collectifs.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Des <strong className="text-gray-900 dark:text-white">quartiers du Pont-de-la-Maye</strong> jusqu'à la <strong className="text-gray-900 dark:text-white">rue Léon Blum</strong>, nos équipes interviennent dans tous les secteurs de Villenave-d'Ornon avec la même exigence de qualité.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Chaque projet bénéficie d'une <strong className="text-gray-900 dark:text-white">étude personnalisée</strong> tenant compte de l'architecture locale, des contraintes techniques et de vos objectifs de confort et d'économies d'énergie.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Notre équipe d'<strong className="text-gray-900 dark:text-white">experts certifiés RGE</strong> intervient aussi bien dans les maisons individuelles que dans les résidences collectives, avec un service adapté à chaque type d'habitat.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nous garantissons un <strong className="text-gray-900 dark:text-white">service de proximité</strong> réactif et un suivi personnalisé, de la première visite technique à la maintenance préventive de vos équipements.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Villenave-d&apos;Ornon
              </h2>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Interventions dans tous les secteurs de Villenave-d'Ornon, du vieux bourg aux nouveaux lotissements, avec des solutions adaptées à chaque type d'habitat urbain et périurbain.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Habitat collectif & individuel</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Solutions adaptées aux résidences collectives comme aux maisons individuelles, avec une expertise particulière des contraintes de copropriété et des normes urbaines.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Proximité Bordeaux</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Service de proximité optimisé grâce à notre connaissance de la métropole bordelaise, avec des interventions rapides et un accompagnement personnalisé de qualité.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Chaque intervention respecte les plus hauts standards de qualité, avec certification RGE et accompagnement complet pour votre tranquillité d'esprit totale.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune en pleine mutation entre ville et nature
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Située au sud de Bordeaux, <strong className="text-gray-900 dark:text-white">Villenave-d'Ornon</strong> compte plus de 35 000 habitants et connaît une forte croissance résidentielle. Grâce à sa proximité avec la rocade, la gare de Bègles et les zones d'activités, elle attire aussi bien des familles que des actifs.
                      </p>
                      <p>
                        Entre les quartiers du Pont-de-la-Maye, Chambéry, Bocage ou Courrejean, les styles de logements sont variés : maisons de lotissements, bâtis anciens rénovés ou résidences neuves.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions à Villenave-d&apos;Ornon
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue Jules Ferry :</strong> remplacement d'un ancien système de chauffage par une PAC air/eau haute performance.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Avenue du Maréchal Leclerc :</strong> installation d'une climatisation réversible dans un appartement récent.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Résidence Les Jardins de Courrejean :</strong> maintenance annuelle de climatiseurs muraux en copropriété.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une expertise locale adaptée au cadre urbain et pavillonnaire
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Votre projet thermique à Villenave-d&apos;Ornon
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous habitez <strong className="text-gray-900 dark:text-white">Villenave-d'Ornon</strong> ou venez d'y acquérir un bien ? Notre équipe vous accompagne dans vos projets de chauffage, climatisation ou production d'eau chaude.
                      </p>
                      <p>
                        Contactez-nous pour un <strong className="text-gray-900 dark:text-white">devis gratuit</strong> et un accompagnement personnalisé.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Villenave-d&apos;Ornon ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Villenave-d'Ornon - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#2563EB] dark:text-[#60A5FA]">Connaissance approfondie</strong> de Villenave-d'Ornon et de la métropole bordelaise. <strong className="text-[#2563EB] dark:text-[#60A5FA]">Maîtrise parfaite</strong> des contraintes urbaines et réglementaires.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#f97316]/50 dark:hover:border-[#fb923c] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#f97316] dark:text-[#fb923c]">Systèmes optimisés</strong> pour l'habitat collectif et individuel. <strong className="text-[#f97316] dark:text-[#fb923c]">Respect de l'architecture</strong> locale et des normes énergétiques.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Intervention rapide</strong> sur Villenave-d'Ornon et environs, <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">service réactif</strong> et <strong className="text-[#8B5CF6] dark:text-[#8B5CF6]">proximité optimale</strong> avec Bordeaux.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">Proximité, rigueur</strong> et accompagnement administratif. <strong className="text-[#059669] dark:text-[#10B981]">L'excellence ClimGO</strong> au service des habitants de Villenave-d'Ornon.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Villenave-d&apos;Ornon
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Villenave-d&apos;Ornon</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Villenave-d'Ornon,France&zoom=13&center=44.7767,-0.5389`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Villenave-d'Ornon, Bordeaux Métropole"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Villenave-d'Ornon et dans la métropole bordelaise"
