  ...
  return (
    <main className="px-0">
      ...
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Bassin d'Arcachon, Habitant d'Arès
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Située entre <strong className="text-gray-900 dark:text-white">bassin et forêt</strong>, Arès séduit par son authenticité, ses pistes cyclables et ses quartiers calmes comme les Quinconces ou Jane de Boy.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO s'adapte à chaque habitat pour assurer votre <strong className="text-gray-900 dark:text-white">confort thermique</strong>. Nous accompagnons les familles, retraités et nouveaux arrivants dans leurs projets d'installation.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  En respectant les <strong className="text-gray-900 dark:text-white">zones naturelles protégées</strong> et les spécificités locales, chaque intervention vise à optimiser la performance énergétique de votre logement.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Arès charme ses habitants avec ses <strong className="text-gray-900 dark:text-white">plages paisibles, sa réserve naturelle des prés salés</strong>, ses marchés traditionnels et son port ostréicole.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Les quartiers comme <strong className="text-gray-900 dark:text-white">Jane de Boy, Les Quinconces ou Le Coulin</strong> abritent des maisons de style arcachonnais, des villas contemporaines et des résidences familiales.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Entre <strong className="text-gray-900 dark:text-white">jeunes familles</strong> en quête de confort moderne et retraités attentifs aux économies d'énergie, les profils sont variés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  À Arès, le <strong className="text-gray-900 dark:text-white">vent marin, la proximité de la pinède</strong> et les conditions salines imposent un choix rigoureux de matériel extérieur.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Arès
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Des quartiers comme Domaine de Saint-Brice aux Quinconces, nous couvrons tous les secteurs d'Arès. Nos solutions s'adaptent aux constructions neuves comme aux maisons anciennes, avec un souci constant d'efficacité et de durabilité.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Authenticité du Bassin</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Interventions dans tous les quartiers : Jane de Boy, Les Quinconces, Le Coulin, Domaine de Saint-Brice. Plages paisibles, réserve naturelle des prés salés, port ostréicole.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Maisons de style arcachonnais, villas contemporaines et résidences familiales. Jeunes familles confort moderne et retraités attentifs aux économies d'énergie.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Contraintes Naturelles</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Vent marin, proximité pinède et conditions salines. Unités renforcées anticorrosion, fixées sur plots surélevés. Zones inondables et zones protégées.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Savoir-faire local et engagé. Matériaux performants, normes rigoureuses et finitions impeccables. Intervention rapide pour installations urgentes sans attente.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une ville entre bassin et nature
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Ici, l'<strong className="text-gray-900 dark:text-white">authenticité du bassin</strong> se mêle à un mode de vie doux et tourné vers la nature.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions à Arès
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un savoir-faire local et engagé
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        À Arès, le <strong className="text-gray-900 dark:text-white">vent marin, la proximité de la pinède</strong> et les conditions salines imposent un choix rigoureux de matériel extérieur.
                      ...
                      <p>
                        Nous utilisons des <strong className="text-gray-900 dark:text-white">unités renforcées anticorrosion</strong>, fixées sur plots surélevés pour des installations respectueuses de la réglementation locale.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Discutons ensemble de votre projet à Arès
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous habitez à Arès ou vous y <strong className="text-gray-900 dark:text-white">investissez dans une résidence secondaire</strong> ? ClimGO vous accompagne du conseil à l'entretien.
                      </p>
                      <p>
                        N'hésitez pas à nous contacter pour <strong className="text-gray-900 dark:text-white">échanger sur votre projet</strong> dans cette ville authentique entre bassin et nature.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Arès ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Arès - Version personnalisée */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-6xl mx-auto mb-12 sm:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Connaissance des <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">contraintes spécifiques du climat local</strong> et de la richesse environnementale de la commune d'Arès.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">Matériaux performants, normes rigoureuses</strong> et finitions impeccables. Chaque projet traité avec la plus grande exigence.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#2563EB] dark:text-[#60A5FA]">Unités renforcées anticorrosion</strong>, fixées sur plots surélevés. Prise en compte zones inondables et zones protégées.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">proximité</strong> permet d'intervenir rapidement sur tout Arès, pour des dépannages ou installations urgentes sans attente.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Arès
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Arès</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat 
        ...
        subtitle="Nos réponses à vos préoccupations les plus courantes sur le chauffage et la climatisation à Arès"
        faqs={[
          {
            question: "Quels sont vos services à Arès ?",
            answer: "Nous assurons l'installation, l'entretien et le dépannage de systèmes de chauffage, climatisation et production d'eau chaude à Arès et ses lieux-dits : Jane de Boy, Quinconces, Le Coulin, Domaine de Saint-Brice."
          },
          {
            question: "Proposez-vous un accompagnement pour les aides ?",
            answer: "Oui ! Nous vous guidons dans les démarches pour obtenir MaPrimeRénov', les CEE, la TVA réduite ou l'Éco-PTZ, selon votre projet. Notre accompagnement administratif est complet."
          },
          {
            question: "Intervenez-vous dans les lieux-dits autour d'Arès ?",
            answer: "Absolument ! Nos techniciens se déplacent dans tous les lieux-dits d'Arès : Domaine de Saint-Brice, Quinconces, Jane de Boy, Le Coulin, avec notre expertise locale."
          },
          {
            question: "Comment adaptez-vous vos installations au climat marin ?",
            answer: "À Arès, nous utilisons des unités renforcées anticorrosion, fixées sur plots surélevés. Nos conseils prennent en compte les zones inondables et la proximité des zones protégées pour des installations respectueuses."
          }
        ]}
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Arès,France&zoom=12&center=44.7613,-1.1376`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Arès, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Arès et ses quartiers"
