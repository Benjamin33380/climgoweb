...
export default function Cadaujac() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Cadaujac - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Cadaujac, ville verte et résidentielle au cœur de la métropole
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Cadaujac, connue pour ses <strong className="text-gray-900 dark:text-white">parcs, ses équipements publics et son cadre résidentiel</strong>, est une commune idéale pour des solutions de confort thermique haut de gamme.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous habitiez près du <strong className="text-gray-900 dark:text-white">Bourg, de Fayet, Avenue de Toulouse ou route du port de grima</strong>, ClimGO vous accompagne pour choisir et installer la solution la plus adaptée.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Cadaujac, à la fois <strong className="text-gray-900 dark:text-white">paisible et connectée</strong>, attire de plus en plus de familles souhaitant vivre à proximité de Bordeaux.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec ses <strong className="text-gray-900 dark:text-white">berges de Garonne, ses pistes cyclables et ses zones pavillonnaires calmes</strong>, elle séduit autant les actifs que les retraités.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  La commune bénéficie d'un <strong className="text-gray-900 dark:text-white">tissu associatif dynamique, d'un accès rapide à la rocade</strong> via la D1113, et d'infrastructures publiques bien entretenues.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Du <strong className="text-gray-900 dark:text-white">quartier du Bourg à la route de Beautiran</strong>, nous proposons des équipements pensés pour les maisons neuves comme pour les habitations traditionnelles.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nos installations sur Cadaujac sont pensées pour <strong className="text-gray-900 dark:text-white">durer, tout en s'adaptant à l'architecture et aux spécificités locales</strong>.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Ville Verte Résidentielle</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Parcs, équipements publics et cadre résidentiel idéal pour solutions confort thermique haut de gamme. Bourg, Fayet, Avenue de Toulouse ou route du port de grima.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Commune en Essor</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Paisible et connectée attire familles souhaitant vivre proximité Bordeaux. Berges de Garonne, pistes cyclables et zones pavillonnaires calmes séduit actifs et retraités.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Infrastructures Dynamiques</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Tissu associatif dynamique, accès rapide à la rocade via la D1113, et infrastructures publiques bien entretenues. Quartier du Bourg à la route de Beautiran.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Installations Durables</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Équipements pensés pour les maisons neuves comme pour les habitations traditionnelles. Installations pensées pour durer, s'adaptant à l'architecture et spécificités locales.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune en plein essor résidentiel
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        C'est dans ce cadre que ClimGO intervient, en adaptant chaque projet à <strong className="text-gray-900 dark:text-white">l'environnement résidentiel cadaujacais</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples d'interventions à Cadaujac
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Expertise locale et solutions durables
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Les constructions cadaujacaises, souvent dotées de <strong className="text-gray-900 dark:text-white">combles peu isolés ou de murs anciens</strong> en moellon, demandent une approche sur mesure.
                      </p>
                      <p>
                        Nos unités extérieures sont posées sur <strong className="text-gray-900 dark:text-white">plots béton isolés du sol</strong> avec attention à l'évacuation des condensats.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Discutons ensemble de votre projet à Cadaujac
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous avez un projet de <strong className="text-gray-900 dark:text-white">rénovation thermique ou souhaitez améliorer</strong> votre confort ?
                      </p>
                      <p>
                        Que vous soyez près de la mairie, du cimetière paysager ou du <strong className="text-gray-900 dark:text-white">lycée Toulouse-Lautrec</strong>, notre équipe répond rapidement.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Cadaujac ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Cadaujac - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire confiance à une <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">équipe locale, experte des besoins thermiques</strong> des habitations traditionnelles et récentes de la commune.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Pompes à chaleur, climatisations, chauffe-eaux : chaque solution est <strong className="text-gray-900 dark:text-gray-300">sélectionnée pour s'intégrer à votre environnement</strong> et réduire vos factures.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre <strong className="text-gray-900 dark:text-gray-300">ancrage local garantit réactivité, suivi rigoureux</strong> et qualité de service à Cadaujac.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Constructions dotées de <strong className="text-gray-900 dark:text-gray-300">combles peu isolés ou murs anciens en moellon</strong> demandent une approche sur mesure avec étude thermique complète.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Cadaujac
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Cadaujac</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="cadaujac" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Cadaujac,France&zoom=13&center=44.7428,-0.5175`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Cadaujac, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Cadaujac et ses quartiers"
