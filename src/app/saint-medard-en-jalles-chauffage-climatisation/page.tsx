...
export default function SaintMedardEnJalles() {
  ...
  return (
    <main className="px-0">
        ...
        <div className="relative z-10 flex h-full items-center">
          ...
          >
            <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-light tracking-tight mb-3 sm:mb-4 md:mb-6 text-white sm:text-black dark:text-white break-words leading-tight">
              ClimGO à Saint-Médard-en-Jalles
            </h1>
      ...
      {/* Section Saint-Médard-en-Jalles - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Saint-Médard-en-Jalles, entre forêt et dynamisme technologique
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Située entre Bordeaux et les Landes</strong>, Saint-Médard-en-Jalles conjugue zones résidentielles calmes et pôles d'activités technologiques.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  À seulement <strong className="text-gray-900 dark:text-white">15 km de Bordeaux, avec plus de 30 000 habitants</strong>, elle offre un tissu urbain diversifié et un fort potentiel immobilier.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous soyez vers <strong className="text-gray-900 dark:text-white">Hastignan, Cérillan, Magudas ou Corbiac</strong>, ClimGO propose des installations sur-mesure et efficaces.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nos systèmes s'intègrent aussi bien dans <strong className="text-gray-900 dark:text-white">les maisons traditionnelles que dans les logements récents</strong> des quartiers pavillonnaires.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Les familles apprécient ses <strong className="text-gray-900 dark:text-white">infrastructures complètes et sa proximité avec les pôles économiques</strong> (Dassault, ArianeGroup).
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient dans <strong className="text-gray-900 dark:text-white">tous les quartiers avec une expertise adaptée aux conditions locales</strong> et un accompagnement personnalisé.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Saint-Médard-en-Jalles
              </h2>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Située entre Bordeaux et les Landes, Saint-Médard-en-Jalles conjugue zones résidentielles calmes et pôles d'activités technologiques. À 15 km de Bordeaux, plus de 30 000 habitants.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Quartiers Diversifiés</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Que vous soyez vers Hastignan, Cérillan, Magudas ou Corbiac, ClimGO propose des installations sur-mesure et efficaces. Tissu urbain diversifié et fort potentiel immobilier.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Logements Variés</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Nos systèmes s'intègrent aussi bien dans les maisons traditionnelles que dans les logements récents des quartiers pavillonnaires. Infrastructures complètes et pôles économiques.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    ClimGO intervient dans tous les quartiers avec une expertise adaptée aux conditions locales et un accompagnement personnalisé. Solutions boisées et sols argileux.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune technologique dynamique
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Saint-Médard-en-Jalles séduit avec son <strong className="text-gray-900 dark:text-white">équilibre entre vie résidentielle, pôles économiques</strong> (Dassault, ArianeGroup) et cadre boisé.
                      </p>
                      <p>
                        Forte de <strong className="text-gray-900 dark:text-white">plus de 30 000 habitants</strong>, elle offre un tissu urbain diversifié et un fort potentiel immobilier.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples d'interventions à Saint-Médard
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Allée François Arago :</strong> installation climatisation gainable dans maison ossature bois RT2012.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue du Commandant Charcot :</strong> remplacement ancien chauffage gaz par PAC air/eau pour foyer quatre personnes.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Résidence des Écureuils :</strong> entretien annuel plusieurs PAC Mitsubishi pour copropriété boisée.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Expertise adaptée aux conditions jallaises
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Entre les <strong className="text-gray-900 dark:text-white">zones boisées, les sols argileux et la proximité des forêts</strong>, les installations nécessitent une approche sur-mesure.
                      </p>
                      <p>
                        Nos équipes maîtrisent les <strong className="text-gray-900 dark:text-white">contraintes locales : bruit, ventilation, sécurité</strong> et longévité des équipements.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Votre projet à Saint-Médard-en-Jalles
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        <strong className="text-gray-900 dark:text-white">Projet de rénovation énergétique ou installation</strong> dans une maison neuve ? Notre équipe locale vous accompagne.
                      </p>
                      <p>
                        Contactez ClimGO pour un <strong className="text-gray-900 dark:text-white">diagnostic sur place à Saint-Médard et un devis rapide</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Saint-Médard-en-Jalles ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Saint-Médard-en-Jalles - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire appel à ClimGO à Saint-Médard-en-Jalles, c'est choisir un <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">acteur local qui comprend les spécificités thermiques</strong> de la commune.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements sont adaptés à <strong className="text-gray-900 dark:text-gray-300">l'environnement résidentiel : efficaces, durables, et esthétiques</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Vous bénéficiez d'un <strong className="text-gray-900 dark:text-gray-300">accompagnement humain, rigoureux et réactif</strong>, du devis à la maintenance.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous proposons des <strong className="text-gray-900 dark:text-gray-300">systèmes réversibles discrets et performants</strong>, compatibles avec les contraintes d'urbanisme.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Saint-Médard-en-Jalles
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Saint-Médard-en-Jalles</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="saint-medard-en-jalles" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Saint-Médard-en-Jalles,France&zoom=13&center=44.8914,-0.7206`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Saint-Médard-en-Jalles, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Saint-Médard-en-Jalles et ses quartiers"
