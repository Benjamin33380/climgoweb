...
export const metadata: Metadata = {
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Saint-Medard-En-Jalles 33160 | ClimGO Expert Local',
    'DC.description': 'Expert chauffage climatisation Saint-Medard-En-Jalles 33160. Installation PAC, dépannage urgent, entretien. Artisan RGE certifié.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
              ...
              "makesOffer": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Installation de pompes à chaleur air/eau et air/air à Saint-Medard-En-Jalles"
                  },
                  "price": "8000",
                  "priceCurrency": "EUR"
                },
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Service de dépannage chauffage 24h/7j à Saint-Medard-En-Jalles"
                  },
                  "price": "120",
                  "priceCurrency": "EUR"
                }
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "item": "https://climgo.fr/saint-medard-en-jalles-chauffage-climatisation"
                }
              ]
            })
          }}
