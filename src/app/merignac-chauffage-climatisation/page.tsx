            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Située à <strong className="text-gray-900 dark:text-white">proximité de Bordeaux et de son aéroport</strong>, Mérignac est une ville aux quartiers variés, mêlant zones pavillonnaires, maisons familiales et espaces verts.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous résidiez dans le <strong className="text-gray-900 dark:text-white">centre-ville, aux Capeyron ou à Beutre</strong>, ClimGO conçoit chaque installation en tenant compte des spécificités de votre habitat mérignacais.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Grâce à notre <strong className="text-gray-900 dark:text-white">expertise locale et nos certifications</strong>, nous assurons des systèmes performants, discrets et économes, parfaitement intégrés au cadre de vie mérignacais.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec plus de <strong className="text-gray-900 dark:text-white">70 000 habitants</strong>, Mérignac est la deuxième plus grande ville de Gironde, combinant activité économique, pôles d'affaires, et zones résidentielles très recherchées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Grâce à sa proximité immédiate avec Bordeaux et à son <strong className="text-gray-900 dark:text-white">accessibilité (tramway A, rocade, aéroport)</strong>, la ville attire aussi bien les familles que les actifs en quête de confort de vie.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient régulièrement dans les quartiers d'<strong className="text-gray-900 dark:text-white">Arlac, Capeyron, Beaudésert ou Bourranville</strong>. Nos installations s'intègrent aussi bien dans les maisons des années 60 que dans les programmes neufs.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  La <strong className="text-gray-900 dark:text-white">diversité des habitats</strong> à Mérignac impose une expertise fine : maisons mitoyennes, immeubles collectifs, lotissements récents... Chaque projet est dimensionné sur mesure.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Ville Résidentielle</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Accessibilité Optimale</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Diversité Urbaine</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Grâce à sa proximité immédiate avec Bordeaux et à son <strong className="text-gray-900 dark:text-white">accessibilité (tramway A, rocade, aéroport)</strong>, la ville attire aussi bien les familles que les actifs.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Nos techniciens prennent aussi en compte la <strong className="text-gray-900 dark:text-white">densité urbaine et les contraintes acoustiques</strong> pour garantir un confort maximal.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Que ce soit pour une <strong className="text-gray-900 dark:text-white">installation neuve</strong>, un remplacement ou un entretien régulier, notre équipe vous accompagne à chaque étape.
                      </p>
                      <p>
                        Profitez de notre <strong className="text-gray-900 dark:text-white">expertise locale</strong> pour votre logement ou votre local professionnel à Mérignac.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Spécialistes des <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">ville résidentielles dynamiques</strong>. Connaissance parfaite des spécificités de Mérignac, proche Bordeaux et aéroport.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">PAC, climatiseurs et chauffe-eaux</strong> sélectionnés pour assurer efficacité, discrétion et durabilité, maison individuelle ou lotissement.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Prise en compte de la <strong className="text-[#2563EB] dark:text-[#60A5FA]">densité urbaine et contraintes acoustiques</strong>. Confort maximal et intégration discrète des équipements.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">proximité et rigueur</strong> garantissent un service rapide, des finitions soignées, et un accompagnement administratif complet.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Mérignac</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
