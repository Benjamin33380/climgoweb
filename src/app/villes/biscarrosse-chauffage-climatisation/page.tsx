    ...
    <main className="px-0">
      <section className="hero-mobile-section relative h-[100vh] xs:h-[95vh] sm:h-[90vh] min-h-[500px] xs:min-h-[550px] sm:min-h-[600px] md:min-h-[640px] lg:min-h-[700px] xl:min-h-[750px] w-full overflow-hidden bg-transparent sm:bg-white sm:dark:bg-black text-black dark:text-white">
        ...
        <div className="absolute top-0 left-0 h-full w-full z-1 sm:hidden">
          <Image
            src="/villes/bisca.webp"
            alt="Biscarrosse - Côte Atlantique"
            fill
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                <p className="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white leading-normal">
                  Nichée entre <strong className="text-black dark:text-white">Atlantique et grands lacs</strong>, Biscarrosse offre un environnement exceptionnel. Station balnéaire vivante, elle attire familles, retraités et jeunes actifs.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Du centre-ville à <strong className="text-black dark:text-white">Biscarrosse-Plage</strong>, en passant par les quartiers résidentiels, ClimGO propose des solutions sur mesure, adaptées aux spécificités locales.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Nos systèmes tiennent compte du <strong className="text-black dark:text-white">climat océanique</strong> et des exigences énergétiques pour garantir confort et performance toute l'année.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Biscarrosse séduit par son <strong className="text-black dark:text-white">cadre naturel unique</strong> : dunes, forêt landaise, plages de sable fin et grands lacs.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  La ville se divise entre <strong className="text-black dark:text-white">Biscarrosse-Bourg</strong>, cœur de vie locale, et Biscarrosse-Plage, plus touristique, avec forte activité estivale.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Zones résidentielles autour du <strong className="text-black dark:text-white">lac Nord, lotissements Naouas</strong>, maisons typiques avenue Georges Clemenceau ou quartier du Vivier.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Entre <strong className="text-black dark:text-white">humidité marine et variations température</strong>, vents d'ouest fréquents : installations dimensionnées précisément pour résister corrosion et air salin.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Station Entre Lacs et Océan</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Contraintes Océaniques</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Expertise Côte Landaise</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Elle attire aussi bien les familles en quête de calme que les <strong className="text-black dark:text-white">sportifs et amoureux de la nature</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Entre <strong className="text-black dark:text-white">humidité marine et variations de température</strong>, chaque installation nécessite un dimensionnement précis.
                      </p>
                      <p>
                        Nos solutions pensées pour résister à la <strong className="text-black dark:text-white">corrosion et à l'air salin</strong>, unités extérieures surélevées et ventilées.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous êtes <strong className="text-black dark:text-white">propriétaire, bailleur saisonnier ou résident à l'année</strong> ? Nous vous accompagnons avec écoute et professionnalisme.
                      </p>
                      <p>
                        N'hésitez pas à nous contacter pour une <strong className="text-black dark:text-white">étude sur mesure, sans engagement</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Équipes <strong className="text-black dark:text-white">proches de Biscarrosse</strong> connaissent parfaitement les contraintes climatiques de la côte landaise.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Installations de <strong className="text-black dark:text-white">systèmes fiables, performants et discrets</strong>, en accord avec l'esthétique locale.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Solutions pensées pour résister à la <strong className="text-black dark:text-white">corrosion et à l'air salin</strong>, unités extérieures surélevées et ventilées.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre <strong className="text-black dark:text-white">proximité garantit réactivité</strong>, accompagnement et suivi personnalisé pour tous vos projets.
                  </p>
                </div>
              </div>
            </div>
