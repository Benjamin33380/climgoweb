...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Biscarrosse 40600 | ClimGO',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Biscarrosse 40600 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Biscarrosse 40600 | ClimGO',
    'DC.description': 'Expert chauffage climatisation Biscarrosse 40600. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
