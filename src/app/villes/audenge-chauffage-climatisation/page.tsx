    ...
    <main className="px-0">
      <section className="hero-mobile-section relative h-[100vh] xs:h-[95vh] sm:h-[90vh] min-h-[500px] xs:min-h-[550px] sm:min-h-[600px] md:min-h-[640px] lg:min-h-[700px] xl:min-h-[750px] w-full overflow-hidden bg-transparent sm:bg-white sm:dark:bg-black text-black dark:text-white">
        ...
        <div className="absolute top-0 left-0 h-full w-full z-1 sm:hidden">
          <Image
            src="/villes/audenge.webp"
            alt="Audenge - Bassin d'Arcachon"
            fill
      ...
      {/* Section Audenge - Texte défilant au scroll */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                <p className="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white leading-normal">
                  Située entre forêt, bassin et tranquillité, <strong className="text-black dark:text-white">Audenge</strong> est une commune prisée pour sa qualité de vie. Ses maisons individuelles, ses lotissements récents et ses bâtisses anciennes demandent des solutions thermiques bien pensées.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Nous intervenons aussi dans les lieux-dits voisins comme <strong className="text-black dark:text-white">Hougueyra</strong>, <strong className="text-black dark:text-white">Lubec</strong>, la <strong className="text-black dark:text-white">Pointe Émile</strong> ou encore <strong className="text-black dark:text-white">Bas-Vallon</strong>, pour garantir le même niveau de confort et d'exigence.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Que vous soyez à proximité du <strong className="text-black dark:text-white">port d'Audenge</strong>, du <strong className="text-black dark:text-white">Domaine de Certes</strong> ou en plein cœur de la commune, ClimGO vous accompagne avec des installations adaptées à chaque configuration.
                </p>
                ...
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec notre connaissance du secteur et nos <strong className="text-black dark:text-white">certifications</strong>, nous garantissons un confort optimal en toutes saisons, sans dénaturer l'esthétique de votre maison.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Notre équipe d'<strong className="text-black dark:text-white">experts certifiés</strong> intervient dans tous les quartiers d'Audenge, des maisons de lotissement aux bâtisses en pierre, en respectant les spécificités locales.
                </p>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Tous les secteurs d'Audenge</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Diversité des Habitats</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Excellence Environnementale</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        <strong className="text-black dark:text-white">Audenge</strong> charme ses habitants par sa douceur de vivre entre forêt domaniale et rives du bassin. Cette situation privilégiée attire de plus en plus de familles, de retraités actifs et de jeunes propriétaires.
                      </p>
                      <p>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous soyez propriétaire d'une résidence principale, secondaire ou en rénovation, <strong className="text-black dark:text-white">ClimGO</strong> est votre partenaire local pour un confort maîtrisé.
                      </p>
                      <p>
                        Contactez-nous et obtenez une <strong className="text-black dark:text-white">étude gratuite</strong> adaptée à votre habitation audengeoise.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Connaissance approfondie</strong> du secteur audengeois et de ses spécificités climatiques. <strong className="text-black dark:text-white">Maîtrise parfaite</strong> des contraintes locales.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Équipements sélectionnés</strong> pour garantir efficacité et discrétion. <strong className="text-black dark:text-white">Respect de l'environnement</strong> et de l'esthétique de votre maison.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Service local</strong> avec intervention rapide sur Audenge et ses secteurs. <strong className="text-black dark:text-white">Réactivité</strong> dans tous les quartiers de la commune.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Suivi rigoureux</strong> de chaque projet et <strong className="text-black dark:text-white">maintenance préventive</strong> pour préserver performances et économies d'énergie.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Audenge</h3>
                <p className="text-black dark:text-white leading-relaxed text-center text-lg flex-grow">
