            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                <p className="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Située entre forêt et dynamisme périurbain</strong>, Saint-Aubin-de-Médoc offre un cadre de vie privilégié pour ses habitants.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Des quartiers de <strong className="text-black dark:text-white">La Canau</strong> à celui du Bourg, ClimGO vous accompagne avec des installations de qualité, pensées pour durer.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Nous intervenons sur tous types d'habitations aubinoises, avec des <strong className="text-black dark:text-white">solutions sur mesure alliant performance, discrétion et esthétique</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  À moins de 30 minutes de Bordeaux, Saint-Aubin-de-Médoc séduit par son <strong className="text-black dark:text-white">cadre boisé, ses grands terrains et son ambiance résidentielle haut de gamme</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec un peu plus de <strong className="text-black dark:text-white">7 000 habitants</strong>, la commune attire les familles et cadres en quête de tranquillité et d'espace.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Villas d'architecte, maisons traditionnelles ou nouvelles constructions RT2012</strong>, chaque projet demande une attention particulière.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Environnement Privilégié</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Population et Attractivité</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Quartiers Desservis</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Avec un peu plus de 7 000 habitants, la commune attire les <strong className="text-black dark:text-white">familles et cadres en quête de tranquillité et d'espace</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Le <strong className="text-black dark:text-white">relief plat, les haies hautes et l'ombre permanente</strong> influencent le choix des équipements à Saint-Aubin-de-Médoc.
                      </p>
                      <p>
                        Nous veillons à préserver la <strong className="text-black dark:text-white">tranquillité sonore et l'esthétique extérieure</strong>, souvent recherchées dans les zones pavillonnaires entourées de pins.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous envisagez une <strong className="text-black dark:text-white">rénovation, une construction ou un simple remplacement d'équipement</strong> ?
                      </p>
                      <p>
                        ClimGO vous accompagne à Saint-Aubin-de-Médoc avec des <strong className="text-black dark:text-white">solutions sur mesure</strong>. Contactez-nous pour un devis clair et une étude personnalisée.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous connaissons parfaitement les <strong className="text-black dark:text-white">particularités de Saint-Aubin-de-Médoc</strong> et adaptons nos solutions aux réalités locales.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous combinons <strong className="text-black dark:text-white">efficacité, discrétion et adaptabilité</strong> pour chaque projet, du pavillon familial à la maison contemporaine.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre équipe vous accompagne aussi dans toutes vos <strong className="text-black dark:text-white">démarches administratives, avec rigueur et disponibilité</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Maisons récentes, demeures de caractère ou lotissements résidentiels</strong> : nous adaptons chaque installation aux spécificités de Saint-Aubin-de-Médoc.
                  </p>
                </div>
              </div>
            </div>
