...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Saint-Aubin-de-Medoc 33160 | ClimGO',
  description: 'Expert chauffage climatisation Saint-Aubin-de-Medoc 33160. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Saint-Aubin-de-Medoc 33160 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Saint-Aubin-de-Medoc 33160 | ClimGO',
    'DC.description': 'Expert chauffage climatisation Saint-Aubin-de-Medoc 33160. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://www.climgo.fr/villes/saint-aubin-de-medoc-chauffage-climatisation',
...
export default function SaintAubindeMedocLayout({
  ...
  return (
    <>
      <JsonLd type="city" city="Saint-Aubin-de-Medoc" postalCode="33160" />
      {children}
    </>
  );
}