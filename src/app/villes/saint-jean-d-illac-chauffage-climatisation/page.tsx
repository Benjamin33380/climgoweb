  ...
  return (
    <main className="px-0">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Située entre Bordeaux et le bassin d'Arcachon</strong>, Saint-Jean-d'Illac offre un cadre de vie paisible, dynamique et arboré.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Que vous soyez dans un <strong className="text-black dark:text-white">lotissement récent, près du Bourg ou du côté de la plaine forestière</strong>, ClimGO vous propose des solutions thermiques adaptées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nos installations s'intègrent parfaitement aux <strong className="text-black dark:text-white">habitations illacaises, avec discrétion et performance</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Saint-Jean-d'Illac attire chaque année de nouveaux habitants grâce à sa <strong className="text-black dark:text-white">position stratégique entre Bordeaux, Mérignac et le bassin d'Arcachon</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec plus de <strong className="text-black dark:text-white">8 000 habitants</strong>, la commune allie qualité de vie, calme forestier et dynamisme immobilier.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les familles apprécient les <strong className="text-black dark:text-white">infrastructures scolaires et la proximité de la D106</strong> pour rejoindre rapidement l'aéroport ou la rocade.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Évolution Démographique</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Quartiers Couverts</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Avec plus de 8 000 habitants, la commune allie <strong className="text-black dark:text-white">qualité de vie, calme forestier et dynamisme immobilier</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Le <strong className="text-black dark:text-white">sol sablonneux et les nombreuses zones boisées</strong> imposent une vigilance particulière pour les installations extérieures.
                      </p>
                      <p>
                        Nous tenons aussi compte de l'<strong className="text-black dark:text-white">exposition des logements illacais, souvent orientés nord/sud</strong> avec peu de protections solaires, pour adapter la puissance et le type d'équipements.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous soyez <strong className="text-black dark:text-white">propriétaire, primo-accédant ou en rénovation</strong>, notre équipe se tient à votre disposition pour échanger sur votre confort thermique à Saint-Jean-d'Illac.
                      </p>
                      <p>
                        Vous pouvez nous joindre en quelques clics via notre <strong className="text-black dark:text-white">formulaire ou par téléphone</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Choisir ClimGO à Saint-Jean-d'Illac, c'est s'appuyer sur un <strong className="text-black dark:text-white">savoir-faire local et des équipements pensés pour le climat illacais</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous veillons à proposer des <strong className="text-black dark:text-white">solutions silencieuses, esthétiques et économes en énergie</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre accompagnement personnalisé vous assure une <strong className="text-black dark:text-white">installation sereine, durable et conforme</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Maisons neuves, habitats de lotissements, résidences en zone boisée</strong> : nous adaptons chaque installation aux spécificités de Saint-Jean-d'Illac.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Saint-Jean-d'Illac</h3>
                <p className="text-black dark:text-white leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="saint-jean-d-illac" />
