...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{
      url: 'https://www.climgo.fr/images/og/saint-jean-d-illac-chauffage-climatisation.jpg',
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Saint-Jean-d\'Illac 33127 | ClimGO',
    description: 'Expert chauffage climatisation Saint-Jean-d\'Illac 33127. Installation PAC, dépannage, entretien. Artisan RGE.',
  ...
  other: {
    ...
    'DC.description': 'Expert chauffage climatisation Saint-Jean-d\'Illac 33127. Installation PAC, dépannage, entretien. Artisan RGE.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://www.climgo.fr/villes/saint-jean-d-illac-chauffage-climatisation',
