    ...
    <main className="px-0">
      <section className="hero-mobile-section relative h-[100vh] xs:h-[95vh] sm:h-[90vh] min-h-[500px] xs:min-h-[550px] sm:min-h-[600px] md:min-h-[640px] lg:min-h-[700px] xl:min-h-[750px] w-full overflow-hidden bg-transparent sm:bg-white sm:dark:bg-black text-black dark:text-white">
        ...
        <div className="absolute top-0 left-0 h-full w-full z-1 sm:hidden">
          <Image
            src="/villes/mimizan.webp"
            alt="Mimizan - Côte Atlantique"
            fill
      ...
      {/* Section Mimizan - Texte défilant au scroll */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                <p className="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Station balnéaire prisée</strong> de la côte landaise, Mimizan allie dynamisme côtier et douceur de vivre au cœur des Landes.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Du <strong className="text-black dark:text-white">front de mer</strong> aux lotissements boisés, ClimGO adapte ses solutions aux habitations variées de Mimizan, qu'elles soient récentes ou anciennes.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Nous tenons compte des <strong className="text-black dark:text-white">spécificités salines et climatiques</strong> propres à la façade Atlantique pour garantir des installations fiables et durables.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située au cœur des Landes, <strong className="text-black dark:text-white">Mimizan</strong> séduit par son cadre naturel exceptionnel, entre pins maritimes, plages de sable fin et étangs paisibles.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  La commune compte environ <strong className="text-black dark:text-white">7 000 habitants</strong> et attire chaque année de nouveaux résidents et vacanciers grâce à son cadre de vie privilégié.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO intervient aussi bien dans le <strong className="text-black dark:text-white">centre de Mimizan-Bourg</strong> que dans les quartiers résidentiels proches de Mimizan-Plage ou de la route de Bias.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  À Mimizan, l'<strong className="text-black dark:text-white">humidité de l'air et le vent marin</strong> exigent des équipements résistants à la corrosion et un entretien rigoureux pour garantir la durabilité.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Station Balnéaire</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Habitat Côtier</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Climat Océanique</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="hidden md:block absolute right-0 top-0 bottom-0 w-90 bg-gradient-to-l from-white via-white/80 to-transparent dark:from-black dark:via-black/80 z-10 pointer-events-none" />
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        À Mimizan, l'<strong className="text-black dark:text-white">humidité de l'air et le vent marin</strong> exigent des équipements résistants à la corrosion et un entretien rigoureux.
                      </p>
                      <p>
                        Nos <strong className="text-black dark:text-white">PAC sont sélectionnées</strong> pour leur fiabilité en bord de mer et nous anticipons les fortes amplitudes thermiques.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que ce soit pour votre <strong className="text-black dark:text-white">résidence principale</strong>, une location saisonnière ou une maison de vacances, ClimGO est votre partenaire de confiance.
                      </p>
                      <p>
                        Contactez-nous pour un <strong className="text-black dark:text-white">devis personnalisé</strong> et adapté à vos besoins locaux à Mimizan.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Savoir-faire éprouvé</strong> alliant expertise technique et connaissance du territoire. Adaptation parfaite au <strong className="text-black dark:text-white">dynamisme côtier</strong> landais.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Équipements fiables</strong> et performants, compatibles avec les spécificités thermiques des <strong className="text-black dark:text-white">logements landais</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Équipements résistants</strong> à la corrosion et entretien rigoureux. PAC sélectionnées pour leur <strong className="text-black dark:text-white">fiabilité en bord de mer</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Installés à proximité</strong>, nous garantissons une grande réactivité, un <strong className="text-black dark:text-white">suivi rigoureux</strong> et des réalisations soignées à Mimizan.
                  </p>
                </div>
              </div>
            </div>
