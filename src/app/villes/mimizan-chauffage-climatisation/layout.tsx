...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Mimizan 40200 | Expert Local | ClimGO',
  ...
  openGraph: {
    title: 'Chauffage Climatisation Mimizan 40200 | Expert Local | ClimGO',
    description: 'ClimGO, expert chauffage climatisation Mimizan 40200. Installation PAC, dépannage urgent, entretien. Artisan RGE certifié. Devis gratuit.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Mimizan 40200 - ClimGO Expert Local',
    }],
  },
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Mimizan 40200 | Expert Local | ClimGO',
    description: 'Expert chauffage climatisation Mimizan 40200. Installation PAC, dépannage urgent. Artisan RGE certifié.',
