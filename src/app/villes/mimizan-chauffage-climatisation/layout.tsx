...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Mimizan - Chauffage & Climatisation",
    template: "%s | ClimGO Mimizan"
  },
  description: "Expert chauffage climatisation Mimizan 40200. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.",
  keywords: ["chauffage Mimizan", "climatisation Mimizan", "pompe à chaleur Mimizan", "installation PAC Mimizan", "entretien chauffage Mimizan", "artisan RGE Mimizan", "PAC air-eau Mimizan", "PAC air-air Mimizan", "plancher chauffant Mimizan", "radiateurs Mimizan", "maintenance Mimizan", "dépannage Mimizan", "devis gratuit Mimizan"],
  ...
  openGraph: {
    ...
    title: "ClimGO Mimizan - Chauffage & Climatisation",
    description: "Expert chauffage climatisation Mimizan 40200. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.",
    siteName: "ClimGO",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ClimGO Mimizan - Chauffage & Climatisation | Installation PAC, Entretien",
      },
    ],
  },
  icons: {
  ...
  alternates: {
    ...
    languages: {
      'x-default': 'https://www.climgo.fr/villes/mimizan-chauffage-climatisation',
      'fr-FR': 'https://www.climgo.fr/villes/mimizan-chauffage-climatisation',
    },
  },
  verification: {
  ...
  other: {
    "zones-desservies": "Mimizan, Landes, Nouvelle-Aquitaine",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "ClimGO Mimizan",
    "application-name": "ClimGO Mimizan",
...
export default function MimizanLayout({
  ...
  // Coordonnées de la mairie de Mimizan
  const mimizanCoords = getCityCoordinates('mimizan');
  
  return (
    <>
      {/* Schéma JSON-LD principal - LocalBusiness pour Mimizan */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "ClimGO, expert chauffage et climatisation à Mimizan. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "address": {
                "@type": "PostalAddress",
              ...
              // Données géographiques de la mairie de Mimizan
              "geo": mimizanCoords ? generateGeoJsonLd(mimizanCoords, "Mairie de Mimizan") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
              ...
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "Services ClimGO Mimizan",
                "itemListElement": [
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Chauffage Mimizan",
                      "description": "Installation et maintenance de systèmes de chauffage, PAC, planchers chauffants à Mimizan",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Climatisation Mimizan",
                      "description": "Installation et maintenance de systèmes de climatisation à Mimizan",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Eau Chaude Sanitaire Mimizan",
                      "description": "Installation et maintenance de systèmes d'eau chaude sanitaire à Mimizan",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Maintenance Mimizan",
                      "description": "Entretien et dépannage de vos équipements thermiques à Mimizan",
        ...
        {/* JSON-LD pour la page web de Mimizan */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "name": "ClimGO Mimizan - Chauffage & Climatisation",
              "url": "https://www.climgo.fr/villes/mimizan-chauffage-climatisation",
              "description": "ClimGO, expert chauffage et climatisation à Mimizan. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "potentialAction": {
                "@type": "SearchAction",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ItemList",
              "name": "Services ClimGO Mimizan",
              "description": "Liste des services proposés par ClimGO à Mimizan",
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
        ...
        {/* JSON-LD FAQ - Questions génériques pour Mimizan (ville faible) */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
