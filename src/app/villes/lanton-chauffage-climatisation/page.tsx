    ...
    <main className="px-0">
      <section className="hero-mobile-section relative h-[100vh] xs:h-[95vh] sm:h-[90vh] min-h-[500px] xs:min-h-[550px] sm:min-h-[600px] md:min-h-[640px] lg:min-h-[700px] xl:min-h-[750px] w-full overflow-hidden bg-transparent sm:bg-white sm:dark:bg-black text-black dark:text-white">
        ...
        <div className="absolute top-0 left-0 h-full w-full z-1 sm:hidden">
          <Image
            src="/villes/lanton.webp"
            alt="Lanton - Bassin d'Arcachon"
            fill
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                <p className="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white leading-normal">
                  Située entre Andernos et Audenge, Lanton est une <strong className="text-black dark:text-white">commune paisible du bassin d'Arcachon</strong>, réputée pour ses plages et ses sentiers côtiers.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Que vous habitiez à <strong className="text-black dark:text-white">Taussat, Cassy ou au centre-ville</strong>, ClimGO vous accompagne avec des solutions de chauffage et de climatisation sur mesure.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Située au bord du bassin d'Arcachon, Lanton est une <strong className="text-black dark:text-white">commune calme et prisée</strong> pour son authenticité et sa qualité de vie.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec ses hameaux <strong className="text-black dark:text-white">(Cassy, Taussat, Blagon, Grand Lanton)</strong>, elle séduit aussi bien les familles que les retraités ou les jeunes actifs.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nous accompagnons les <strong className="text-black dark:text-white">familles, retraités et nouveaux arrivants</strong> dans leurs projets d'installation, en respectant les zones naturelles protégées et les spécificités locales.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  L'<strong className="text-black dark:text-white">humidité de l'air marin, la proximité des pins</strong> et les variations de température imposent une sélection rigoureuse des équipements.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Chaque intervention vise à <strong className="text-black dark:text-white">optimiser la performance énergétique</strong> de votre logement tout en préservant son intégration dans ce cadre naturel exceptionnel.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Commune Paisible du Bassin</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Hameaux Authentiques</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Accompagnement Personnalisé</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Expertise Littorale Adaptée</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        On y trouve un bon équilibre entre <strong className="text-black dark:text-white">maisons anciennes, villas récentes</strong> et programmes neufs avec plages paisibles.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Nous choisissons des <strong className="text-black dark:text-white">PAC et climatiseurs spécialement traités</strong> pour résister aux conditions côtières.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Faites appel à ClimGO pour votre projet de <strong className="text-black dark:text-white">chauffage, climatisation ou chauffe-eau</strong> à Lanton.
                      </p>
                      <p>
                        Nous vous conseillons avec précision et <strong className="text-black dark:text-white">intervenons rapidement</strong>, que vous habitiez Cassy, Taussat ou Grand Lanton.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    S'assurer d'un <strong className="text-black dark:text-white">service de proximité</strong>, respectueux de l'environnement local et des contraintes climatiques du bassin.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre <strong className="text-black dark:text-white">réactivité et notre exigence</strong> font la différence à chaque étape de votre projet à Lanton.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Matériaux performants, normes rigoureuses</strong> et finitions impeccables : chaque projet traité avec la plus grande exigence.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité nous permet d'<strong className="text-black dark:text-white">intervenir rapidement</strong> sur tout Lanton, pour dépannages ou installations urgentes.
                  </p>
                </div>
              </div>
            </div>
