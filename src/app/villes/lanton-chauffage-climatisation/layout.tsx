...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ClimGO Lanton - Chauffage & Climatisation | Installation PAC, Entretien",
      },
    ],
  },
  ...
  other: {
    "zones-desservies": "Lanton, Bassin d'Arcachon, Gironde, Nouvelle-Aquitaine",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "ClimGO Lanton",
    "application-name": "ClimGO Lanton",
...
export default function LantonLayout({
  ...
  // Coordonnées de la mairie de Lanton
  const lantonCoords = getCityCoordinates('lanton');
  
  return (
    <>
      {/* Schéma JSON-LD principal - LocalBusiness pour Lanton */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Lanton
              "geo": lantonCoords ? generateGeoJsonLd(lantonCoords, "Mairie de Lanton") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
              ...
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "Services ClimGO Lanton",
                "itemListElement": [
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Chauffage Lanton",
                      "description": "Installation et maintenance de systèmes de chauffage, PAC, planchers chauffants à Lanton",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Climatisation Lanton",
                      "description": "Installation et maintenance de systèmes de climatisation à Lanton",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Eau Chaude Sanitaire Lanton",
                      "description": "Installation et maintenance de systèmes d'eau chaude sanitaire à Lanton",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Maintenance Lanton",
                      "description": "Entretien et dépannage de vos équipements thermiques à Lanton",
        ...
        {/* JSON-LD pour la page web de Lanton */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "name": "ClimGO Lanton - Chauffage & Climatisation",
              "url": "https://www.climgo.fr/villes/lanton-chauffage-climatisation",
              "description": "ClimGO, expert chauffage et climatisation à Lanton. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "potentialAction": {
                "@type": "SearchAction",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ItemList",
              "name": "Services ClimGO Lanton",
              "description": "Liste des services proposés par ClimGO à Lanton",
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
        ...
        {/* JSON-LD FAQ - Questions génériques pour Lanton (ville faible) */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
