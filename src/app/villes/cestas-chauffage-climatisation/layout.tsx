...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Cestas - Chauffage & Climatisation",
  ...
  openGraph: {
    ...
    title: "ClimGO Cestas - Chauffage & Climatisation",
    description: "Expert chauffage climatisation à Cestas. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié.",
    siteName: "ClimGO",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ClimGO Cestas - Chauffage & Climatisation | Installation PAC, Entretien",
      },
    ],
  },
  ...
  other: {
    "zones-desservies": "Cestas, Bordeaux Métropole, Gironde, Nouvelle-Aquitaine",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "ClimGO Cestas",
    "application-name": "ClimGO Cestas",
...
export default function CestasLayout({
  ...
  // Coordonnées de la mairie de Cestas
  const cestasCoords = getCityCoordinates('cestas');
  
  return (
    <>
      {/* Schéma JSON-LD principal - LocalBusiness pour Cestas */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Cestas
              "geo": cestasCoords ? generateGeoJsonLd(cestasCoords, "Mairie de Cestas") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
              ...
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "Services ClimGO Cestas",
                "itemListElement": [
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Chauffage Cestas",
                      "description": "Installation et maintenance de systèmes de chauffage, PAC, planchers chauffants à Cestas",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Climatisation Cestas",
                      "description": "Installation et maintenance de systèmes de climatisation à Cestas",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Eau Chaude Sanitaire Cestas",
                      "description": "Installation et maintenance de systèmes d'eau chaude sanitaire à Cestas",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Maintenance Cestas",
                      "description": "Entretien et dépannage de vos équipements thermiques à Cestas",
        ...
        {/* JSON-LD pour la page web de Cestas */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "name": "ClimGO Cestas - Chauffage & Climatisation",
              "url": "https://www.climgo.fr/villes/cestas-chauffage-climatisation",
              "description": "ClimGO, expert chauffage et climatisation à Cestas. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "potentialAction": {
                "@type": "SearchAction",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ItemList",
              "name": "Services ClimGO Cestas",
              "description": "Liste des services proposés par ClimGO à Cestas",
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
        ...
        {/* JSON-LD FAQ - Questions intermédiaires pour Cestas (ville moyenne) */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Intervenez-vous à domicile sur Cestas ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO intervient à domicile sur Cestas et ses environs. Nos techniciens se déplacent chez vous pour l'installation, la maintenance et le dépannage de vos équipements de chauffage et climatisation."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Proposez-vous des devis gratuits à Cestas ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Absolument ! ClimGO propose des devis gratuits et sans engagement à Cestas. Nos experts évaluent vos besoins et vous proposent la solution la plus adaptée à votre projet."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Quels sont vos délais d'intervention à Cestas ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "À Cestas, ClimGO s'engage sur des délais rapides : devis sous 24h, installation sous 15 jours et dépannage d'urgence sous 4h. Nous assurons votre confort rapidement."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Êtes-vous certifiés RGE pour Cestas ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO est certifié RGE (Reconnu Garant de l'Environnement). Cette certification vous permet de bénéficier des aides de l'État et garantit la qualité de nos installations sur Cestas."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Pouvez-vous m'aider avec MaPrimeRénov' à Cestas ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO vous accompagne dans vos démarches MaPrimeRénov' à Cestas. Nous calculons les montants éligibles et vous aidons à obtenir jusqu'à 90% d'aides selon vos revenus."
                  }
                }
              ]
            })
