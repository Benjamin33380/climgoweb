            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Léognan, réputée pour ses vignobles et son cadre de vie paisible</strong>, est une commune où confort thermique et esthétique vont de pair.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située au cœur des Graves, Léognan offre un <strong className="text-black dark:text-white">cadre de vie recherché mêlant tradition viticole, nature préservée et proximité urbaine</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec plus de 10 000 habitants, la ville <strong className="text-black dark:text-white">séduit autant les familles que les actifs bordelais</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les habitants profitent de nombreux services : <strong className="text-black dark:text-white">établissements scolaires, zones commerciales, infrastructures sportives</strong> et un accès rapide à la rocade via la D1010.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Que vous viviez près du centre, du quartier Larrieu ou vers les châteaux viticoles, <strong className="text-black dark:text-white">ClimGO vous accompagne pour des installations performantes</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nos réalisations à Léognan <strong className="text-black dark:text-white">s'intègrent parfaitement à l'architecture locale</strong>, avec un savoir-faire alliant efficacité et discrétion.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Charme Viticole</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Services Nombreux</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Installations Performantes</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Le tissu résidentiel mêle <strong className="text-black dark:text-white">maisons neuves, lotissements des années 90 et bâtisses anciennes en pierre</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        À Léognan, les <strong className="text-black dark:text-white">variations de températures entre vignes et forêts, ainsi que l'humidité ambiante</strong>, exigent des installations robustes et bien dimensionnées.
                      </p>
                      <p>
                        Nous adaptons nos systèmes en fonction de l'exposition des maisons et des contraintes énergétiques, pour garantir un <strong className="text-black dark:text-white">confort optimal toute l'année</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous soyez <strong className="text-black dark:text-white">viticulteur, famille installée ou jeune propriétaire</strong>, nous vous accompagnons dans vos projets de chauffage, climatisation ou chauffe-eau à Léognan.
                      </p>
                      <p>
                        Prenez contact avec notre équipe pour une <strong className="text-black dark:text-white">étude gratuite et sans engagement</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    S'assurer une <strong className="text-black dark:text-white">expertise locale adaptée aux logements résidentiels comme aux propriétés viticoles</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Pompes à chaleur, climatisation gainable, chauffe-eaux économiques</strong> : nous concevons des solutions sur-mesure pour chaque besoin.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre présence à proximité garantit une <strong className="text-black dark:text-white">intervention rapide et un suivi personnalisé</strong> tout au long de votre projet.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Maisons familiales, propriétés viticoles, pavillons modernes</strong> : nous adaptons chaque installation aux spécificités des habitations de Léognan.
                  </p>
                </div>
              </div>
            </div>
