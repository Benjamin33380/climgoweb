...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Leognan 33850 | ClimGO Expert Local',
  ...
  keywords: 'climatisation gironde, chauffage gironde, pompe à chaleur gironde, chauffagiste bordeaux, installateur climatisation, artisan RGE, installation PAC air eau, entretien climatisation, dépannage chauffage, chaudière gaz condensation, plancher chauffant, radiateurs électriques, maintenance pompe à chaleur, réparation climatisation, devis gratuit, intervention urgence, certificat RGE, MaPrimeRénov, aide financière chauffage, prime CEE, crédit impôt, économie énergie, rénovation énergétique, audit énergétique, chauffage léognan, climatisation léognan, chauffagiste léognan, pompe à chaleur léognan, installation PAC léognan, dépannage chauffage léognan, entretien climatisation léognan, artisan RGE léognan, chaudière léognan, maintenance léognan, expert chauffage 33850, climatisation 33850, chauffagiste 33850, devis gratuit léognan, intervention urgence léognan, spécialiste CVC léognan, entreprise chauffage léognan, installateur agréé léognan, technicien qualifié léognan, service après-vente léognan',
  ...
  openGraph: {
    ...
    url: 'https://climgo.fr/villes/leognan-chauffage-climatisation',
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Leognan 33850 | ClimGO Expert Local',
    description: 'Expert chauffage climatisation Leognan. Installation PAC, dépannage urgent. Artisan RGE certifié.',
    images: ['https://climgo.fr/images/twitter-leognan-chauffage-climatisation.jpg'],
  },
  ...
  other: {
    ...
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://climgo.fr/villes/leognan-chauffage-climatisation',
  ...
  alternates: {
    canonical: 'https://climgo.fr/villes/leognan-chauffage-climatisation',
  },
