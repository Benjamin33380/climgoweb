...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Léognan - Chauffage & Climatisation",
  ...
  openGraph: {
    ...
    title: "ClimGO Léognan - Chauffage & Climatisation",
    description: "Expert chauffage climatisation à Léognan. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié.",
    siteName: "ClimGO",
    images: [
      {
...
export default function LeognanLayout({
  ...
  // Coordonnées de la mairie de Léognan
  const leognanCoords = getCityCoordinates('leognan');
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Léognan
              "geo": leognanCoords ? generateGeoJsonLd(leognanCoords, "Mairie de Léognan") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
