...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Leognan 33850 | ClimGO',
  description: 'Expert chauffage climatisation Leognan 33850. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Leognan 33850 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Leognan 33850 | ClimGO',
    'DC.description': 'Expert chauffage climatisation Leognan 33850. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
