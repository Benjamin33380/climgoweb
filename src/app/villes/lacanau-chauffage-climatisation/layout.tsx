...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Lacanau - Chauffage & Climatisation",
  ...
  openGraph: {
    ...
    title: "ClimGO Lacanau - Chauffage & Climatisation",
    description: "Expert chauffage climatisation Lacanau 33680. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.",
    siteName: "ClimGO",
    images: [
      {
...
export default function LacanauLayout({
  ...
  // Coordonnées de la mairie de Lacanau
  const lacanauCoords = getCityCoordinates('lacanau');
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Lacanau
              "geo": lacanauCoords ? generateGeoJsonLd(lacanauCoords, "Mairie de Lacanau") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
