...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Lacanau 33680 | ClimGO',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Lacanau 33680 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Lacanau 33680 | ClimGO',
    'DC.description': 'Expert chauffage climatisation Lacanau 33680. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
