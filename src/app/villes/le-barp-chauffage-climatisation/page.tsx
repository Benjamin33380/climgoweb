            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  Située au cœur du Val de l'Eyre, la commune du Barp se distingue par son <strong className="text-black dark:text-white">environnement naturel remarquable</strong>, entre forêts de pins, rivières et sentiers boisés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Ce secteur, prisé pour son <strong className="text-black dark:text-white">calme et sa qualité de vie</strong>, attire aussi bien les familles que les jeunes actifs souhaitant conjuguer confort et nature.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Situé <strong className="text-black dark:text-white">entre Cestas et Salles</strong>, Le Barp bénéficie d'une situation privilégiée aux portes du parc naturel régional des Landes de Gascogne.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Le centre-bourg, les lotissements comme <strong className="text-black dark:text-white">Le Bourdieu ou Les Ecureuils</strong>, ainsi que les zones pavillonnaires récentes profitent d'un bon dynamisme résidentiel.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Que vous résidiez au centre-ville, à Haureuils, ou dans les hameaux environnants, ClimGO vous propose des <strong className="text-black dark:text-white">solutions de chauffage, climatisation et eau chaude sanitaire</strong> pensées pour répondre aux besoins spécifiques des maisons du Val de l'Eyre.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Entre <strong className="text-black dark:text-white">humidité, résine de pins et sols instables</strong>, Le Barp exige une installation précise et soignée avec plots béton adaptés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nos <strong className="text-black dark:text-white">systèmes sont conçus pour durer</strong> dans le temps, avec des solutions compatibles maison à étage, plain-pied, ou extension bois.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Village Nature Privilégié</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Situation Stratégique</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Solutions Spécialisées</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Expertise Environnement Forestier</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Situé entre Cestas et Salles, Le Barp bénéficie d'une <strong className="text-black dark:text-white">situation privilégiée aux portes du parc naturel régional</strong> des Landes de Gascogne.
                      </p>
                      <p>
                        Avec plus de 5 000 habitants, la commune séduit par sa <strong className="text-black dark:text-white">tranquillité, ses espaces boisés</strong> et son accessibilité directe via la RN250.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Entre <strong className="text-black dark:text-white">humidité, résine de pins et sols instables</strong>, Le Barp exige une installation précise et soignée.
                      </p>
                      <p>
                        Chez ClimGO, nous prévoyons <strong className="text-black dark:text-white">plots béton adaptés, gaines protégées</strong> et équipements traités anticorrosion.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Pour une <strong className="text-black dark:text-white">climatisation réversible, une pompe à chaleur</strong> ou un chauffe-eau performant, contactez notre équipe.
                      </p>
                      <p>
                        Nous vous accompagnons <strong className="text-black dark:text-white">pas à pas dans votre projet thermique</strong> au Barp.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Bénéficiez d'un <strong className="text-black dark:text-white">accompagnement de proximité</strong>, pensé pour les spécificités du Barp et ses alentours.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous utilisons uniquement du <strong className="text-black dark:text-white">matériel rigoureusement sélectionné</strong> pour sa fiabilité et performance, garantissant qualité et durabilité.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Situés à proximité, nous <strong className="text-black dark:text-white">intervenons rapidement</strong>, limitant les délais d'attente pour installation neuve ou maintenance.
                  </p>
                </div>
              </div>
            </div>
