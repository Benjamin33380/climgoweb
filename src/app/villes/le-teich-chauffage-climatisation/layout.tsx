...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Le Teich 33470 | Expert Local | ClimGO',
  ...
  openGraph: {
    title: 'Chauffage Climatisation Le Teich 33470 | Expert Local | ClimGO',
    description: 'ClimGO, expert chauffage climatisation Le Teich 33470. Installation PAC, dépannage urgent, entretien. Artisan RGE certifié. Devis gratuit.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Le Teich 33470 - ClimGO Expert Local',
    }],
  },
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Le Teich 33470 | Expert Local | ClimGO',
    description: 'Expert chauffage climatisation Le Teich 33470. Installation PAC, dépannage urgent. Artisan RGE certifié.',
