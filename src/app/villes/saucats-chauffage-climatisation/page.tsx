            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                ...
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Notre expertise locale nous permet de maîtriser les <strong className="text-black dark:text-white">spécificités climatiques</strong> du secteur : l'humidité forestière, les variations saisonnières et les contraintes d'accès propres aux zones résidentielles saucataises.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  À seulement <strong className="text-black dark:text-white">25 minutes de Bordeaux</strong>, Saucats bénéficie d'un environnement préservé où nos installations s'intègrent harmonieusement dans le respect de la <strong className="text-black dark:text-white">qualité paysagère</strong> locale.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  De la <strong className="text-black dark:text-white">pompe à chaleur silencieuse</strong> à la <strong className="text-black dark:text-white">climatisation discrète</strong>, nos solutions s'adaptent aux maisons avec grands terrains comme aux constructions plus compactes du centre-bourg.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Notre équipe d'<strong className="text-black dark:text-white">experts certifiés RGE</strong> intervient dans tous les secteurs de Saucats, des <strong className="text-black dark:text-white">lotissements récents</strong> aux <strong className="text-black dark:text-white">maisons traditionnelles</strong>, avec un service personnalisé.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nous garantissons un <strong className="text-black dark:text-white">accompagnement complet</strong> de A à Z : étude préalable, devis détaillé, installation soignée et maintenance préventive pour votre tranquillité d'esprit absolue.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Centre-bourg & zones résidentielles</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Habitat traditionnel & moderne</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Service nature et proximité</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Qualité et durabilité</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        À seulement 25 minutes de Bordeaux, <strong className="text-black dark:text-white">Saucats</strong> offre un environnement paisible en lisière de la forêt des Landes. Cette commune de près de 2 500 habitants séduit les familles recherchant calme, espace et qualité de vie.
                      </p>
                      <p>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous habitiez le centre de <strong className="text-black dark:text-white">Saucats</strong> ou ses hameaux environnants, nous sommes à votre écoute pour tous vos besoins en chauffage, climatisation ou chauffe-eau.
                      </p>
                      <p>
                        Demandez votre <strong className="text-black dark:text-white">devis personnalisé</strong> en quelques clics ou appelez-nous directement.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Maîtrise parfaite</strong> des spécificités de Saucats et de son environnement forestier. <strong className="text-black dark:text-white">Expertise adaptée</strong> aux contraintes du secteur rural.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Matériels robustes</strong> sélectionnés pour leur fiabilité et leur efficacité énergétique. <strong className="text-black dark:text-white">Adaptation parfaite</strong> au bâti girondin.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Intervention rapide</strong> sur Saucats et environs, <strong className="text-black dark:text-white">accompagnement sur mesure</strong> et <strong className="text-black dark:text-white">travaux soignés</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Accompagnement complet</strong> pour vos aides disponibles à Saucats : <strong className="text-black dark:text-white">primes CEE, MaPrimeRénov'</strong>, TVA réduite et Éco-PTZ.
                  </p>
                </div>
              </div>
            </div>
