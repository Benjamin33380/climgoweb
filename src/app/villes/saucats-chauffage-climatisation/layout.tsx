...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Saucats 33650 | Expert Local | ClimGO',
  ...
  openGraph: {
    title: 'Chauffage Climatisation Saucats 33650 | Expert Local | ClimGO',
    description: 'ClimGO, expert chauffage climatisation Saucats 33650. Installation PAC, dépannage urgent, entretien. Artisan RGE certifié. Devis gratuit.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Saucats 33650 - ClimGO Expert Local',
    }],
  },
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Saucats 33650 | Expert Local | ClimGO',
    description: 'Expert chauffage climatisation Saucats 33650. Installation PAC, dépannage urgent. Artisan RGE certifié.',
