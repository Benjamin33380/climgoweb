...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Saucats - Chauffage & Climatisation",
  ...
  openGraph: {
    ...
    title: "ClimGO Saucats - Chauffage & Climatisation",
    description: "Expert chauffage climatisation à Saucats. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié.",
    siteName: "ClimGO",
    images: [
      {
...
export default function SaucatsLayout({
  ...
  // Coordonnées de la mairie de Saucats
  const saucatsCoords = getCityCoordinates('saucats');
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Saucats
              "geo": saucatsCoords ? generateGeoJsonLd(saucatsCoords, "Mairie de Saucats") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
