            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                <p className="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Située entre les coteaux boisés et la Garonne</strong>, Floirac offre un cadre de vie paisible et verdoyant, idéal pour des installations énergétiques modernes.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Située sur la <strong className="text-black dark:text-white">rive droite de la Garonne</strong>, Floirac connaît une forte dynamique résidentielle grâce à son lien direct avec Bordeaux et ses projets de réaménagement urbain.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Avec plus de <strong className="text-black dark:text-white">18 000 habitants</strong>, la commune attire les jeunes actifs, familles et retraités.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Le <strong className="text-black dark:text-white">tram A, le pont Simone Veil</strong> et la proximité immédiate de l'Arena et des berges font de Floirac un secteur à fort potentiel.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les <strong className="text-black dark:text-white">écoles, les équipements sportifs et les commerces</strong> de proximité complètent un cadre de vie urbain, mais aéré.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO vous accompagne à Floirac pour tous vos besoins en <strong className="text-black dark:text-white">chauffage, climatisation ou production d'eau chaude</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Grâce à notre <strong className="text-black dark:text-white">expertise locale</strong>, chaque solution est pensée pour s'adapter aux caractéristiques des logements floiracais.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Cadre Verdoyant</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Dynamique Résidentielle</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Secteur Fort Potentiel</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Située sur la <strong className="text-black dark:text-white">rive droite de la Garonne</strong>, Floirac connaît une forte dynamique résidentielle grâce à son lien direct avec Bordeaux.
                      </p>
                      <p>
                        Les <strong className="text-black dark:text-white">écoles, les équipements sportifs et les commerces</strong> de proximité complètent un cadre de vie urbain, mais aéré.
                      </p>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Le <strong className="text-black dark:text-white">relief de Floirac, avec ses zones hautes et basses</strong>, et la diversité des habitats nécessitent une adaptation précise des puissances et technologies utilisées.
                      </p>
                      <p>
                        Nos équipes maîtrisent aussi les <strong className="text-black dark:text-white">contraintes d'intégration en milieu urbain dense</strong>, avec des solutions discrètes, performantes et conformes.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous soyez en train de <strong className="text-black dark:text-white">rénover une maison de ville ou d'emménager dans une résidence neuve</strong>, ClimGO vous accompagne avec des conseils sur-mesure à Floirac.
                      </p>
                      <p>
                        Un <strong className="text-black dark:text-white">simple appel ou un formulaire suffit</strong> pour obtenir un devis gratuit.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix de la <strong className="text-black dark:text-white">proximité, du conseil et d'un savoir-faire reconnu</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements <strong className="text-black dark:text-white">s'intègrent dans tous les types de logements floiracais</strong>, avec discrétion et performance.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    ClimGO intervient dans tous les quartiers : <strong className="text-black dark:text-white">Dravemont, Domaine de la Burthe, Carriet ou La Souys</strong>. Solutions adaptées à chaque cas.
                  </p>
                </div>
              </div>
            </div>
