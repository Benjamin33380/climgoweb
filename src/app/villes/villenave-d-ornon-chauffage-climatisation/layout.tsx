...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ClimGO Villenave-d'Ornon - Chauffage & Climatisation | Installation PAC, Entretien",
      },
    ],
  },
  ...
  other: {
    "zones-desservies": "Villenave-d'Ornon, Bordeaux Métropole, Gironde, Nouvelle-Aquitaine",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "ClimGO Villenave-d'Ornon",
    "application-name": "ClimGO Villenave-d'Ornon",
  ...
  return (
    <>
      <PerformanceOptimizations />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "Services ClimGO Villenave-d'Ornon",
                "itemListElement": [
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Chauffage Villenave-d'Ornon",
                      "description": "Installation et maintenance de systèmes de chauffage, PAC, planchers chauffants à Villenave-d'Ornon",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Climatisation Villenave-d'Ornon",
                      "description": "Installation et maintenance de systèmes de climatisation à Villenave-d'Ornon",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Eau Chaude Sanitaire Villenave-d'Ornon",
                      "description": "Installation et maintenance de systèmes d'eau chaude sanitaire à Villenave-d'Ornon",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Maintenance Villenave-d'Ornon",
                      "description": "Entretien et dépannage de vos équipements thermiques à Villenave-d'Ornon",
        ...
        {/* JSON-LD pour la page web de Villenave-d'Ornon */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "name": "ClimGO Villenave-d'Ornon - Chauffage & Climatisation",
              "url": "https://www.climgo.fr/villes/villenave-d-ornon-chauffage-climatisation",
              "description": "ClimGO, expert chauffage et climatisation à Villenave-d'Ornon. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "potentialAction": {
                "@type": "SearchAction",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ItemList",
              "name": "Services ClimGO Villenave-d'Ornon",
              "description": "Liste des services proposés par ClimGO à Villenave-d'Ornon",
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
        ...
        {/* JSON-LD FAQ - Questions intermédiaires pour Villenave-d'Ornon (ville moyenne) */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Intervenez-vous à domicile sur Villenave-d'Ornon ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO intervient à domicile sur Villenave-d'Ornon et ses environs. Nos techniciens se déplacent chez vous pour l'installation, la maintenance et le dépannage de vos équipements de chauffage et climatisation."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Proposez-vous des devis gratuits à Villenave-d'Ornon ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Absolument ! ClimGO propose des devis gratuits et sans engagement à Villenave-d'Ornon. Nos experts évaluent vos besoins et vous proposent la solution la plus adaptée à votre projet."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Quels sont vos délais d'intervention à Villenave-d'Ornon ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "À Villenave-d'Ornon, ClimGO s'engage sur des délais rapides : devis sous 24h, installation sous 15 jours et dépannage d'urgence sous 4h. Nous assurons votre confort rapidement."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Êtes-vous certifiés RGE pour Villenave-d'Ornon ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO est certifié RGE (Reconnu Garant de l'Environnement). Cette certification vous permet de bénéficier des aides de l'État et garantit la qualité de nos installations sur Villenave-d'Ornon."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Pouvez-vous m'aider avec MaPrimeRénov' à Villenave-d'Ornon ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO vous accompagne dans vos démarches MaPrimeRénov' à Villenave-d'Ornon. Nous calculons les montants éligibles et vous aidons à obtenir jusqu'à 90% d'aides selon vos revenus."
                  }
                }
              ]
            })
