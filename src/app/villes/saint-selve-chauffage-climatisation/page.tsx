            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Nichée dans un écrin de verdure</strong>, Saint-Selve séduit par son cadre paisible et résidentiel.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située au cœur de <strong className="text-black dark:text-white">l'Entre-Deux-Mers, avec près de 3 500 habitants</strong>, elle attire les familles en quête de tranquillité.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nos solutions de chauffage et climatisation <strong className="text-black dark:text-white">s'intègrent avec discrétion dans tous les quartiers</strong>, du centre aux lotissements récents.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Chez ClimGO, chaque projet est conçu pour <strong className="text-black dark:text-white">répondre aux besoins thermiques spécifiques</strong> des habitations de Saint-Selve.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">À seulement 25 minutes de Bordeaux</strong>, les habitants bénéficient d'un tissu associatif dynamique et d'infrastructures complètes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO intervient dans <strong className="text-black dark:text-white">tous les quartiers avec des solutions sur mesure</strong> adaptées au climat tempéré local.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Cadre Paisible</h3>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Située au cœur de <strong className="text-black dark:text-white">l'Entre-Deux-Mers, Saint-Selve connaît une croissance résidentielle douce</strong> tout en conservant son cadre de vie rural.
                      </p>
                      <p>
                        Avec <strong className="text-black dark:text-white">près de 3 500 habitants</strong>, elle attire les familles en quête de tranquillité, à seulement 25 minutes de Bordeaux.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Entre les <strong className="text-black dark:text-white">bâtis anciens en pierre et les maisons récentes BBC</strong>, nos installations sont toujours dimensionnées sur mesure.
                      </p>
                      <p>
                        Nous privilégions les <strong className="text-black dark:text-white">systèmes silencieux, peu énergivores et discrets</strong>, pour un confort durable.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        <strong className="text-black dark:text-white">Vous habitez Saint-Selve ou vous y faites construire</strong> ? Notre équipe est disponible pour vous proposer un accompagnement sur mesure.
                      </p>
                      <p>
                        Contactez-nous pour un <strong className="text-black dark:text-white">premier échange gratuit en chauffage, climatisation ou eau chaude</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire appel à ClimGO à Saint-Selve, c'est choisir une <strong className="text-black dark:text-white">équipe locale réactive et spécialisée</strong> dans le confort thermique résidentiel.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos pompes à chaleur, climatiseurs et chauffe-eaux sont <strong className="text-black dark:text-white">installés selon les exigences techniques locales</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Basés à proximité de Saint-Selve, nous <strong className="text-black dark:text-white">garantissons un service rapide et suivi</strong>.
                  </p>
                </div>
              </div>
