...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Canejan 33610 | ClimGO Expert Local',
  ...
  keywords: 'climatisation gironde, chauffage gironde, pompe à chaleur gironde, chauffagiste bordeaux, installateur climatisation, artisan RGE, installation PAC air eau, entretien climatisation, dépannage chauffage, chaudière gaz condensation, plancher chauffant, radiateurs électriques, maintenance pompe à chaleur, réparation climatisation, devis gratuit, intervention urgence, certificat RGE, MaPrimeRénov, aide financière chauffage, prime CEE, crédit impôt, économie énergie, rénovation énergétique, audit énergétique, chauffage canéjan, climatisation canéjan, chauffagiste canéjan, pompe à chaleur canéjan, installation PAC canéjan, dépannage chauffage canéjan, entretien climatisation canéjan, artisan RGE canéjan, chaudière canéjan, maintenance canéjan, expert chauffage 33610, climatisation 33610, chauffagiste 33610, devis gratuit canéjan, intervention urgence canéjan, spécialiste CVC canéjan, entreprise chauffage canéjan, installateur agréé canéjan, technicien qualifié canéjan, service après-vente canéjan',
  ...
  openGraph: {
    ...
    url: 'https://climgo.fr/villes/canejan-chauffage-climatisation',
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Canejan 33610 | ClimGO Expert Local',
    description: 'Expert chauffage climatisation Canejan. Installation PAC, dépannage urgent. Artisan RGE certifié.',
    images: ['https://climgo.fr/images/twitter-canejan-chauffage-climatisation.jpg'],
  },
  ...
  other: {
    ...
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://climgo.fr/villes/canejan-chauffage-climatisation',
    'DC.source': 'https://climgo.fr',
    'DC.coverage': 'Canejan, Gironde, France',
  ...
  alternates: {
    canonical: 'https://climgo.fr/villes/canejan-chauffage-climatisation',
  },
