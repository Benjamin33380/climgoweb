            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  Située au cœur du <strong className="text-black dark:text-white">Val de l'Eyre</strong>, la commune de Mios se distingue par son environnement naturel remarquable, entre forêts de pins, rivières et sentiers boisés.
                </p>
                ...
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Que vous résidiez à <strong className="text-black dark:text-white">Lacanau-de-Mios</strong>, au Bourg, <strong className="text-black dark:text-white">Lillet</strong> ou dans les hameaux périphériques, ClimGO vous propose des solutions adaptées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Mios</strong> séduit par son cadre de vie calme, verdoyant et bien connecté. Avec plus de <strong className="text-black dark:text-white">9 000 habitants</strong>, la commune connaît un développement résidentiel important.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les familles apprécient la proximité de la <strong className="text-black dark:text-white">gare SNCF</strong>, les écoles (Jean Zay, groupe scolaire de Lacanau-de-Mios), les équipements sportifs et la vie associative locale.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO intervient sur tout le territoire miot : du <strong className="text-black dark:text-white">centre-bourg</strong> aux lotissements du Val de l'Eyre, en passant par Lacanau-de-Mios ou la route de Salles.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  À Mios, la présence de <strong className="text-black dark:text-white">zones humides et boisées</strong> nécessite une attention particulière sur l'installation extérieure des PAC. Nos installations sont pensées pour l'environnement forestier.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Environnement Forestier</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Zones Humides</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        <strong className="text-black dark:text-white">Mios</strong> séduit par son cadre de vie calme, verdoyant et bien connecté. Avec plus de <strong className="text-black dark:text-white">9 000 habitants</strong>, développement résidentiel important.
                      </p>
                      <p>
                        Les familles apprécient la proximité de la <strong className="text-black dark:text-white">gare SNCF</strong>, les écoles, équipements sportifs et vie associative locale très active.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        À Mios, la présence de <strong className="text-black dark:text-white">zones humides et boisées</strong> nécessite une attention particulière sur l'installation extérieure des PAC.
                      </p>
                      <p>
                        ClimGO installe systématiquement sur <strong className="text-black dark:text-white">dalles ventilées ou plots stabilisés</strong> pour éviter l'humidité au sol et maximiser le confort.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous habitez <strong className="text-black dark:text-white">Mios</strong> ou ses environs ? Nos équipes se déplacent rapidement pour étudier votre projet.
                      </p>
                      <p>
                        Profitez de nos <strong className="text-black dark:text-white">conseils personnalisés</strong> et d'un devis clair, sans engagement.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Environnement forestier</strong> remarquable : forêts de pins, rivières et sentiers boisés. <strong className="text-black dark:text-white">Solutions respectueuses</strong> de la nature.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Techniciens certifiés</strong> RGE et QualiPAC, garantissant qualité et durabilité. <strong className="text-black dark:text-white">Matériel rigoureusement</strong> sélectionné pour sa fiabilité.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Installations sur dalles</strong> ventilées ou plots stabilisés. Attention particulière aux <strong className="text-black dark:text-white">zones humides et boisées</strong> de Mios.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Situés à proximité</strong>, nous intervenons rapidement, limitant les délais d'attente pour une <strong className="text-black dark:text-white">prise en charge efficace</strong> à Mios.
                  </p>
                </div>
              </div>
            </div>
