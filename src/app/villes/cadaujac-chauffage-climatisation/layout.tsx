...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Cadaujac 33140 | ClimGO',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Cadaujac 33140 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Cadaujac 33140 | ClimGO',
    'DC.description': 'Expert chauffage climatisation Cadaujac 33140. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
