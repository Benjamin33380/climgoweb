            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  Cadaujac, connue pour ses <strong className="text-black dark:text-white">parcs, ses équipements publics et son cadre résidentiel</strong>, est une commune idéale pour des solutions de confort thermique haut de gamme.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Que vous habitiez près du <strong className="text-black dark:text-white">Bourg, de Fayet, Avenue de Toulouse ou route du port de grima</strong>, ClimGO vous accompagne pour choisir et installer la solution la plus adaptée.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Cadaujac, à la fois <strong className="text-black dark:text-white">paisible et connectée</strong>, attire de plus en plus de familles souhaitant vivre à proximité de Bordeaux.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec ses <strong className="text-black dark:text-white">berges de Garonne, ses pistes cyclables et ses zones pavillonnaires calmes</strong>, elle séduit autant les actifs que les retraités.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  La commune bénéficie d'un <strong className="text-black dark:text-white">tissu associatif dynamique, d'un accès rapide à la rocade</strong> via la D1113, et d'infrastructures publiques bien entretenues.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Du <strong className="text-black dark:text-white">quartier du Bourg à la route de Beautiran</strong>, nous proposons des équipements pensés pour les maisons neuves comme pour les habitations traditionnelles.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nos installations sur Cadaujac sont pensées pour <strong className="text-black dark:text-white">durer, tout en s'adaptant à l'architecture et aux spécificités locales</strong>.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Ville Verte Résidentielle</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Commune en Essor</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Infrastructures Dynamiques</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Installations Durables</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        C'est dans ce cadre que ClimGO intervient, en adaptant chaque projet à <strong className="text-black dark:text-white">l'environnement résidentiel cadaujacais</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Les constructions cadaujacaises, souvent dotées de <strong className="text-black dark:text-white">combles peu isolés ou de murs anciens</strong> en moellon, demandent une approche sur mesure.
                      </p>
                      <p>
                        Nos unités extérieures sont posées sur <strong className="text-black dark:text-white">plots béton isolés du sol</strong> avec attention à l'évacuation des condensats.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous avez un projet de <strong className="text-black dark:text-white">rénovation thermique ou souhaitez améliorer</strong> votre confort ?
                      </p>
                      <p>
                        Que vous soyez près de la mairie, du cimetière paysager ou du <strong className="text-black dark:text-white">lycée Toulouse-Lautrec</strong>, notre équipe répond rapidement.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire confiance à une <strong className="text-black dark:text-white">équipe locale, experte des besoins thermiques</strong> des habitations traditionnelles et récentes de la commune.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Pompes à chaleur, climatisations, chauffe-eaux : chaque solution est <strong className="text-black dark:text-white">sélectionnée pour s'intégrer à votre environnement</strong> et réduire vos factures.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre <strong className="text-black dark:text-white">ancrage local garantit réactivité, suivi rigoureux</strong> et qualité de service à Cadaujac.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Constructions dotées de <strong className="text-black dark:text-white">combles peu isolés ou murs anciens en moellon</strong> demandent une approche sur mesure avec étude thermique complète.
                  </p>
                </div>
              </div>
            </div>
