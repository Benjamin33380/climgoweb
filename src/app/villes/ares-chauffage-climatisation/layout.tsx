...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Arès - Chauffage & Climatisation",
  ...
  openGraph: {
    ...
    title: "ClimGO Arès - Chauffage & Climatisation",
    description: "Expert chauffage climatisation Arès 33640. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.",
    siteName: "ClimGO",
    images: [
      {
  ...
  other: {
    "zones-desservies": "Arès, Bassin d'Arcachon, Gironde, Nouvelle-Aquitaine",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "ClimGO Arès",
    "application-name": "ClimGO Arès",
  ...
  return (
    <>
      <PerformanceOptimizations />
                ...
                "itemListElement": [
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Chauffage Arès",
                      "description": "Installation et maintenance de systèmes de chauffage, PAC, planchers chauffants à Arès",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Climatisation Arès",
                      "description": "Installation et maintenance de systèmes de climatisation à Arès",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Eau Chaude Sanitaire Arès",
                      "description": "Installation et maintenance de systèmes d'eau chaude sanitaire à Arès",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Maintenance Arès",
                      "description": "Entretien et dépannage de vos équipements thermiques à Arès",
        ...
        {/* JSON-LD pour la page web d'Arès */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "name": "ClimGO Arès - Chauffage & Climatisation",
              "url": "https://www.climgo.fr/villes/ares-chauffage-climatisation",
              "description": "ClimGO, expert chauffage et climatisation à Arès. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "potentialAction": {
                "@type": "SearchAction",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ItemList",
              "name": "Services ClimGO Arès",
              "description": "Liste des services proposés par ClimGO à Arès",
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
        ...
        {/* JSON-LD FAQ - Questions génériques pour Arès (ville faible) */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
