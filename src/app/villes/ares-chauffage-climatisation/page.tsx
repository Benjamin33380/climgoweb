            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  Située entre <strong className="text-black dark:text-white">bassin et forêt</strong>, Arès séduit par son authenticité, ses pistes cyclables et ses quartiers calmes comme les Quinconces ou Jane de Boy.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO s'adapte à chaque habitat pour assurer votre <strong className="text-black dark:text-white">confort thermique</strong>. Nous accompagnons les familles, retraités et nouveaux arrivants dans leurs projets d'installation.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  En respectant les <strong className="text-black dark:text-white">zones naturelles protégées</strong> et les spécificités locales, chaque intervention vise à optimiser la performance énergétique de votre logement.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Arès charme ses habitants avec ses <strong className="text-black dark:text-white">plages paisibles, sa réserve naturelle des prés salés</strong>, ses marchés traditionnels et son port ostréicole.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les quartiers comme <strong className="text-black dark:text-white">Jane de Boy, Les Quinconces ou Le Coulin</strong> abritent des maisons de style arcachonnais, des villas contemporaines et des résidences familiales.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Entre <strong className="text-black dark:text-white">jeunes familles</strong> en quête de confort moderne et retraités attentifs aux économies d'énergie, les profils sont variés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  À Arès, le <strong className="text-black dark:text-white">vent marin, la proximité de la pinède</strong> et les conditions salines imposent un choix rigoureux de matériel extérieur.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Authenticité du Bassin</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Contraintes Naturelles</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Ici, l'<strong className="text-black dark:text-white">authenticité du bassin</strong> se mêle à un mode de vie doux et tourné vers la nature.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Nous utilisons des <strong className="text-black dark:text-white">unités renforcées anticorrosion</strong>, fixées sur plots surélevés pour des installations respectueuses de la réglementation locale.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous habitez à Arès ou vous y <strong className="text-black dark:text-white">investissez dans une résidence secondaire</strong> ? ClimGO vous accompagne du conseil à l'entretien.
                      </p>
                      <p>
                        N'hésitez pas à nous contacter pour <strong className="text-black dark:text-white">échanger sur votre projet</strong> dans cette ville authentique entre bassin et nature.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Connaissance des <strong className="text-black dark:text-white">contraintes spécifiques du climat local</strong> et de la richesse environnementale de la commune d'Arès.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Unités renforcées anticorrosion</strong>, fixées sur plots surélevés. Prise en compte zones inondables et zones protégées.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre <strong className="text-black dark:text-white">proximité</strong> permet d'intervenir rapidement sur tout Arès, pour des dépannages ou installations urgentes sans attente.
                  </p>
                </div>
              </div>
            </div>
