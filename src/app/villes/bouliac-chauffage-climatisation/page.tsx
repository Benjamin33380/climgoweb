            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  Bouliac offre un <strong className="text-black dark:text-white">cadre résidentiel paisible avec vue sur Bordeaux</strong>, idéal pour des solutions de chauffage et climatisation haut de gamme.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO intervient à Bouliac pour proposer des <strong className="text-black dark:text-white">équipements thermiques adaptés à l'architecture résidentielle locale</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Bouliac, surnommée le <strong className="text-black dark:text-white">balcon de Bordeaux</strong>, offre un panorama exceptionnel sur la ville tout en conservant une ambiance de village résidentiel haut de gamme.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Sa situation sur les coteaux attire des <strong className="text-black dark:text-white">familles en quête de tranquillité et de qualité de vie</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Entre <strong className="text-black dark:text-white">demeures en pierre, lotissements récents et maisons d'architectes</strong>, la diversité des logements exige des solutions personnalisées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Du centre-bourg aux hauteurs du <strong className="text-black dark:text-white">chemin de Carbonnieu</strong>, avec des équipements discrets, performants et parfaitement intégrés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Notre expérience à Bouliac garantit une <strong className="text-black dark:text-white">installation discrète, efficace et parfaitement intégrée</strong> à votre cadre de vie.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Balcon de Bordeaux</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Village Résidentiel Haut de Gamme</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Diversité Logements</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Intégration Parfaite</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Bouliac, surnommée le <strong className="text-black dark:text-white">balcon de Bordeaux</strong>, offre un panorama exceptionnel sur la ville.
                      </p>
                      <p>
                        Sa situation sur les coteaux attire des <strong className="text-black dark:text-white">familles en quête de tranquillité</strong> et de qualité de vie.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Le <strong className="text-black dark:text-white">relief prononcé et nature argilo-calcaire</strong> du sol imposent une attention particulière à la stabilité.
                      </p>
                      <p>
                        ClimGO adapte chaque installation selon <strong className="text-black dark:text-white">l'exposition, le vis-à-vis et les contraintes architecturales</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous vivez à Bouliac ou venez d'acquérir une <strong className="text-black dark:text-white">maison sur les hauteurs</strong> ?
                      </p>
                      <p>
                        Nos équipes sont disponibles pour vous conseiller et établir un <strong className="text-black dark:text-white">devis gratuit adapté</strong> à votre confort et budget.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix de la <strong className="text-black dark:text-white">proximité, du conseil et d'un savoir-faire reconnu</strong> à Bouliac.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements s'intègrent dans tous les types de <strong className="text-black dark:text-white">logements bouliacais avec discrétion et performance</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    ClimGO vous accompagne de A à Z, avec un <strong className="text-black dark:text-white">service rapide, soigné et démarches simplifiées</strong> pour vos aides.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Adaptation selon <strong className="text-black dark:text-white">l'exposition, le vis-à-vis et les contraintes architecturales</strong> du quartier, préservant l'esthétique des façades.
                  </p>
                </div>
              </div>
            </div>
