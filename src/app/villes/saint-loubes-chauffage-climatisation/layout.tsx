...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Saint-Loubes 33450 | ClimGO',
  description: 'Expert chauffage climatisation Saint-Loubes 33450. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Saint-Loubes 33450 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Saint-Loubes 33450 | ClimGO',
    'DC.description': 'Expert chauffage climatisation Saint-Loubes 33450. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
