          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                ...
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située entre le <strong className="text-black dark:text-white">Bassin d'Arcachon</strong>, les plages océanes et la forêt landaise, La Teste-de-Buch offre un équilibre rare entre nature, animation et qualité de vie. Avec plus de 27 000 habitants, la commune est l'une des plus vastes de France.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les quartiers comme <strong className="text-black dark:text-white">Pyla-sur-Mer</strong>, le <strong className="text-black dark:text-white">Port</strong>, <strong className="text-black dark:text-white">La Hume</strong> ou le centre-ville attirent familles, retraités et vacanciers. La ville bénéficie d'un fort dynamisme immobilier, d'écoles, d'un lycée et d'un tissu associatif développé.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Entre humidité saline, vents côtiers et variations de température, les installations à La Teste demandent une vraie expertise. Chez ClimGO, nous utilisons des <strong className="text-black dark:text-white">matériaux anticorrosion</strong> et des supports renforcés.
                </p>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Toute La Teste-de-Buch</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Expertise Littorale</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Solutions Sur-Mesure</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Qualité & Proximité</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Située entre le <strong className="text-black dark:text-white">Bassin d'Arcachon</strong>, les plages océanes et la forêt landaise, La Teste-de-Buch offre un équilibre rare entre nature, animation et qualité de vie.
                      </p>
                      <p>
                        Avec plus de <strong className="text-black dark:text-white">27 000 habitants</strong>, la commune est l'une des plus vastes de France. Les quartiers comme Pyla-sur-Mer, le Port, La Hume attirent familles et retraités.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Entre <strong className="text-black dark:text-white">humidité saline</strong>, vents côtiers et variations de température, les installations à La Teste demandent une vraie expertise.
                      </p>
                      <p>
                        Chez ClimGO, nous utilisons des <strong className="text-black dark:text-white">matériaux anticorrosion</strong> et des supports renforcés pour garantir durabilité et sécurité, adaptés aux logements utilisés en continu ou de façon saisonnière.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous vivez à l'année à <strong className="text-black dark:text-white">La Teste-de-Buch</strong> ou vous souhaitez équiper votre résidence secondaire ?
                      </p>
                      <p>
                        ClimGO vous accompagne avec des <strong className="text-black dark:text-white">solutions sur mesure</strong>, adaptées à votre mode de vie et à votre budget.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Connaissance approfondie</strong> du climat littoral et des contraintes côtières. <strong className="text-black dark:text-white">Matériaux spécialisés</strong> pour résister à l'humidité saline.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Maisons neuves</strong> comme <strong className="text-black dark:text-white">bâtisses traditionnelles</strong> rénovées. Adaptation aux contraintes architecturales et énergétiques de chaque logement.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Étude personnalisée</strong> puis devis gratuit et détaillé. <strong className="text-black dark:text-white">Installation soignée</strong> en respectant délais et normes en vigueur.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Contrats d'entretien</strong> personnalisés avec visites régulières pour vérification, nettoyage et optimisation des performances.
                  </p>
                </div>
              </div>
            </div>
