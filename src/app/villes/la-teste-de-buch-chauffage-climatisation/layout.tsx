...
export default function LaTesteDeBuchLayout({
  ...
  // Coordonnées de la mairie de La Teste-de-Buch
  const laTesteDeBuchCoords = getCityCoordinates('la-teste-de-buch');
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de La Teste-de-Buch
              "geo": laTesteDeBuchCoords ? generateGeoJsonLd(laTesteDeBuchCoords, "Mairie de La Teste-de-Buch") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
