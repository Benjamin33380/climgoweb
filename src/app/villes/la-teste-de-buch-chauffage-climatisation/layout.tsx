...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation La Teste-de-Buch 33260 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation La Teste-de-Buch 33260 | ClimGO',
    'DC.description': 'Expert chauffage climatisation La Teste-de-Buch 33260. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
