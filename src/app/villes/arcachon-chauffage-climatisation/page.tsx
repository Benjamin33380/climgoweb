...
export default function Arcachon() {
  ...
  return (
    <main className="px-0 bg-transparent">
        ...
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mt-16">
              <Link
                href="/contact"
                className="inline-flex items-center px-8 py-4 bg-gray-50 dark:bg-background text-black dark:text-white font-semibold rounded-full hover:bg-white dark:hover:bg-background transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl border border-white"
              >
                Demander un devis
              </Link>
            </div>
      ...
      {/* Section 4 blocs horizontaux avec ScrollShadow HeroUI - Responsive */}
        ...
        <SimpleWrapper>
          <div className="max-w-7xl mx-auto">
            <div className="relative max-w-full overflow-hidden">
              ...
              {/* Version mobile - Grid vertical */}
              <div className="md:hidden grid grid-cols-1 gap-6 px-4">
                {/* Bloc 1 */}
                <div className="w-full bg-gray-50 dark:bg-background rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                  <h3 className="text-xl font-bold text-black dark:text-white mb-4">
                    La perle du Bassin d'Arcachon
                  </h3>
                  <div className="space-y-3 text-black dark:text-white leading-relaxed text-sm">
                    <p>
                ...
                <div className="w-full bg-gray-50 dark:bg-background rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="space-y-3 text-black dark:text-white leading-relaxed text-sm">
                    ...
                    <div className="mt-4">
                      <a
                        href="/contact"
                        className="inline-flex items-center px-6 py-3 bg-gray-50 dark:bg-background text-black dark:text-white font-semibold rounded-lg hover:bg-white dark:hover:bg-background border border-white"
                      >
                        Devis gratuit
                      </a>
                    </div>
              ...
              <div className="hidden md:block overflow-x-auto">
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  {/* Bloc 1 */}
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
      ...
      <section className="relative py-24 overflow-hidden bg-gray-50 dark:bg-background" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            {/* Pourquoi choisir ClimGO à Arcachon - Version personnalisée - Responsive */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Connaissance approfondie</strong> du climat marin et de l'architecture arcachonnaise. <strong className="text-black dark:text-white">Maîtrise parfaite</strong> des contraintes côtières et patrimoniales.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Équipements résistants</strong> aux conditions marines et <strong className="text-black dark:text-white">normes rigoureuses</strong>. Installation respectant les <strong className="text-black dark:text-white">plus hauts standards</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Intervention rapide</strong> dans tous les quartiers d'Arcachon, <strong className="text-black dark:text-white">dépannages urgents</strong> et <strong className="text-black dark:text-white">service de proximité</strong> personnalisé.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Garantie étendue</strong> sur tous nos équipements et <strong className="text-black dark:text-white">service après-vente réactif</strong>. <strong className="text-black dark:text-white">Tranquillité d'esprit</strong> assurée.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Section Carte en pleine largeur */}
        ...
        <div className="relative z-10 w-full px-4">
          <SimpleWrapper>
            <div className="relative w-full">
              {/* Carte Google Maps en pleine largeur - Responsive */}
