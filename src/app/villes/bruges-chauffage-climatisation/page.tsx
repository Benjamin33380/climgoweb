            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  Bruges allie <strong className="text-black dark:text-white">patrimoine, vie résidentielle et développement urbain</strong>, un cadre idéal pour des solutions thermiques sur mesure.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO intervient à Bruges pour vous proposer des <strong className="text-black dark:text-white">systèmes de chauffage, climatisation et eau chaude</strong> adaptés à votre logement.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située à deux pas de Bordeaux, Bruges connaît une <strong className="text-black dark:text-white">croissance soutenue</strong> depuis plusieurs années. Quartiers modernes comme Ausone, Tasta ou Grand Darnal.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Le <strong className="text-black dark:text-white">tram D, la rocade</strong> et les nombreux aménagements cyclables facilitent les déplacements. Stade, médiathèque et zones boisées préservées comme le parc Ausone.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Interventions dans toutes les zones : des <strong className="text-black dark:text-white">pavillons anciens proches de la mairie</strong> aux nouvelles résidences côté Ginko. Systèmes adaptés à chaque besoin.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Bruges combine <strong className="text-black dark:text-white">habitat dense et zones pavillonnaires</strong>. Techniciens s'adaptent urbanisme local, proximité voies ferrées, règles copropriétés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Performances thermiques bâtiments brégeais, exposition, vis-à-vis, <strong className="text-black dark:text-white">contraintes bruit ou d'esthétique</strong> pour installations optimales.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Commune en Pleine Mutation</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Équipements et Espaces Verts</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Habitat Diversifié</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Expertise Sur Mesure</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Située à deux pas de Bordeaux, Bruges connaît une <strong className="text-black dark:text-white">croissance soutenue</strong> depuis plusieurs années.
                      </p>
                      <p>
                        Avec ses quartiers modernes comme <strong className="text-black dark:text-white">Ausone, Tasta ou Grand Darnal</strong>, la commune attire jeunes actifs, familles et seniors.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Bruges combine <strong className="text-black dark:text-white">habitat dense et zones pavillonnaires</strong>. Nos techniciens s'adaptent à l'urbanisme local.
                      </p>
                      <p>
                        Nous prenons en compte les performances thermiques des bâtiments brégeais, l'exposition, le vis-à-vis, les <strong className="text-black dark:text-white">contraintes de bruit ou d'esthétique</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous habitiez une <strong className="text-black dark:text-white">résidence récente, une échoppe rénovée</strong> ou une maison de lotissement, ClimGO vous accompagne.
                      </p>
                      <p>
                        Nous améliorons votre <strong className="text-black dark:text-white">confort thermique à Bruges</strong>. Contactez-nous dès maintenant.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix de la <strong className="text-black dark:text-white">proximité, du conseil</strong> et d'un savoir-faire reconnu pour tous vos projets thermiques à Bruges.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements s'intègrent dans tous les types de logements brégeais, avec <strong className="text-black dark:text-white">discrétion et performance</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Techniciens s'adaptent à l'<strong className="text-black dark:text-white">urbanisme local, proximité voies ferrées</strong>, règles copropriétés pour installations optimales.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    ClimGO vous accompagne de A à Z, avec un <strong className="text-black dark:text-white">service rapide, soigné, et des démarches simplifiées</strong> pour vos aides.
                  </p>
                </div>
              </div>
            </div>
