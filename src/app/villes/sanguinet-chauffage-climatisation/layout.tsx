...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Sanguinet - Chauffage & Climatisation",
  ...
  openGraph: {
    ...
    title: "ClimGO Sanguinet - Chauffage & Climatisation",
    description: "Expert chauffage climatisation Sanguinet 40460. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.",
    siteName: "ClimGO",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ClimGO Sanguinet - Chauffage & Climatisation | Installation PAC, Entretien",
      },
    ],
  },
  icons: {
  ...
  other: {
    "zones-desservies": "Sanguinet, Bassin d'Arcachon, Gironde, Nouvelle-Aquitaine",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "ClimGO Sanguinet",
    "application-name": "ClimGO Sanguinet",
...
export default function SanguinetLayout({
  ...
  // Coordonnées de la mairie de Sanguinet
  const sanguinetCoords = getCityCoordinates('sanguinet');
  
  return (
    <>
      {/* Schéma JSON-LD principal - LocalBusiness pour Sanguinet */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Sanguinet
              "geo": sanguinetCoords ? generateGeoJsonLd(sanguinetCoords, "Mairie de Sanguinet") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
              ...
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "Services ClimGO Sanguinet",
                "itemListElement": [
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Chauffage Sanguinet",
                      "description": "Installation et maintenance de systèmes de chauffage, PAC, planchers chauffants à Sanguinet",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Climatisation Sanguinet",
                      "description": "Installation et maintenance de systèmes de climatisation à Sanguinet",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Eau Chaude Sanitaire Sanguinet",
                      "description": "Installation et maintenance de systèmes d'eau chaude sanitaire à Sanguinet",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Maintenance Sanguinet",
                      "description": "Entretien et dépannage de vos équipements thermiques à Sanguinet",
        ...
        {/* JSON-LD pour la page web de Sanguinet */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "name": "ClimGO Sanguinet - Chauffage & Climatisation",
              "url": "https://www.climgo.fr/villes/sanguinet-chauffage-climatisation",
              "description": "ClimGO, expert chauffage et climatisation à Sanguinet. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "potentialAction": {
                "@type": "SearchAction",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ItemList",
              "name": "Services ClimGO Sanguinet",
              "description": "Liste des services proposés par ClimGO à Sanguinet",
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
        ...
        {/* JSON-LD FAQ - Questions génériques pour Sanguinet (ville faible) */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "ClimGO intervient-il sur Sanguinet ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO intervient sur Sanguinet et les communes environnantes. Nos techniciens se déplacent pour l'installation, la maintenance et le dépannage de vos équipements."
                  }
                },
                {
                  "@type": "Question",
