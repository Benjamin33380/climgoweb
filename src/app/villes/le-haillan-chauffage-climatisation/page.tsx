            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Le Haillan, située à l'ouest de Bordeaux</strong>, est une commune dynamique qui allie harmonieusement zones résidentielles et activité économique.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Son <strong className="text-black dark:text-white">cadre de vie agréable nécessite des solutions de chauffage et climatisation</strong> adaptées à ses différents quartiers.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Situé à l'ouest de Bordeaux, Le Haillan bénéficie d'un <strong className="text-black dark:text-white">cadre de vie recherché, mêlant zones pavillonnaires, commerces de proximité et espaces verts</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  La ville attire de nombreux actifs grâce à sa <strong className="text-black dark:text-white">proximité avec Mérignac, l'aéroport et la rocade</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec ses <strong className="text-black dark:text-white">écoles, ses installations sportives modernes et ses zones résidentielles en plein essor</strong> (quartier La Luzerne, route de Saint-Médard).
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Que vous soyez situé près du centre-ville ou dans les zones pavillonnaires, <strong className="text-black dark:text-white">ClimGO conçoit et installe des équipements thermiques adaptés</strong> à votre habitat.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Forts de notre expérience locale et de nos certifications, nous garantissons des installations <strong className="text-black dark:text-white">durables, économiques et parfaitement adaptées</strong> aux besoins spécifiques des logements du Haillan.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Cadre de Vie Recherché</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Équipements Modernes</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="hidden md:block absolute right-0 top-0 bottom-0 w-90 bg-gradient-to-l from-white via-white/80 to-transparent dark:from-black dark:via-black/80 z-10 pointer-events-none" />
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Le Haillan est soumis à des <strong className="text-black dark:text-white">étés de plus en plus chauds et à des intersaisons humides</strong>. Nos équipements sont pensés pour garantir un confort thermique optimal.
                      </p>
                      <p>
                        Nous analysons l'isolation de chaque logement pour proposer une <strong className="text-black dark:text-white">solution sur-mesure, en tenant compte des combles, des orientations et des volumes</strong> à chauffer ou climatiser.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Pour toute demande d'<strong className="text-black dark:text-white">installation, d'entretien ou de remplacement d'équipement thermique</strong> au Haillan, ClimGO se tient à votre disposition.
                      </p>
                      <p>
                        Demandez votre <strong className="text-black dark:text-white">étude personnalisée, gratuite et sans engagement</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Choisir une <strong className="text-black dark:text-white">entreprise engagée, qui comprend les particularités climatiques et architecturales</strong> de la commune.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Pompes à chaleur, climatiseurs et chauffe-eaux sélectionnés pour garantir <strong className="text-black dark:text-white">efficacité, discrétion et durabilité</strong>, résidences familiales ou logements collectifs.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Résidences familiales, logements collectifs, et zones pavillonnaires</strong> : nous maîtrisons les contraintes thermiques de tous les types d'habitat au Haillan.
                  </p>
                </div>
              </div>
            </div>
