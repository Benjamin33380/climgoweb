...
export default function LeHaillanLayout({
  ...
  // Coordonnées de la mairie du Haillan
  const leHaillanCoords = getCityCoordinates('le-haillan');
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie du Haillan
              "geo": leHaillanCoords ? generateGeoJsonLd(leHaillanCoords, "Mairie du Haillan") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
