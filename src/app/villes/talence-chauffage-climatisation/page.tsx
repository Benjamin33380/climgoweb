    ...
    <main className="px-0">
      <section className="hero-mobile-section relative h-[100vh] xs:h-[95vh] sm:h-[90vh] min-h-[500px] xs:min-h-[550px] sm:min-h-[600px] md:min-h-[640px] lg:min-h-[700px] xl:min-h-[750px] w-full overflow-hidden bg-transparent sm:bg-white sm:dark:bg-black text-black dark:text-white">
        ...
        <div className="absolute top-0 left-0 h-full w-full z-1 sm:hidden">
          <Image
            src="/villes/talence.webp"
            alt="Talence - Bordeaux Métropole"
            fill
      ...
      {/* Section Talence - Texte défilant au scroll */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                <p className="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white leading-normal">
                  Ville universitaire animée et résidentielle, <strong className="text-black dark:text-white">Talence</strong> allie espaces verts et patrimoine local. Ses résidences familiales et logements étudiants requièrent des solutions thermiques à la fois économiques et performantes.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Que vous soyez proche du domaine universitaire, du centre-ville ou du quartier <strong className="text-black dark:text-white">Thouars</strong>, ClimGO adapte chaque installation aux spécificités thermiques de votre logement.
                </p>
                ...
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située à deux pas de Bordeaux, <strong className="text-black dark:text-white">Talence</strong> se distingue par son fort tissu résidentiel, ses nombreux campus universitaires et son dynamisme culturel. Avec plus de <strong className="text-black dark:text-white">42 000 habitants</strong>, elle attire familles, étudiants et jeunes actifs.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les quartiers de <strong className="text-black dark:text-white">Thouars</strong>, <strong className="text-black dark:text-white">Médoquine</strong> ou encore <strong className="text-black dark:text-white">Peixotto</strong> combinent maisons de ville, résidences récentes et bâtis anciens. Une diversité qui exige des solutions de confort thermique sur-mesure.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Talence étant une <strong className="text-black dark:text-white">commune dense</strong>, nos techniciens tiennent compte des contraintes d'espace, de bruit et d'esthétique en milieu urbain. Nos installations privilégient la discrétion et la performance.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Que ce soit pour une maison des années 50, un studio étudiant ou une copropriété, nous adaptons chaque projet avec soin, en respectant les <strong className="text-black dark:text-white">règles locales d'urbanisme</strong>.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Toute Talence</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Habitat Universitaire</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Tissu Urbain Dense</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Proximité & Rigueur</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Située à deux pas de Bordeaux, <strong className="text-black dark:text-white">Talence</strong> se distingue par son fort tissu résidentiel, ses nombreux campus universitaires et son dynamisme culturel.
                      </p>
                      <p>
                        Avec plus de <strong className="text-black dark:text-white">42 000 habitants</strong>, elle attire aussi bien des familles que des étudiants ou des jeunes actifs. Une diversité qui exige des solutions sur-mesure.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Talence étant une <strong className="text-black dark:text-white">commune dense</strong>, nos techniciens tiennent compte des contraintes d'espace, de bruit et d'esthétique en milieu urbain.
                      </p>
                      <p>
                        Nos installations privilégient la <strong className="text-black dark:text-white">discrétion, la performance</strong> et le respect des règles de voisinage et d'urbanisme locales.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous avez un projet à <strong className="text-black dark:text-white">Talence</strong> ? Que ce soit pour rafraîchir un appartement, rénover une vieille bâtisse ou optimiser une résidence principale.
                      </p>
                      <p>
                        ClimGO est à votre écoute. Contactez-nous facilement pour un <strong className="text-black dark:text-white">devis ou une visite technique</strong> rapide.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Solutions économiques</strong> et performantes pour résidences étudiantes et logements familiaux. <strong className="text-black dark:text-white">Adaptation spécialisée</strong> aux besoins variés.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Équipements sélectionnés</strong> pour garantir efficacité, discrétion et durabilité. Parfaite intégration dans résidences familiales et <strong className="text-black dark:text-white">logements étudiants</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Installations discrètes</strong> tenant compte des contraintes d'espace, bruit et esthétique. <strong className="text-black dark:text-white">Respect des règles</strong> de voisinage et d'urbanisme.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Service rapide</strong>, finitions propres et <strong className="text-black dark:text-white">accompagnement administratif</strong> complet. Proximité et rigueur pour tous vos projets talençais.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Talence</h3>
                <p className="text-black dark:text-white leading-relaxed text-center text-lg flex-grow">
