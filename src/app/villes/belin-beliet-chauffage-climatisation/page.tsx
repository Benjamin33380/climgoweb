            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  Située au cœur du <strong className="text-black dark:text-white">Val de l'Eyre</strong>, la commune de Belin-Béliet se distingue par son environnement naturel remarquable, entre forêts de pins, rivières et sentiers boisés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nous intervenons dans tous ses quartiers, notamment les lieux-dits <strong className="text-black dark:text-white">Guiton, le Puch, Pernaud ou encore le Télègraphe</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située entre <strong className="text-black dark:text-white">forêts et rivières</strong>, Belin-Béliet séduit par son cadre verdoyant, son calme et ses traditions gasconnes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec près de <strong className="text-black dark:text-white">5 000 habitants</strong>, la commune accueille de plus en plus de familles venues chercher la tranquillité tout en restant proches de Bordeaux et d'Arcachon.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  La commune est marquée par son tissu résidentiel mêlant <strong className="text-black dark:text-white">quartiers anciens (Le Bourg, Guiton, Le Puch) et lotissements récents</strong> comme Les Pins ou Le Télegraphe.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nos solutions s'adaptent aussi bien aux <strong className="text-black dark:text-white">longères traditionnelles qu'aux pavillons RT2012</strong> en tenant compte des contraintes d'isolation et de l'exposition au soleil.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Grâce à notre <strong className="text-black dark:text-white">proximité géographique et notre connaissance du tissu local</strong>, nous vous accompagnons dans chaque étape de votre projet.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Village Nature Val de l'Eyre</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Commune Tranquille</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Tissu Résidentiel Mixte</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Solutions Adaptées</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Le <strong className="text-black dark:text-white">patrimoine y est préservé</strong>, entre vieilles bâtisses en pierre et maisons à colombages.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Belin-Béliet impose des <strong className="text-black dark:text-white">critères techniques précis liés à la forêt environnante</strong> : risques de résine, humidité des sols.
                      </p>
                      <p>
                        Nous prévoyons des <strong className="text-black dark:text-white">installations sur plots ou rehausses</strong>, avec un dimensionnement sur-mesure selon l'usage.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous habitez <strong className="text-black dark:text-white">Belin-Béliet ou ses hameaux</strong> ? Contactez-nous pour un projet thermique sur-mesure.
                      </p>
                      <p>
                        ClimGO se déplace chez vous pour étudier vos besoins et vous proposer une <strong className="text-black dark:text-white">solution fiable, économe et adaptée</strong> à votre cadre de vie.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Bénéficiez d'un <strong className="text-black dark:text-white">accompagnement de proximité, pensé pour les spécificités</strong> de Belin-Béliet et ses alentours.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos techniciens sont <strong className="text-black dark:text-white">certifiés RGE et QualiPAC</strong>, garantissant qualité et durabilité des installations.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous utilisons uniquement du <strong className="text-black dark:text-white">matériel rigoureusement sélectionné</strong> pour sa fiabilité et performance.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Situés à proximité, nous <strong className="text-black dark:text-white">intervenons rapidement, limitant les délais d'attente</strong> pour une prise en charge efficace.
                  </p>
                </div>
              </div>
            </div>
