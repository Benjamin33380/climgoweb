...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Begles 33130 | Expert Local | ClimGO',
  ...
  openGraph: {
    title: 'Chauffage Climatisation Begles 33130 | Expert Local | ClimGO',
    description: 'ClimGO, expert chauffage climatisation Begles 33130. Installation PAC, dépannage urgent, entretien. Artisan RGE certifié. Devis gratuit.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Begles 33130 - ClimGO Expert Local',
    }],
  },
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Begles 33130 | Expert Local | ClimGO',
    description: 'Expert chauffage climatisation Begles 33130. Installation PAC, dépannage urgent. Artisan RGE certifié.',
