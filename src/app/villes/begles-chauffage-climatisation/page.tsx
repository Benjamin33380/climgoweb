    ...
    <main className="px-0">
      <section className="hero-mobile-section relative h-[100vh] xs:h-[95vh] sm:h-[90vh] min-h-[500px] xs:min-h-[550px] sm:min-h-[600px] md:min-h-[640px] lg:min-h-[700px] xl:min-h-[750px] w-full overflow-hidden bg-transparent sm:bg-white sm:dark:bg-black text-black dark:text-white">
        ...
        <div className="absolute top-0 left-0 h-full w-full z-1 sm:hidden">
          <Image
            src="/villes/begles.webp"
            alt="Bègles - Bordeaux Métropole"
            fill
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-center pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                <p className="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white leading-normal">
                  Bègles est une <strong className="text-black dark:text-white">commune dynamique située en proche banlieue de Bordeaux</strong>, connue pour son mélange d'urbanisme moderne et de quartiers historiques.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Ses habitations variées nécessitent des <strong className="text-black dark:text-white">solutions de chauffage et de climatisation adaptées</strong>. Que vous soyez situé près du centre-ville, de la Gare ou du quartier Saint-Bruno.
                </p>
                
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-normal">
                  Située aux portes de Bordeaux, Bègles est une <strong className="text-black dark:text-white">ville en constante mutation</strong>, entre habitat ancien en pierre bordelaise et programmes immobiliers modernes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">ZAC des Sècheries, quartier Terre Sud</strong>, ligne de tram C, établissements scolaires (Lycée Vaclav Havel, écoles Albert Camus), équipements culturels (Le Carré-Colonnes).
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Attire de plus en plus de <strong className="text-black dark:text-white">jeunes familles et de professionnels</strong> en quête de confort urbain. Échoppes proches gare de Bègles, résidences neuves parc de Mussonville.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Entre <strong className="text-black dark:text-white">mitoyenneté forte, petits jardins</strong> et fortes amplitudes thermiques, chaque installation à Bègles demande un diagnostic précis.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  PAC fixées sur <strong className="text-black dark:text-white">plots ou supports muraux</strong> pour limiter nuisances sonores, unités intérieures choisies pour discrétion et efficacité énergétique.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Commune Urbaine Multiples Visages</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Population Dynamique</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Contraintes Urbaines</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Connue pour sa ligne de tram C, ses établissements scolaires, ses <strong className="text-black dark:text-white">équipements culturels</strong> (Le Carré-Colonnes).
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Nos équipes adaptent les solutions selon l'orientation, l'espace disponible et les <strong className="text-black dark:text-white">habitudes de vie</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-gray-50 dark:bg-background rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous envisagez de moderniser votre système de chauffage, d'ajouter une <strong className="text-black dark:text-white">climatisation réversible</strong> ou de remplacer un chauffe-eau ?
                      </p>
                      <p>
                        Faites appel à ClimGO. Un <strong className="text-black dark:text-white">technicien peut se déplacer rapidement</strong> pour évaluer les besoins sur place.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Entreprise engagée qui comprend les <strong className="text-black dark:text-white">particularités climatiques et architecturales</strong> de la commune de Bègles.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    PAC fixées sur <strong className="text-black dark:text-white">plots ou supports muraux</strong> pour limiter nuisances sonores. Unités intérieures choisies pour discrétion.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-gray-50 dark:bg-background backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité et notre rigueur font la différence : <strong className="text-black dark:text-white">service rapide, finitions propres, accompagnement administratif complet</strong>.
                  </p>
                </div>
              </div>
            </div>
