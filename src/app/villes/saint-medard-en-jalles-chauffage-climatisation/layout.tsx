...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Saint-Médard-en-Jalles - Chauffage & Climatisation",
    template: "%s | ClimGO Saint-Médard-en-Jalles"
  },
  description: "Expert chauffage climatisation à Saint-Médard-en-Jalles. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié.",
  ...
  openGraph: {
    ...
    title: "ClimGO Saint-Médard-en-Jalles - Chauffage & Climatisation",
    description: "Expert chauffage climatisation à Saint-Médard-en-Jalles. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié.",
    siteName: "ClimGO",
    images: [
      {
  ...
  alternates: {
    ...
    languages: {
      'x-default': 'https://www.climgo.fr/villes/saint-medard-en-jalles-chauffage-climatisation',
...
export default function SaintMedardEnJallesLayout({
  ...
  // Coordonnées de la mairie de Saint-Médard-en-Jalles
  const saintMedardEnJallesCoords = getCityCoordinates('saint-medard-en-jalles');
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Saint-Médard-en-Jalles
              "geo": saintMedardEnJallesCoords ? generateGeoJsonLd(saintMedardEnJallesCoords, "Mairie de Saint-Médard-en-Jalles") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
