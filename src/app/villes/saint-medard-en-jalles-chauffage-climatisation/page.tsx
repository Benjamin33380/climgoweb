            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Située entre Bordeaux et les Landes</strong>, Saint-Médard-en-Jalles conjugue zones résidentielles calmes et pôles d'activités technologiques.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  À seulement <strong className="text-black dark:text-white">15 km de Bordeaux, avec plus de 30 000 habitants</strong>, elle offre un tissu urbain diversifié et un fort potentiel immobilier.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Que vous soyez vers <strong className="text-black dark:text-white">Hastignan, Cérillan, Magudas ou Corbiac</strong>, ClimGO propose des installations sur-mesure et efficaces.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nos systèmes s'intègrent aussi bien dans <strong className="text-black dark:text-white">les maisons traditionnelles que dans les logements récents</strong> des quartiers pavillonnaires.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les familles apprécient ses <strong className="text-black dark:text-white">infrastructures complètes et sa proximité avec les pôles économiques</strong> (Dassault, ArianeGroup).
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO intervient dans <strong className="text-black dark:text-white">tous les quartiers avec une expertise adaptée aux conditions locales</strong> et un accompagnement personnalisé.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Quartiers Diversifiés</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Logements Variés</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Saint-Médard-en-Jalles séduit avec son <strong className="text-black dark:text-white">équilibre entre vie résidentielle, pôles économiques</strong> (Dassault, ArianeGroup) et cadre boisé.
                      </p>
                      <p>
                        Forte de <strong className="text-black dark:text-white">plus de 30 000 habitants</strong>, elle offre un tissu urbain diversifié et un fort potentiel immobilier.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Entre les <strong className="text-black dark:text-white">zones boisées, les sols argileux et la proximité des forêts</strong>, les installations nécessitent une approche sur-mesure.
                      </p>
                      <p>
                        Nos équipes maîtrisent les <strong className="text-black dark:text-white">contraintes locales : bruit, ventilation, sécurité</strong> et longévité des équipements.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        <strong className="text-black dark:text-white">Projet de rénovation énergétique ou installation</strong> dans une maison neuve ? Notre équipe locale vous accompagne.
                      </p>
                      <p>
                        Contactez ClimGO pour un <strong className="text-black dark:text-white">diagnostic sur place à Saint-Médard et un devis rapide</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire appel à ClimGO à Saint-Médard-en-Jalles, c'est choisir un <strong className="text-black dark:text-white">acteur local qui comprend les spécificités thermiques</strong> de la commune.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements sont adaptés à <strong className="text-black dark:text-white">l'environnement résidentiel : efficaces, durables, et esthétiques</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Vous bénéficiez d'un <strong className="text-black dark:text-white">accompagnement humain, rigoureux et réactif</strong>, du devis à la maintenance.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous proposons des <strong className="text-black dark:text-white">systèmes réversibles discrets et performants</strong>, compatibles avec les contraintes d'urbanisme.
                  </p>
                </div>
              </div>
            </div>
