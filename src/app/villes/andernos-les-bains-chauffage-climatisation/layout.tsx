...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Andernos-Les-Bains 33510 | ClimGO Expert Local',
  ...
  openGraph: {
    ...
    url: 'https://climgo.fr/villes/andernos-les-bains-chauffage-climatisation',
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Andernos-Les-Bains 33510 | ClimGO Expert Local',
    description: 'Expert chauffage climatisation Andernos-Les-Bains. Installation PAC, dépannage urgent. Artisan RGE certifié.',
    images: ['https://www.climgo.fr/images/twitter-andernos-les-bains-chauffage-climatisation.jpg'],
  },
  ...
  other: {
    ...
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://climgo.fr/villes/andernos-les-bains-chauffage-climatisation',
    'DC.source': 'https://www.climgo.fr',
    'DC.coverage': 'Andernos-Les-Bains, Gironde, France',
  ...
  alternates: {
    canonical: 'https://climgo.fr/villes/andernos-les-bains-chauffage-climatisation',
  },
