            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Eysines combine charme résidentiel et dynamisme périurbain</strong>. Un territoire idéal pour des solutions de chauffage et climatisation bien pensées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO intervient à Eysines pour vous proposer des <strong className="text-black dark:text-white">installations thermiques adaptées à tous les types d'habitat</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située au <strong className="text-black dark:text-white">nord-ouest de Bordeaux</strong>, Eysines bénéficie d'un développement résidentiel continu tout en conservant ses espaces verts.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Comme le <strong className="text-black dark:text-white">parc du Vigean ou le bois de Migelane</strong>. Sa proximité avec les boulevards et le tram D attire de nombreuses familles et jeunes actifs.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Les habitants profitent d'un <strong className="text-black dark:text-white">cadre de vie équilibré</strong>, avec des infrastructures modernes, des écoles réputées et un accès rapide vers Mérignac ou le centre de Bordeaux.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Le <strong className="text-black dark:text-white">tissu pavillonnaire, ancien et récent</strong>, permet des interventions variées en chauffage et climatisation.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Profitez d'un <strong className="text-black dark:text-white">accompagnement sur mesure, d'un confort optimisé</strong> et d'un rendu discret et efficace.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Charme Résidentiel</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Développement Résidentiel</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Cadre Équilibré</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Interventions Variées</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Sa <strong className="text-black dark:text-white">proximité avec les boulevards et le tram D</strong> attire de nombreuses familles et jeunes actifs.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Le bâti à Eysines est très <strong className="text-black dark:text-white">hétérogène : pavillons des années 60, logements en bande, maisons neuves RT2012</strong>…
                      </p>
                      <p>
                        Nous tenons également compte des <strong className="text-black dark:text-white">contraintes de voisinage pour minimiser le bruit extérieur</strong>, tout en garantissant confort et performance.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous soyez <strong className="text-black dark:text-white">propriétaire, en extension de maison ou en réhabilitation</strong>, ClimGO vous propose des solutions adaptées aux réalités d'Eysines.
                      </p>
                      <p>
                        Parlons-en et obtenez un <strong className="text-black dark:text-white">devis rapide et précis</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    S'assurer d'un <strong className="text-black dark:text-white">service de proximité avec une parfaite connaissance</strong> des enjeux locaux.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements <strong className="text-black dark:text-white">s'intègrent harmonieusement dans le paysage résidentiel eysinais</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous facilitons chaque étape, <strong className="text-black dark:text-white">des conseils jusqu'aux aides financières</strong>, pour un projet serein.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Que vous soyez en <strong className="text-black dark:text-white">maison individuelle ou en résidence à Eysines</strong>, nos solutions s'adaptent parfaitement à votre habitat.
                  </p>
                </div>
              </div>
            </div>
