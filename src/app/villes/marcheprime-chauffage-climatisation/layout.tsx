...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Marcheprime - Chauffage & Climatisation",
  ...
  openGraph: {
    ...
    title: "ClimGO Marcheprime - Chauffage & Climatisation",
    description: "Expert chauffage climatisation à Marcheprime. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié.",
    siteName: "ClimGO",
    images: [
      {
...
export default function MarcheprimeLayout({
  ...
  // Coordonnées de la mairie de Marcheprime
  const marcheprimeCoords = getCityCoordinates('marcheprime');
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Marcheprime
              "geo": marcheprimeCoords ? generateGeoJsonLd(marcheprimeCoords, "Mairie de Marcheprime") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
