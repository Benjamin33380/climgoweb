          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                ...
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nichée entre Bordeaux et le bassin d'Arcachon, <strong className="text-black dark:text-white">Marcheprime</strong> séduit par son environnement boisé, ses pistes cyclables et sa proximité avec la N250.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Avec plus de <strong className="text-black dark:text-white">5 000 habitants</strong>, la commune attire des familles en quête de calme, de maisons avec jardin et de solutions de confort thermique adaptées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Le tissu résidentiel se compose de <strong className="text-black dark:text-white">lotissements récents</strong>, d'habitations individuelles et de bâtis plus anciens à rénover. Nos solutions s'adaptent aux maisons RT2012.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  La nature sableuse du sol et la présence fréquente de pins imposent une attention particulière à l'emplacement des <strong className="text-black dark:text-white">unités extérieures</strong>.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Tous Quartiers</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Environnement Boisé</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Qualité & Professionnalisme</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Avec plus de <strong className="text-black dark:text-white">5 000 habitants</strong>, la commune attire des familles en quête de calme et de solutions de confort thermique adaptées.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Nous installons sur <strong className="text-black dark:text-white">plots ou dalles isolées</strong> pour préserver les performances acoustiques et thermiques.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous soyez résident de longue date ou nouvel arrivant, nous étudions votre logement pour vous proposer une <strong className="text-black dark:text-white">solution sur mesure</strong>.
                      </p>
                      <p>
                        Demandez votre <strong className="text-black dark:text-white">devis en ligne</strong> ou contactez-nous pour planifier une visite technique à Marcheprime.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Équipe réactive</strong>, ancrée localement. <strong className="text-black dark:text-white">Grande réactivité</strong>, accompagnement clair et chantiers menés avec exigence et professionnalisme.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Savoir-faire certifié</strong> RGE & QualiPAC. <strong className="text-black dark:text-white">Installations pensées</strong> pour durer avec matériel haut de gamme sélectionné.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Maisons traditionnelles</strong>, extensions bois, pavillons récents. Solutions adaptées aux <strong className="text-black dark:text-white">défis thermiques</strong> neufs comme anciens.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Nature sableuse</strong> du sol et présence de pins. <strong className="text-black dark:text-white">Installations sur plots</strong> isolées pour performances acoustiques optimales.
                  </p>
                </div>
              </div>
            </div>
