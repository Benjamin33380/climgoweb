...
export default function SallesLayout({
  ...
  // Coordonnées de la mairie de Salles
  const sallesCoords = getCityCoordinates('salles');
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // Données géographiques de la mairie de Salles
              "geo": sallesCoords ? generateGeoJsonLd(sallesCoords, "Mairie de Salles") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
