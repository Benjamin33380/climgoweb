          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                ...
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Ses équipements culturels comme le <strong className="text-black dark:text-white">Rocher de Palmer</strong> et ses quartiers en pleine mutation en font une ville tournée vers l'avenir.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Des <strong className="text-black dark:text-white">Hauts de Cenon jusqu'au Bas-Cenon</strong>, les familles bénéficient d'une bonne desserte en transports (tram A, bus TBM).
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO intervient dans l'ensemble de la commune, du <strong className="text-black dark:text-white">secteur Palmer à la Marègue</strong>, avec des solutions adaptées aux résidences récentes comme aux habitats collectifs des années 70.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Grâce à notre <strong className="text-black dark:text-white">expertise locale</strong>, chaque solution est pensée pour s'adapter aux caractéristiques des logements cenonnais.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Rive Droite Garonne</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Desserte Transport</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Avec ses <strong className="text-black dark:text-white">25 000 habitants</strong>, Cenon est une commune dynamique de la métropole bordelaise.
                      </p>
                      <p>
                        Connue pour ses <strong className="text-black dark:text-white">projets urbains modernes, ses équipements culturels</strong> comme le Rocher de Palmer et ses quartiers en pleine mutation.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Cenon possède une <strong className="text-black dark:text-white">diversité architecturale qui nécessite une approche sur-mesure</strong> : résidences en bande, logements sociaux, immeubles en terrasse.
                      </p>
                      <p>
                        Nous analysons chaque configuration <strong className="text-black dark:text-white">(exposition, orientation, ventilation naturelle)</strong> pour garantir des installations efficaces.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous <strong className="text-black dark:text-white">habitez Cenon ou y investissez</strong> ? Nos équipes vous conseillent et se déplacent rapidement.
                      </p>
                      <p>
                        Pour étudier votre logement et vous proposer la <strong className="text-black dark:text-white">solution la plus adaptée</strong> à votre confort et à votre budget.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix de la <strong className="text-black dark:text-white">proximité, du conseil et d'un savoir-faire reconnu</strong> à Cenon.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements <strong className="text-black dark:text-white">s'intègrent dans tous les types de logements cenonnais</strong>, avec discrétion et performance.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    ClimGO vous accompagne de A à Z, avec un <strong className="text-black dark:text-white">service rapide, soigné</strong>, et des démarches simplifiées pour vos aides.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Maisons récentes, résidences ou immeubles anciens</strong> : nous adaptons chaque installation aux spécificités des logements de Cenon.
                  </p>
                </div>
              </div>
            </div>
