...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Cenon 33150 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Cenon 33150 | ClimGO',
    'DC.description': 'Expert chauffage climatisation Cenon 33150. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://www.climgo.fr/villes/cenon-chauffage-climatisation',
...
export default function CenonLayout({
  ...
  return (
    <>
      <JsonLd type="city" city="Cenon" postalCode="33150" />
      {children}
    </>
  );
}