...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Pessac 33600 | ClimGO',
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Pessac 33600 - ClimGO',
    }],
  },
  ...
  other: {
    ...
    // Dublin Core COMPLET
    'DC.title': 'Chauffage Climatisation Pessac 33600 | ClimGO',
    'DC.description': 'Expert chauffage climatisation Pessac 33600. Installation PAC, dépannage, entretien. Artisan RGE. Devis gratuit.',
    'DC.creator': 'ClimGO',
    'DC.publisher': 'ClimGO',
    'DC.language': 'fr-FR',
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://www.climgo.fr/villes/pessac-chauffage-climatisation',
...
export default function PessacLayout({
  ...
  return (
    <>
      <JsonLd type="city" city="Pessac" postalCode="33600" />
      {children}
    </>
  );
}