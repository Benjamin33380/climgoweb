...
export const metadata: Metadata = {
  ...
  title: {
    default: "ClimGO Martillac - Chauffage & Climatisation",
    template: "%s | ClimGO Martillac"
  },
  description: "Expert chauffage climatisation à Martillac. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié.",
  keywords: ["chauffage Martillac", "climatisation Martillac", "pompe à chaleur Martillac", "installation PAC Martillac", "entretien chauffage Martillac", "artisan RGE Martillac", "PAC air-eau Martillac", "PAC air-air Martillac", "plancher chauffant Martillac", "radiateurs Martillac", "maintenance Martillac", "dépannage Martillac", "devis gratuit Martillac"],
  ...
  openGraph: {
    ...
    title: "ClimGO Martillac - Chauffage & Climatisation",
    description: "Expert chauffage climatisation à Martillac. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié.",
    siteName: "ClimGO",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ClimGO Martillac - Chauffage & Climatisation | Installation PAC, Entretien",
      },
    ],
  },
  ...
  alternates: {
    ...
    languages: {
      'x-default': 'https://www.climgo.fr/villes/martillac-chauffage-climatisation',
      'fr-FR': 'https://www.climgo.fr/villes/martillac-chauffage-climatisation',
    },
  },
  verification: {
  ...
  other: {
    "zones-desservies": "Martillac, Bordeaux Métropole, Gironde, Nouvelle-Aquitaine",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "ClimGO Martillac",
    "application-name": "ClimGO Martillac",
...
export default function MartillacLayout({
  ...
  // Coordonnées de la mairie de Martillac
  const martillacCoords = getCityCoordinates('martillac');
  
  return (
    <>
      {/* Schéma JSON-LD principal - LocalBusiness pour Martillac */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "ClimGO, expert chauffage et climatisation à Martillac. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "address": {
                "@type": "PostalAddress",
              ...
              // Données géographiques de la mairie de Martillac
              "geo": martillacCoords ? generateGeoJsonLd(martillacCoords, "Mairie de Martillac") : undefined,
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+33766460008",
              ...
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "Services ClimGO Martillac",
                "itemListElement": [
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Chauffage Martillac",
                      "description": "Installation et maintenance de systèmes de chauffage, PAC, planchers chauffants à Martillac",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Climatisation Martillac",
                      "description": "Installation et maintenance de systèmes de climatisation à Martillac",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Eau Chaude Sanitaire Martillac",
                      "description": "Installation et maintenance de systèmes d'eau chaude sanitaire à Martillac",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Maintenance Martillac",
                      "description": "Entretien et dépannage de vos équipements thermiques à Martillac",
        ...
        {/* JSON-LD pour la page web de Martillac */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "name": "ClimGO Martillac - Chauffage & Climatisation",
              "url": "https://www.climgo.fr/villes/martillac-chauffage-climatisation",
              "description": "ClimGO, expert chauffage et climatisation à Martillac. Installation PAC air/eau, climatisation réversible, entretien et dépannage. Artisan RGE certifié. Devis gratuit sous 24h.",
              "potentialAction": {
                "@type": "SearchAction",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ItemList",
              "name": "Services ClimGO Martillac",
              "description": "Liste des services proposés par ClimGO à Martillac",
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
        ...
        {/* JSON-LD FAQ - Questions génériques pour Martillac (ville faible) */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
