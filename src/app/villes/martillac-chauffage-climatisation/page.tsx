            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Située entre Bordeaux et les grands châteaux du Sud-Ouest</strong>, Martillac est une commune qui allie tradition et modernité.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nos installations de chauffage et de climatisation s'intègrent parfaitement à l'<strong className="text-black dark:text-white">architecture locale</strong>, que vous soyez dans le centre, proche du domaine de Cheval Blanc ou dans les zones pavillonnaires environnantes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Chaque intervention est pensée pour <strong className="text-black dark:text-white">optimiser le confort de votre logement</strong> tout en respectant le cadre résidentiel et les performances énergétiques exigées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Nichée au cœur des <strong className="text-black dark:text-white">prestigieux vignobles des Graves</strong>, Martillac offre un cadre paisible et authentique à ses habitants.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Située à seulement <strong className="text-black dark:text-white">20 minutes de Bordeaux</strong>, la ville séduit autant les amateurs de nature que les familles recherchant un environnement calme.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Martillac se développe autour d'un <strong className="text-black dark:text-white">tissu résidentiel varié</strong>, entre chais anciens rénovés, maisons traditionnelles et nouvelles zones pavillonnaires.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Vignobles Prestigieux</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Tissu Résidentiel Varié</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Territoire Couvert</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Installations Sur Mesure</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="hidden md:block absolute right-0 top-0 bottom-0 w-90 bg-gradient-to-l from-white via-white/80 to-transparent dark:from-black dark:via-black/80 z-10 pointer-events-none" />
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Entre <strong className="text-black dark:text-white">humidité matinale des vignes et variations thermiques</strong>, nous adaptons nos installations aux exigences spécifiques du climat martillacais.
                      </p>
                      <p>
                        L'esthétique locale étant un enjeu majeur, nous privilégions des <strong className="text-black dark:text-white">installations sobres, efficaces et silencieuses</strong>, parfaitement intégrées aux façades typiques de la région.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Que vous soyez <strong className="text-black dark:text-white">viticulteur, propriétaire d'un bien ancien ou acquéreur d'une maison neuve</strong>, ClimGO vous accompagne pour optimiser votre confort thermique.
                      </p>
                      <p>
                        Contactez-nous pour une <strong className="text-black dark:text-white">étude personnalisée sur Martillac et ses alentours</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire appel à ClimGO à Martillac, c'est choisir un <strong className="text-black dark:text-white">acteur local réactif et expérimenté dans le confort thermique</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Pompes à chaleur, climatisation, chauffe-eau</strong>… Nous adaptons chaque projet aux besoins du secteur résidentiel local.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité avec Martillac nous permet une <strong className="text-black dark:text-white">rapidité d'intervention et un suivi optimal</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Maisons traditionnelles, constructions récentes ou rénovations</strong> : nous couvrons l'ensemble du territoire de Martillac.
                  </p>
                </div>
              </div>
            </div>
