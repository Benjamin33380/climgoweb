...
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Le Bouscat 33110 | Expert Local | ClimGO',
  ...
  openGraph: {
    title: 'Chauffage Climatisation Le Bouscat 33110 | Expert Local | ClimGO',
    description: 'ClimGO, expert chauffage climatisation Le Bouscat 33110. Installation PAC, dépannage urgent, entretien. Artisan RGE certifié. Devis gratuit.',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Chauffage climatisation Le Bouscat 33110 - ClimGO Expert Local',
    }],
  },
  ...
  twitter: {
    ...
    creator: '@climgo_fr',
    title: 'Chauffage Climatisation Le Bouscat 33110 | Expert Local | ClimGO',
    description: 'Expert chauffage climatisation Le Bouscat 33110. Installation PAC, dépannage urgent. Artisan RGE certifié.',
