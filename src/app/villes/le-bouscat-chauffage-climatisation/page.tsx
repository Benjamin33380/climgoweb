            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-white leading-normal">
                  <strong className="text-black dark:text-white">Le Bouscat, avec son ambiance résidentielle et ses belles maisons</strong>, mérite des installations thermiques sur-mesure.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Le Bouscat <strong className="text-black dark:text-white">séduit par son équilibre entre urbanité et nature</strong>. Proche du centre de Bordeaux, la commune offre un cadre résidentiel recherché.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Entre <strong className="text-black dark:text-white">échoppes rénovées, maisons bourgeoises et résidences contemporaines</strong>. Elle attire autant les familles que les actifs bordelais.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Bien desservi par le <strong className="text-black dark:text-white">tram D, les lignes de bus et la rocade</strong>, Le Bouscat est prisé pour sa qualité de vie, ses commerces de proximité et ses équipements culturels.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Comme <strong className="text-black dark:text-white">l'Hippodrome ou la médiathèque</strong>. ClimGO intervient dans tous les quartiers : Parc Marceau, Barrière du Médoc, avenue Victor Hugo ou secteur Saint-Amand.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  ClimGO vous accompagne pour équiper votre maison ou appartement du Bouscat avec des <strong className="text-black dark:text-white">solutions performantes, esthétiques et discrètes</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-white leading-normal">
                  Forts de notre expérience locale et de nos certifications, nous garantissons des installations <strong className="text-black dark:text-white">durables, économiques et parfaitement adaptées</strong> aux besoins spécifiques des logements du Bouscat.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Ambiance Résidentielle</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Équilibre Urbanité Nature</h3>
                  <p className="text-black dark:text-white leading-relaxed">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-black dark:text-white mb-3">Cadre Recherché</h3>
                  <p className="text-black dark:text-white leading-relaxed">
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      ...
                      <p>
                        Bien desservi par le <strong className="text-black dark:text-white">tram D, les lignes de bus et la rocade</strong>, Le Bouscat est prisé pour sa qualité de vie.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        L'<strong className="text-black dark:text-white">architecture du Bouscat demande des installations discrètes et efficaces</strong>. Chez ClimGO, nous adaptons nos systèmes aux surfaces vitrées, aux murs épais typiques des échoppes.
                      </p>
                      <p>
                        Nos équipements sont sélectionnés pour leur <strong className="text-black dark:text-white">faible nuisance sonore et leur design</strong>, répondant parfaitement aux exigences des habitats du Bouscat.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-black dark:text-white leading-relaxed">
                      <p>
                        Vous envisagez une <strong className="text-black dark:text-white">rénovation énergétique, une installation de climatisation ou un entretien de PAC</strong> au Bouscat ?
                      </p>
                      <p>
                        ClimGO vous accompagne avec <strong className="text-black dark:text-white">sérieux et réactivité</strong>. Contactez-nous pour une étude personnalisée.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix d'un <strong className="text-black dark:text-white">savoir-faire local et d'un accompagnement complet</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Pompes à chaleur, climatiseurs et chauffe-eaux sélectionnés pour garantir <strong className="text-black dark:text-white">efficacité, discrétion et durabilité</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité et notre rigueur font la différence : un <strong className="text-black dark:text-white">service rapide, des finitions propres, et un accompagnement administratif complet</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-black dark:hover:border-white min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-black dark:text-white text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-black dark:text-white">Résidences familiales, logements collectifs, et zones pavillonnaires</strong> : nous maîtrisons les contraintes thermiques de tous les types d'habitat au Bouscat.
                  </p>
                </div>
              </div>
            </div>
