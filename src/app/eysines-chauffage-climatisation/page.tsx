...
export default function Eysines() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Eysines - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Eysines, entre tradition et modernité aux portes de Bordeaux
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Eysines combine charme résidentiel et dynamisme périurbain</strong>. Un territoire idéal pour des solutions de chauffage et climatisation bien pensées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient à Eysines pour vous proposer des <strong className="text-gray-900 dark:text-white">installations thermiques adaptées à tous les types d'habitat</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située au <strong className="text-gray-900 dark:text-white">nord-ouest de Bordeaux</strong>, Eysines bénéficie d'un développement résidentiel continu tout en conservant ses espaces verts.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Comme le <strong className="text-gray-900 dark:text-white">parc du Vigean ou le bois de Migelane</strong>. Sa proximité avec les boulevards et le tram D attire de nombreuses familles et jeunes actifs.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Les habitants profitent d'un <strong className="text-gray-900 dark:text-white">cadre de vie équilibré</strong>, avec des infrastructures modernes, des écoles réputées et un accès rapide vers Mérignac ou le centre de Bordeaux.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Le <strong className="text-gray-900 dark:text-white">tissu pavillonnaire, ancien et récent</strong>, permet des interventions variées en chauffage et climatisation.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Profitez d'un <strong className="text-gray-900 dark:text-white">accompagnement sur mesure, d'un confort optimisé</strong> et d'un rendu discret et efficace.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Charme Résidentiel</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Combine charme résidentiel et dynamisme périurbain. Territoire idéal pour des solutions de chauffage et climatisation bien pensées.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Développement Résidentiel</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Nord-ouest Bordeaux, développement résidentiel continu conservant espaces verts : parc du Vigean, bois de Migelane. Proximité boulevards et tram D.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Cadre Équilibré</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Habitants profitent cadre vie équilibré, infrastructures modernes, écoles réputées et accès rapide vers Mérignac ou centre Bordeaux.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Interventions Variées</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Tissu pavillonnaire, ancien et récent, permet interventions variées chauffage climatisation. Accompagnement sur mesure, confort optimisé, rendu discret efficace.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Eysines, entre urbanisme et nature
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Sa <strong className="text-gray-900 dark:text-white">proximité avec les boulevards et le tram D</strong> attire de nombreuses familles et jeunes actifs.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions à Eysines
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue du Médoc :</strong> climatisation split inverter dans maison mitoyenne en rénovation énergétique.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Chemin de Lescombes :</strong> remplacement ancien chauffe-eau gaz par modèle thermodynamique performant.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Avenue de l'Hippodrome :</strong> PAC air/eau couplée à plancher chauffant pour maison neuve.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un savoir-faire pensé pour les logements eysinais
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Le bâti à Eysines est très <strong className="text-gray-900 dark:text-white">hétérogène : pavillons des années 60, logements en bande, maisons neuves RT2012</strong>…
                      </p>
                      <p>
                        Nous tenons également compte des <strong className="text-gray-900 dark:text-white">contraintes de voisinage pour minimiser le bruit extérieur</strong>, tout en garantissant confort et performance.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Vous avez un projet thermique à Eysines ?
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Que vous soyez <strong className="text-gray-900 dark:text-white">propriétaire, en extension de maison ou en réhabilitation</strong>, ClimGO vous propose des solutions adaptées aux réalités d'Eysines.
                      </p>
                      <p>
                        Parlons-en et obtenez un <strong className="text-gray-900 dark:text-white">devis rapide et précis</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Eysines ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Eysines - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    S'assurer d'un <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">service de proximité avec une parfaite connaissance</strong> des enjeux locaux.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements <strong className="text-gray-900 dark:text-gray-300">s'intègrent harmonieusement dans le paysage résidentiel eysinais</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous facilitons chaque étape, <strong className="text-gray-900 dark:text-gray-300">des conseils jusqu'aux aides financières</strong>, pour un projet serein.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Que vous soyez en <strong className="text-gray-900 dark:text-gray-300">maison individuelle ou en résidence à Eysines</strong>, nos solutions s'adaptent parfaitement à votre habitat.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Eysines
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Eysines</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="eysines" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Eysines,France&zoom=13&center=44.8794,-0.6475`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Eysines, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Eysines et ses quartiers"
