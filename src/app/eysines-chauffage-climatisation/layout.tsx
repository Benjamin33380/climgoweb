...
// Métadonnées ultra-optimisées Eysines
export const metadata: Metadata = {
  title: 'Chauffage Climatisation Eysines | ClimGO Expert Local',
  ...
  keywords: [
    ...
    'chauffage eysines', 'climatisation eysines',
  ...
  openGraph: {
    ...
    url: 'https://climgo.fr/eysines-chauffage-climatisation',
    siteName: 'ClimGO - Expert Chauffage Climatisation',
    locale: 'fr_FR',
    type: 'website',
    images: [{
      url: 'https://climgo.fr/images/og-eysines-chauffage-climatisation.jpg',
      width: 1200,
      height: 630,
