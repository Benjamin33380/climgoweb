...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'chauffage le-bouscat', 'climatisation le-bouscat', 'pompe à chaleur le-bouscat',
    'chauffagiste le-bouscat 33110', 'plombier chauffagiste le-bouscat',
    
    // Services spécifiques
    'installation pompe à chaleur le-bouscat', 'dépannage chauffage le-bouscat',
    'entretien climatisation le-bouscat', 'réparation PAC le-bouscat',
    
    // Urgences
    'chauffagiste urgence le-bouscat', 'dépannage 24h le-bouscat',
    
    // Certifications
    'artisan RGE le-bouscat', 'qualipac le-bouscat'
  ].join(', '),
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Expert chauffage et climatisation à Le-Bouscat. Installation, dépannage et entretien de systèmes de chauffage et pompes à chaleur.",
              "url": "https://climgo.fr/le-bouscat-chauffage-climatisation",
              ...
              "makesOffer": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Installation de pompes à chaleur air/eau et air/air à Le-Bouscat"
                  },
                  "price": "8000",
                  "priceCurrency": "EUR"
                },
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Service de dépannage chauffage 24h/7j à Le-Bouscat"
                  },
                  "price": "120",
                  "priceCurrency": "EUR"
                }
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Quel est le prix d'une pompe à chaleur à Le-Bouscat ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Le prix d'une pompe à chaleur à Le-Bouscat varie entre 8 000€ et 15 000€. ClimGO vous propose un devis gratuit et vous accompagne pour les aides financières."
                  }
                },
                {
                  "@type": "Question",
                  "name": "ClimGO intervient-il en urgence à Le-Bouscat ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO propose un service d'urgence 24h/7j à Le-Bouscat. Contactez-nous au 07 66 46 00 08 pour une intervention rapide."
                  }
                }
              ]
            })
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 3,
                  "name": "Le-Bouscat",
                  "item": "https://climgo.fr/le-bouscat-chauffage-climatisation"
                }
              ]
            })
          }}
