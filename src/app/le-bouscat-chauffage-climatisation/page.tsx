...
export default function LeBouscat() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Le Bouscat - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Le Bouscat, commune résidentielle proche de Bordeaux
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Le Bouscat, avec son ambiance résidentielle et ses belles maisons</strong>, mérite des installations thermiques sur-mesure.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Le Bouscat <strong className="text-gray-900 dark:text-white">séduit par son équilibre entre urbanité et nature</strong>. Proche du centre de Bordeaux, la commune offre un cadre résidentiel recherché.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Entre <strong className="text-gray-900 dark:text-white">échoppes rénovées, maisons bourgeoises et résidences contemporaines</strong>. Elle attire autant les familles que les actifs bordelais.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Bien desservi par le <strong className="text-gray-900 dark:text-white">tram D, les lignes de bus et la rocade</strong>, Le Bouscat est prisé pour sa qualité de vie, ses commerces de proximité et ses équipements culturels.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Comme <strong className="text-gray-900 dark:text-white">l'Hippodrome ou la médiathèque</strong>. ClimGO intervient dans tous les quartiers : Parc Marceau, Barrière du Médoc, avenue Victor Hugo ou secteur Saint-Amand.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO vous accompagne pour équiper votre maison ou appartement du Bouscat avec des <strong className="text-gray-900 dark:text-white">solutions performantes, esthétiques et discrètes</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Forts de notre expérience locale et de nos certifications, nous garantissons des installations <strong className="text-gray-900 dark:text-white">durables, économiques et parfaitement adaptées</strong> aux besoins spécifiques des logements du Bouscat.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Ambiance Résidentielle</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Avec son ambiance résidentielle et ses belles maisons, mérite des installations thermiques sur-mesure.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Équilibre Urbanité Nature</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Séduit par équilibre entre urbanité nature. Proche centre Bordeaux, commune offre cadre résidentiel recherché, échoppes rénovées maisons bourgeoises résidences contemporaines.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Cadre Recherché</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Bien desservi tram D lignes bus rocade, prisé qualité vie commerces proximité équipements culturels Hippodrome médiathèque. Quartiers Parc Marceau Barrière Médoc avenue Victor Hugo secteur Saint-Amand.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    ClimGO accompagne équiper maison appartement Bouscat solutions performantes esthétiques discrètes. Expérience locale certifications, installations durables économiques parfaitement adaptées besoins spécifiques logements.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune urbaine et arborée aux portes de Bordeaux
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Bien desservi par le <strong className="text-gray-900 dark:text-white">tram D, les lignes de bus et la rocade</strong>, Le Bouscat est prisé pour sa qualité de vie.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions au Bouscat
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue Thérèse :</strong> installation système gainable avec régulation multi-zone dans échoppe rénovée.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Avenue de la Libération :</strong> remplacement chauffe-eau vétuste par modèle thermodynamique haute performance.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue des Marronniers :</strong> contrat maintenance annuel pour ensemble climatisation + chauffage existant.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une expertise pensée pour le bâti Bouscatais
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        L'<strong className="text-gray-900 dark:text-white">architecture du Bouscat demande des installations discrètes et efficaces</strong>. Chez ClimGO, nous adaptons nos systèmes aux surfaces vitrées, aux murs épais typiques des échoppes.
                      </p>
                      <p>
                        Nos équipements sont sélectionnés pour leur <strong className="text-gray-900 dark:text-white">faible nuisance sonore et leur design</strong>, répondant parfaitement aux exigences des habitats du Bouscat.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Parlons de votre projet au Bouscat
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous envisagez une <strong className="text-gray-900 dark:text-white">rénovation énergétique, une installation de climatisation ou un entretien de PAC</strong> au Bouscat ?
                      </p>
                      <p>
                        ClimGO vous accompagne avec <strong className="text-gray-900 dark:text-white">sérieux et réactivité</strong>. Contactez-nous pour une étude personnalisée.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO au Bouscat ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO au Bouscat - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix d'un <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">savoir-faire local et d'un accompagnement complet</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Pompes à chaleur, climatiseurs et chauffe-eaux sélectionnés pour garantir <strong className="text-gray-900 dark:text-gray-300">efficacité, discrétion et durabilité</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité et notre rigueur font la différence : un <strong className="text-gray-900 dark:text-gray-300">service rapide, des finitions propres, et un accompagnement administratif complet</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Résidences familiales, logements collectifs, et zones pavillonnaires</strong> : nous maîtrisons les contraintes thermiques de tous les types d'habitat au Bouscat.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique au Bouscat
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières au Bouscat</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="le-bouscat" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Le Bouscat,France&zoom=13&center=44.8658,-0.5925`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention au Bouscat, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO au Bouscat et ses quartiers"
