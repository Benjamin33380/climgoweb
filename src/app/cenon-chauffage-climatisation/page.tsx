  ...
  return (
    <main className="px-0">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Située sur la <strong className="text-gray-900 dark:text-white">rive droite de la Garonne</strong>, Cenon offre un cadre de vie agréable et en pleine évolution, idéal pour des installations énergétiques modernes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO vous accompagne à Cenon pour tous vos besoins en <strong className="text-gray-900 dark:text-white">chauffage, climatisation ou production d'eau chaude</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec ses <strong className="text-gray-900 dark:text-white">25 000 habitants</strong>, Cenon est une commune dynamique de la métropole bordelaise, connue pour ses projets urbains modernes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Ses équipements culturels comme le <strong className="text-gray-900 dark:text-white">Rocher de Palmer</strong> et ses quartiers en pleine mutation en font une ville tournée vers l'avenir.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Des <strong className="text-gray-900 dark:text-white">Hauts de Cenon jusqu'au Bas-Cenon</strong>, les familles bénéficient d'une bonne desserte en transports (tram A, bus TBM).
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient dans l'ensemble de la commune, du <strong className="text-gray-900 dark:text-white">secteur Palmer à la Marègue</strong>, avec des solutions adaptées aux résidences récentes comme aux habitats collectifs des années 70.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Grâce à notre <strong className="text-gray-900 dark:text-white">expertise locale</strong>, chaque solution est pensée pour s'adapter aux caractéristiques des logements cenonnais.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Rive Droite Garonne</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Située sur la rive droite de la Garonne, cadre de vie agréable et en pleine évolution, idéal pour des installations énergétiques modernes.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    25 000 habitants, commune dynamique de la métropole bordelaise, projets urbains modernes, équipements culturels comme le Rocher de Palmer.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Desserte Transport</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Des Hauts de Cenon jusqu'au Bas-Cenon, familles bénéficient bonne desserte transports (tram A, bus TBM), établissements scolaires qualité.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Intervention ensemble commune, secteur Palmer à la Marègue, solutions adaptées résidences récentes comme habitats collectifs années 70. Expertise locale.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Avec ses <strong className="text-gray-900 dark:text-white">25 000 habitants</strong>, Cenon est une commune dynamique de la métropole bordelaise.
                      </p>
                      <p>
                        Connue pour ses <strong className="text-gray-900 dark:text-white">projets urbains modernes, ses équipements culturels</strong> comme le Rocher de Palmer et ses quartiers en pleine mutation.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples d'installations réalisées à Cenon
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un savoir-faire calibré pour Cenon
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Cenon possède une <strong className="text-gray-900 dark:text-white">diversité architecturale qui nécessite une approche sur-mesure</strong> : résidences en bande, logements sociaux, immeubles en terrasse.
                      </p>
                      <p>
                        Nous analysons chaque configuration <strong className="text-gray-900 dark:text-white">(exposition, orientation, ventilation naturelle)</strong> pour garantir des installations efficaces.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un projet thermique à Cenon ?
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous <strong className="text-gray-900 dark:text-white">habitez Cenon ou y investissez</strong> ? Nos équipes vous conseillent et se déplacent rapidement.
                      </p>
                      <p>
                        Pour étudier votre logement et vous proposer la <strong className="text-gray-900 dark:text-white">solution la plus adaptée</strong> à votre confort et à votre budget.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Cenon ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix de la <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">proximité, du conseil et d'un savoir-faire reconnu</strong> à Cenon.
                  </p>
                </div>
              </div>

              {/* Intégration Logements */}
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements <strong className="text-gray-900 dark:text-gray-300">s'intègrent dans tous les types de logements cenonnais</strong>, avec discrétion et performance.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    ClimGO vous accompagne de A à Z, avec un <strong className="text-gray-900 dark:text-gray-300">service rapide, soigné</strong>, et des démarches simplifiées pour vos aides.
                  </p>
                </div>
              </div>

              {/* Adaptation Types Logements */}
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  <div className="bg-gray-100 dark:bg-gray-800 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <svg className="w-12 h-12 text-gray-900 dark:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Maisons récentes, résidences ou immeubles anciens</strong> : nous adaptons chaque installation aux spécificités des logements de Cenon.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Cenon
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Types de logements desservis à Cenon</h3>
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Cenon</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="cenon" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Cenon,France&zoom=13&center=44.8578,-0.5196`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Cenon, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Cenon et ses quartiers"
