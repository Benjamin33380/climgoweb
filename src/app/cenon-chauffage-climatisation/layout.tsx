...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://climgo.fr/cenon-chauffage-climatisation',
  ...
  alternates: {
    canonical: 'https://climgo.fr/cenon-chauffage-climatisation',
  },
              ...
              "makesOffer": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Installation de pompes à chaleur air/eau et air/air à Cenon"
                  },
                  "price": "8000",
                  "priceCurrency": "EUR"
                },
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Service de dépannage chauffage 24h/7j à Cenon"
                  },
                  "price": "120",
                  "priceCurrency": "EUR"
                }
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 3,
                  "name": "Cenon",
                  "item": "https://climgo.fr/cenon-chauffage-climatisation"
                }
              ]
            })
          }}
