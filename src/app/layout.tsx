...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'entretien chauffage gironde',
    'dépannage climatisation gironde',
    'artisan RGE gironde',
    'chauffagiste bordeaux',
    'installateur climatisation bordeaux',
    'maintenance PAC gironde',
    'réparation chauffage gironde',
    'chaudière condensation gironde',
    'plancher chauffant gironde',
    'climatiseur réversible gironde',
    'devis gratuit chauffage',
    'intervention urgence gironde',
