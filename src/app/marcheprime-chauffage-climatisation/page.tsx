  ...
  return (
    <main className="px-0">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Entre <strong className="text-gray-900 dark:text-white">pins et pistes cyclables</strong>, Marcheprime attire par sa douceur de vivre et sa situation idéale entre Bordeaux et le Bassin. Sa croissance maîtrisée en fait un territoire dynamique.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous soyez installé à <strong className="text-gray-900 dark:text-white">Croix d'Hins</strong>, au Bourg ou dans les hameaux environnants comme <strong className="text-gray-900 dark:text-white">Biard</strong>, ClimGO adapte ses solutions à la typologie locale.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec une parfaite connaissance du secteur, nous intégrons les <strong className="text-gray-900 dark:text-white">particularités thermiques</strong> de chaque zone pour concevoir des installations durables et performantes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nichée entre Bordeaux et le bassin d'Arcachon, <strong className="text-gray-900 dark:text-white">Marcheprime</strong> séduit par son environnement boisé, ses pistes cyclables et sa proximité avec la N250.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec plus de <strong className="text-gray-900 dark:text-white">5 000 habitants</strong>, la commune attire des familles en quête de calme, de maisons avec jardin et de solutions de confort thermique adaptées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Le tissu résidentiel se compose de <strong className="text-gray-900 dark:text-white">lotissements récents</strong>, d'habitations individuelles et de bâtis plus anciens à rénover. Nos solutions s'adaptent aux maisons RT2012.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  La nature sableuse du sol et la présence fréquente de pins imposent une attention particulière à l'emplacement des <strong className="text-gray-900 dark:text-white">unités extérieures</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Marcheprime
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                De Biard aux lotissements résidentiels du Bourg, notre équipe intervient dans tous les quartiers de Marcheprime. Chaque projet bénéficie d'un accompagnement sur mesure.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Tous Quartiers</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Interventions dans tous les secteurs : autour de la gare, route de Lacanau, quartier du Bourg, près du collège Aliénor d'Aquitaine. Service de proximité garanti.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Habitat Diversifié</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Maisons traditionnelles, extensions bois, pavillons récents : nos solutions s'adaptent à tous les styles présents à Marcheprime. Défis thermiques neufs comme anciens.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Environnement Boisé</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Installations sur plots ou dalles isolées pour préserver performances acoustiques et thermiques. Attention aux expositions sud/ouest et besoins de rafraîchissement.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Qualité & Professionnalisme</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Grande réactivité, accompagnement clair et chantiers menés avec exigence. Équipements qui allient confort, discrétion et efficacité énergétique.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un cadre résidentiel prisé entre ville et nature
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Avec plus de <strong className="text-gray-900 dark:text-white">5 000 habitants</strong>, la commune attire des familles en quête de calme et de solutions de confort thermique adaptées.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions à Marcheprime
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue des Palombes :</strong> remplacement système fioul par PAC air/eau nouvelle génération.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Lotissement du Bourg :</strong> splits muraux silencieux maison familiale avec mezzanine.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Impasse des Genêts :</strong> plancher chauffant relié PAC double service.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un savoir-faire taillé pour les habitations de Marcheprime
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        La nature sableuse du sol et la présence fréquente de pins imposent une attention particulière à l'emplacement des <strong className="text-gray-900 dark:text-white">unités extérieures</strong>.
                      ...
                      <p>
                        Nous installons sur <strong className="text-gray-900 dark:text-white">plots ou dalles isolées</strong> pour préserver les performances acoustiques et thermiques.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Parlons de votre projet à Marcheprime
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Que vous soyez résident de longue date ou nouvel arrivant, nous étudions votre logement pour vous proposer une <strong className="text-gray-900 dark:text-white">solution sur mesure</strong>.
                      </p>
                      <p>
                        Demandez votre <strong className="text-gray-900 dark:text-white">devis en ligne</strong> ou contactez-nous pour planifier une visite technique à Marcheprime.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Marcheprime ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Choisir ClimGO, c'est faire confiance à une équipe réactive, ancrée localement. Nos interventions à Marcheprime s'appuient sur des solutions éprouvées.
              </p>
            </div>
            
            {/* Pourquoi choisir ClimGO à Marcheprime - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Équipe réactive</strong>, ancrée localement. <strong className="text-gray-900 dark:text-gray-300">Grande réactivité</strong>, accompagnement clair et chantiers menés avec exigence et professionnalisme.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Savoir-faire certifié</strong> RGE & QualiPAC. <strong className="text-gray-900 dark:text-gray-300">Installations pensées</strong> pour durer avec matériel haut de gamme sélectionné.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Maisons traditionnelles</strong>, extensions bois, pavillons récents. Solutions adaptées aux <strong className="text-gray-900 dark:text-gray-300">défis thermiques</strong> neufs comme anciens.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Nature sableuse</strong> du sol et présence de pins. <strong className="text-gray-900 dark:text-gray-300">Installations sur plots</strong> isolées pour performances acoustiques optimales.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Marcheprime
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Marcheprime</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="marcheprime" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Marcheprime,France&zoom=12&center=44.6914,-0.8492`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Marcheprime, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Marcheprime et ses quartiers"
