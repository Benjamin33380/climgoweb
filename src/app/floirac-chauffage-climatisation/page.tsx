...
export default function Floirac() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Floirac - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Floirac, ville verdoyante entre coteaux et fleuve
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Située entre les coteaux boisés et la Garonne</strong>, Floirac offre un cadre de vie paisible et verdoyant, idéal pour des installations énergétiques modernes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située sur la <strong className="text-gray-900 dark:text-white">rive droite de la Garonne</strong>, Floirac connaît une forte dynamique résidentielle grâce à son lien direct avec Bordeaux et ses projets de réaménagement urbain.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec plus de <strong className="text-gray-900 dark:text-white">18 000 habitants</strong>, la commune attire les jeunes actifs, familles et retraités.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Le <strong className="text-gray-900 dark:text-white">tram A, le pont Simone Veil</strong> et la proximité immédiate de l'Arena et des berges font de Floirac un secteur à fort potentiel.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Les <strong className="text-gray-900 dark:text-white">écoles, les équipements sportifs et les commerces</strong> de proximité complètent un cadre de vie urbain, mais aéré.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO vous accompagne à Floirac pour tous vos besoins en <strong className="text-gray-900 dark:text-white">chauffage, climatisation ou production d'eau chaude</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Grâce à notre <strong className="text-gray-900 dark:text-white">expertise locale</strong>, chaque solution est pensée pour s'adapter aux caractéristiques des logements floiracais.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Cadre Verdoyant</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Située entre les coteaux boisés et la Garonne, offre un cadre de vie paisible et verdoyant, idéal pour des installations énergétiques modernes.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Dynamique Résidentielle</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Rive droite Garonne, forte dynamique résidentielle grâce lien direct avec Bordeaux et projets réaménagement urbain. Plus de 18 000 habitants.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Secteur Fort Potentiel</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Tram A, pont Simone Veil et proximité immédiate Arena berges font Floirac secteur fort potentiel. Écoles, équipements sportifs, commerces proximité.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    ClimGO accompagne Floirac tous besoins chauffage, climatisation production eau chaude. Expertise locale, chaque solution adaptée caractéristiques logements floiracais.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Floirac, un équilibre entre ville et nature
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Située sur la <strong className="text-gray-900 dark:text-white">rive droite de la Garonne</strong>, Floirac connaît une forte dynamique résidentielle grâce à son lien direct avec Bordeaux.
                      </p>
                      <p>
                        Les <strong className="text-gray-900 dark:text-white">écoles, les équipements sportifs et les commerces</strong> de proximité complètent un cadre de vie urbain, mais aéré.
                      </p>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions à Floirac
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue Jules Guesde :</strong> remplacement système électrique vieillissant par climatisation air/air multisplit performante.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Quartier La Burthe :</strong> installation pompe à chaleur air/eau dans maison traditionnelle en pierre.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Chemin de Carriet :</strong> pose chauffe-eau thermodynamique en remplacement ancien cumulus hors d'usage.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un savoir-faire local adapté à Floirac
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Le <strong className="text-gray-900 dark:text-white">relief de Floirac, avec ses zones hautes et basses</strong>, et la diversité des habitats nécessitent une adaptation précise des puissances et technologies utilisées.
                      </p>
                      <p>
                        Nos équipes maîtrisent aussi les <strong className="text-gray-900 dark:text-white">contraintes d'intégration en milieu urbain dense</strong>, avec des solutions discrètes, performantes et conformes.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Votre projet thermique à Floirac mérite notre expertise
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Que vous soyez en train de <strong className="text-gray-900 dark:text-white">rénover une maison de ville ou d'emménager dans une résidence neuve</strong>, ClimGO vous accompagne avec des conseils sur-mesure à Floirac.
                      </p>
                      <p>
                        Un <strong className="text-gray-900 dark:text-white">simple appel ou un formulaire suffit</strong> pour obtenir un devis gratuit.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Floirac ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Floirac - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix de la <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">proximité, du conseil et d'un savoir-faire reconnu</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements <strong className="text-[#059669] dark:text-[#10B981]">s'intègrent dans tous les types de logements floiracais</strong>, avec discrétion et performance.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    ClimGO vous accompagne de A à Z, avec un <strong className="text-[#2563EB] dark:text-[#60A5FA]">service rapide, soigné, et des démarches simplifiées</strong> pour vos aides.
                  </p>
                </div>
              </div>

              {/* Quartiers Floiracais */}
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    ClimGO intervient dans tous les quartiers : <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Dravemont, Domaine de la Burthe, Carriet ou La Souys</strong>. Solutions adaptées à chaque cas.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Floirac
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Types de logements desservis à Floirac</h3>
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Floirac</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Floirac,France&zoom=13&center=44.8372,-0.5264`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Floirac, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Floirac et ses quartiers"
