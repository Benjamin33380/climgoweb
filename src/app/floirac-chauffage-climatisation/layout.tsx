...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'chauffage floirac', 'climatisation floirac', 'pompe à chaleur floirac',
    'chauffagiste floirac 33270', 'plombier chauffagiste floirac',
    
    // Services spécifiques
    'installation pompe à chaleur floirac', 'dépannage chauffage floirac',
    'entretien climatisation floirac', 'réparation PAC floirac',
    
    // Urgences
    'chauffagiste urgence floirac', 'dépannage 24h floirac',
    
    // Certifications
    'artisan RGE floirac', 'qualipac floirac'
  ].join(', '),
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LocalBusiness",
              "name": "ClimGO Floirac",
              "description": "Expert chauffage et climatisation à Floirac. Installation, dépannage et entretien de systèmes de chauffage et pompes à chaleur.",
              "url": "https://climgo.fr/floirac-chauffage-climatisation",
              ...
              "makesOffer": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Installation de pompes à chaleur air/eau et air/air à Floirac"
                  },
                  "price": "8000",
                  "priceCurrency": "EUR"
                },
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Service de dépannage chauffage 24h/7j à Floirac"
                  },
                  "price": "120",
                  "priceCurrency": "EUR"
                }
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Quel est le prix d'une pompe à chaleur à Floirac ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Le prix d'une pompe à chaleur à Floirac varie entre 8 000€ et 15 000€. ClimGO vous propose un devis gratuit et vous accompagne pour les aides financières."
                  }
                },
                {
                  "@type": "Question",
                  "name": "ClimGO intervient-il en urgence à Floirac ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO propose un service d'urgence 24h/7j à Floirac. Contactez-nous au 07 66 46 00 08 pour une intervention rapide."
                  }
                }
              ]
            })
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 3,
                  "name": "Floirac",
                  "item": "https://climgo.fr/floirac-chauffage-climatisation"
                }
              ]
            })
          }}
