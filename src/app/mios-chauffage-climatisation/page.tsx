      ...
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Val de l'Eyre, Habitant de Mios
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Située au cœur du <strong className="text-gray-900 dark:text-white">Val de l'Eyre</strong>, la commune de Mios se distingue par son environnement naturel remarquable, entre forêts de pins, rivières et sentiers boisés.
                </p>
                ...
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous résidiez à <strong className="text-gray-900 dark:text-white">Lacanau-de-Mios</strong>, au Bourg, <strong className="text-gray-900 dark:text-white">Lillet</strong> ou dans les hameaux périphériques, ClimGO vous propose des solutions adaptées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Mios</strong> séduit par son cadre de vie calme, verdoyant et bien connecté. Avec plus de <strong className="text-gray-900 dark:text-white">9 000 habitants</strong>, la commune connaît un développement résidentiel important.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Les familles apprécient la proximité de la <strong className="text-gray-900 dark:text-white">gare SNCF</strong>, les écoles (Jean Zay, groupe scolaire de Lacanau-de-Mios), les équipements sportifs et la vie associative locale.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient sur tout le territoire miot : du <strong className="text-gray-900 dark:text-white">centre-bourg</strong> aux lotissements du Val de l'Eyre, en passant par Lacanau-de-Mios ou la route de Salles.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  À Mios, la présence de <strong className="text-gray-900 dark:text-white">zones humides et boisées</strong> nécessite une attention particulière sur l'installation extérieure des PAC. Nos installations sont pensées pour l'environnement forestier.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Mios
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Notre expertise couvre l'ensemble des quartiers de Mios, des lotissements récents aux secteurs traditionnels. Nous adaptons nos solutions à chaque type d'habitat forestier.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Environnement Forestier</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Interventions adaptées au cadre naturel remarquable de Mios : forêts de pins, rivières et sentiers boisés. Solutions respectueuses de l'environnement.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Habitat Varié</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Maisons bois, contemporaines ou traditionnelles. Du centre-bourg aux lotissements du Val de l'Eyre, Lacanau-de-Mios ou route de Salles.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Zones Humides</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Installations sur dalles ventilées ou plots stabilisés pour éviter l'humidité au sol. Attention particulière aux zones humides et boisées.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Situés à proximité, nous intervenons rapidement, limitant les délais d'attente pour une prise en charge efficace à Mios et ses environs.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        <strong className="text-gray-900 dark:text-white">Mios</strong> séduit par son cadre de vie calme, verdoyant et bien connecté. Avec plus de <strong className="text-gray-900 dark:text-white">9 000 habitants</strong>, développement résidentiel important.
                      </p>
                      <p>
                        Les familles apprécient la proximité de la <strong className="text-gray-900 dark:text-white">gare SNCF</strong>, les écoles, équipements sportifs et vie associative locale très active.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        ...
                        <p><strong>Rue de l'Église :</strong> PAC air/air maison plain-pied avec combles aménagés.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Quartier Lacanau-de-Mios :</strong> chauffe-eau thermodynamique résidence familiale récente.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Lotissement Les Genêts :</strong> entretien climatisations monosplit maisons individuelles.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        À Mios, la présence de <strong className="text-gray-900 dark:text-white">zones humides et boisées</strong> nécessite une attention particulière sur l'installation extérieure des PAC.
                      </p>
                      <p>
                        ClimGO installe systématiquement sur <strong className="text-gray-900 dark:text-white">dalles ventilées ou plots stabilisés</strong> pour éviter l'humidité au sol et maximiser le confort.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous habitez <strong className="text-gray-900 dark:text-white">Mios</strong> ou ses environs ? Nos équipes se déplacent rapidement pour étudier votre projet.
                      </p>
                      <p>
                        Profitez de nos <strong className="text-gray-900 dark:text-white">conseils personnalisés</strong> et d'un devis clair, sans engagement.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Mios ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                En faisant appel à ClimGO, vous bénéficiez d'un accompagnement de proximité, pensé pour les spécificités de Mios et ses alentours.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">Environnement forestier</strong> remarquable : forêts de pins, rivières et sentiers boisés. <strong className="text-[#059669] dark:text-[#10B981]">Solutions respectueuses</strong> de la nature.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#2563EB] dark:text-[#60A5FA]">Techniciens certifiés</strong> RGE et QualiPAC, garantissant qualité et durabilité. <strong className="text-[#2563EB] dark:text-[#60A5FA]">Matériel rigoureusement</strong> sélectionné pour sa fiabilité.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">Installations sur dalles</strong> ventilées ou plots stabilisés. Attention particulière aux <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">zones humides et boisées</strong> de Mios.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Situés à proximité</strong>, nous intervenons rapidement, limitant les délais d'attente pour une <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">prise en charge efficace</strong> à Mios.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Mios
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Mios</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Mios,France&zoom=12&center=44.6539,-0.8825`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Mios, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Mios et ses quartiers"
