...
export default function LeHaillan() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Le Haillan - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Le Haillan, commune dynamique à l'ouest de Bordeaux
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Le Haillan, située à l'ouest de Bordeaux</strong>, est une commune dynamique qui allie harmonieusement zones résidentielles et activité économique.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Son <strong className="text-gray-900 dark:text-white">cadre de vie agréable nécessite des solutions de chauffage et climatisation</strong> adaptées à ses différents quartiers.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Situé à l'ouest de Bordeaux, Le Haillan bénéficie d'un <strong className="text-gray-900 dark:text-white">cadre de vie recherché, mêlant zones pavillonnaires, commerces de proximité et espaces verts</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  La ville attire de nombreux actifs grâce à sa <strong className="text-gray-900 dark:text-white">proximité avec Mérignac, l'aéroport et la rocade</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec ses <strong className="text-gray-900 dark:text-white">écoles, ses installations sportives modernes et ses zones résidentielles en plein essor</strong> (quartier La Luzerne, route de Saint-Médard).
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous soyez situé près du centre-ville ou dans les zones pavillonnaires, <strong className="text-gray-900 dark:text-white">ClimGO conçoit et installe des équipements thermiques adaptés</strong> à votre habitat.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Forts de notre expérience locale et de nos certifications, nous garantissons des installations <strong className="text-gray-900 dark:text-white">durables, économiques et parfaitement adaptées</strong> aux besoins spécifiques des logements du Haillan.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Située à l'ouest de Bordeaux, est une commune dynamique qui allie harmonieusement zones résidentielles et activité économique.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Cadre de Vie Recherché</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Bénéficie d'un cadre de vie recherché, mêlant zones pavillonnaires, commerces de proximité et espaces verts. La ville attire de nombreux actifs grâce à sa proximité avec Mérignac, l'aéroport et la rocade.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Équipements Modernes</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Avec ses écoles, ses installations sportives modernes et ses zones résidentielles en plein essor (quartier La Luzerne, route de Saint-Médard), offre un environnement idéal pour les familles.
                  </p>
                </div>
              </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune dynamique et bien desservie
                    </h3>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples d'interventions au Haillan
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue Pasteur :</strong> installation pompe à chaleur air/eau pour maison familiale 120 m² avec plancher chauffant.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue Jean Mermoz :</strong> remplacement ancien chauffe-eau par modèle thermodynamique dernière génération.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Chemin de la Morandière :</strong> installation climatisation gainable dans maison de plain-pied orientée plein sud.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un savoir-faire adapté au climat et aux logements du Haillan
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Le Haillan est soumis à des <strong className="text-gray-900 dark:text-white">étés de plus en plus chauds et à des intersaisons humides</strong>. Nos équipements sont pensés pour garantir un confort thermique optimal.
                      </p>
                      <p>
                        Nous analysons l'isolation de chaque logement pour proposer une <strong className="text-gray-900 dark:text-white">solution sur-mesure, en tenant compte des combles, des orientations et des volumes</strong> à chauffer ou climatiser.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Votre projet énergétique au Haillan mérite un expert
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Pour toute demande d'<strong className="text-gray-900 dark:text-white">installation, d'entretien ou de remplacement d'équipement thermique</strong> au Haillan, ClimGO se tient à votre disposition.
                      </p>
                      <p>
                        Demandez votre <strong className="text-gray-900 dark:text-white">étude personnalisée, gratuite et sans engagement</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO au Haillan ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO au Haillan - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Choisir une <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">entreprise engagée, qui comprend les particularités climatiques et architecturales</strong> de la commune.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Pompes à chaleur, climatiseurs et chauffe-eaux sélectionnés pour garantir <strong className="text-gray-900 dark:text-gray-300">efficacité, discrétion et durabilité</strong>, résidences familiales ou logements collectifs.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Résidences familiales, logements collectifs, et zones pavillonnaires</strong> : nous maîtrisons les contraintes thermiques de tous les types d'habitat au Haillan.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique au Haillan
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières au Haillan</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="le-haillan" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Le Haillan,France&zoom=13&center=44.8703,-0.6747`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention au Haillan, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO au Haillan et ses quartiers"
