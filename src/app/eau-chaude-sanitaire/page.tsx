      ...
      <div className="bg-gray-50 dark:bg-background pt-24 pb-4 px-6">
        <nav className="max-w-7xl mx-auto text-sm text-[black] dark:text-white">
          <ol className="list-reset flex items-center space-x-2">
            ...
            <li className="text-[black] dark:text-white font-medium">Eau chaude sanitaire</li>
          </ol>
        </nav>
      </div>
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
          ...
          <SimpleWrapper>
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-extralight tracking-wide mb-8">
              <span className="bg-gradient-to-r from-[#FF6B6B] via-[black] to-[#FF6B6B] dark:from-[#FF6B6B] dark:via-white dark:to-[#FF6B6B] bg-clip-text text-transparent">
                Eau Chaude Sanitaire
              </span>
              <br />
              <span className="bg-gradient-to-r from-[black] via-[#FF6B6B] to-[black] dark:from-white dark:via-[#FF6B6B] dark:to-white bg-clip-text text-transparent">
                ClimGO
              </span>
            </h1>
          </SimpleWrapper>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[black] to-[#FF6B6B] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </button>
            
            <button className="group px-10 py-4 border border-[black] dark:border-white rounded-full font-medium transition-all duration-300 hover:border-[#FF6B6B] hover:bg-[black]/5 text-[black] dark:text-white">
              Demander un devis
            </button>
          </div>
        </div>
                ...
                {index === 0 || index === 1 || index === 2 ? (
                  ...
                  >
                    ...
                    <div className="relative z-10 p-12 lg:p-16 max-w-xl">
                      <div className="mb-8">
                        <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-[black]/20 to-[#FF4757]/20 border border-[#FF4757] text-[#FF4757] text-sm font-medium mb-6 backdrop-blur-sm shadow-lg">
                          {solution.badge}
                        </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-start gap-4 sm:gap-0">
                        <Link
                          href="/contact"
                          className="group px-8 py-3 bg-gradient-to-r from-[black] to-[#FF6B6B] rounded-full text-white font-medium transition-all duration-300 hover:scale-105 text-center"
                        >
                          Devis gratuit
                        </Link>
                      </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {advantages.map((advantage, index) => (
              <div
                key={index}
                className="group text-center p-8 rounded-2xl bg-gray-50 dark:bg-background border border-[black] dark:border-white/20 hover:border-white/50 dark:hover:border-black/50 transition-all duration-300 min-h-[320px] flex flex-col items-center justify-center"
              >
                <div className="text-5xl mb-6 transform group-hover:scale-110 transition-transform duration-300">
                  {advantage.icon}
                </div>
                <h3 className="text-xl font-medium mb-4 text-[black] dark:text-white group-hover:text-[#FF6B6B] transition-colors">
                  {advantage.title}
                </h3>
                <p className="text-[black] dark:text-white/80 group-hover:text-[#FF6B6B] transition-colors text-center">
                  {advantage.desc}
                </p>
              </div>
            ))}
      ...
      <section className="py-12 md:py-24 relative">
        <div className="max-w-4xl mx-auto text-center px-4 md:px-6">
          <div className="bg-gray-50 dark:bg-background rounded-2xl md:rounded-3xl p-8 md:p-16 border border-[black] dark:border-white/20 backdrop-blur-sm shadow-xl">
            ...
            <Link
              href="/contact"
              className="inline-block px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-[black] to-[#FF6B6B] rounded-full text-white font-medium transition-all duration-300 hover:scale-105 text-sm md:text-base"
            >
