...
export default function SaintSelve() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Saint-Selve - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Saint-Selve, entre nature et sérénité résidentielle
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Nichée dans un écrin de verdure</strong>, Saint-Selve séduit par son cadre paisible et résidentiel.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située au cœur de <strong className="text-gray-900 dark:text-white">l'Entre-Deux-Mers, avec près de 3 500 habitants</strong>, elle attire les familles en quête de tranquillité.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nos solutions de chauffage et climatisation <strong className="text-gray-900 dark:text-white">s'intègrent avec discrétion dans tous les quartiers</strong>, du centre aux lotissements récents.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Chez ClimGO, chaque projet est conçu pour <strong className="text-gray-900 dark:text-white">répondre aux besoins thermiques spécifiques</strong> des habitations de Saint-Selve.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">À seulement 25 minutes de Bordeaux</strong>, les habitants bénéficient d'un tissu associatif dynamique et d'infrastructures complètes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient dans <strong className="text-gray-900 dark:text-white">tous les quartiers avec des solutions sur mesure</strong> adaptées au climat tempéré local.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Saint-Selve
              </h2>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Cadre Paisible</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Nichée dans un écrin de verdure, Saint-Selve séduit par son cadre paisible et résidentiel. Située au cœur de l'Entre-Deux-Mers, avec près de 3 500 habitants.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Nos solutions de chauffage et climatisation s'intègrent avec discrétion dans tous les quartiers, du centre aux lotissements récents. Familles en quête de tranquillité.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    À seulement 25 minutes de Bordeaux, les habitants bénéficient d'un tissu associatif dynamique et d'infrastructures complètes. Chez ClimGO, chaque projet est conçu spécifiquement.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    ClimGO intervient dans tous les quartiers avec des solutions sur mesure adaptées au climat tempéré local. Besoins thermiques spécifiques des habitations de Saint-Selve.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune en développement maîtrisé
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Située au cœur de <strong className="text-gray-900 dark:text-white">l'Entre-Deux-Mers, Saint-Selve connaît une croissance résidentielle douce</strong> tout en conservant son cadre de vie rural.
                      </p>
                      <p>
                        Avec <strong className="text-gray-900 dark:text-white">près de 3 500 habitants</strong>, elle attire les familles en quête de tranquillité, à seulement 25 minutes de Bordeaux.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions à Saint-Selve
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Savoir-faire adapté aux maisons de Saint-Selve
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Entre les <strong className="text-gray-900 dark:text-white">bâtis anciens en pierre et les maisons récentes BBC</strong>, nos installations sont toujours dimensionnées sur mesure.
                      </p>
                      <p>
                        Nous privilégions les <strong className="text-gray-900 dark:text-white">systèmes silencieux, peu énergivores et discrets</strong>, pour un confort durable.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Votre projet à Saint-Selve
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        <strong className="text-gray-900 dark:text-white">Vous habitez Saint-Selve ou vous y faites construire</strong> ? Notre équipe est disponible pour vous proposer un accompagnement sur mesure.
                      </p>
                      <p>
                        Contactez-nous pour un <strong className="text-gray-900 dark:text-white">premier échange gratuit en chauffage, climatisation ou eau chaude</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Saint-Selve ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Saint-Selve - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire appel à ClimGO à Saint-Selve, c'est choisir une <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">équipe locale réactive et spécialisée</strong> dans le confort thermique résidentiel.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos pompes à chaleur, climatiseurs et chauffe-eaux sont <strong className="text-gray-900 dark:text-gray-300">installés selon les exigences techniques locales</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Basés à proximité de Saint-Selve, nous <strong className="text-gray-900 dark:text-gray-300">garantissons un service rapide et suivi</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous privilégions les <strong className="text-gray-900 dark:text-gray-300">systèmes silencieux, peu énergivores et discrets</strong>, pour un confort durable.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Saint-Selve
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Saint-Selve</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="saint-selve" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Saint-Selve,France&zoom=13&center=44.6958,-0.4461`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Saint-Selve, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Saint-Selve et ses quartiers"
