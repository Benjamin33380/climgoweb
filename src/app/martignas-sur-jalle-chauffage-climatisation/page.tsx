...
export default function MartignassuJalle() {
  ...
  return (
    <main className="px-0">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Entre tradition girondine et modernité résidentielle</strong>, Martignas-sur-Jalle offre un cadre de vie prisé.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située entre Bordeaux, Mérignac et Saint-Jean-d'Illac, Martignas-sur-Jalle connaît un <strong className="text-gray-900 dark:text-white">véritable essor résidentiel</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec près de 7 500 habitants, cette commune paisible offre un <strong className="text-gray-900 dark:text-white">équilibre idéal entre dynamisme local, environnement naturel et proximité des grands axes</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Les familles y trouvent des <strong className="text-gray-900 dark:text-white">infrastructures modernes, des établissements scolaires appréciés et un tissu pavillonnaire varié</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  De Beauséjour au centre-ville, <strong className="text-gray-900 dark:text-white">ClimGO vous accompagne avec des solutions fiables et durables</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nous intervenons sur tous types d'habitations martignassaises avec des <strong className="text-gray-900 dark:text-white">installations sur mesure, performantes et esthétiques</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Martignas-sur-Jalle
              </h2>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Tradition Modernité</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Essor Résidentiel</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Située entre Bordeaux Mérignac Saint-Jean-d'Illac, connaît véritable essor résidentiel. Près 7 500 habitants commune paisible offre équilibre idéal entre dynamisme local environnement naturel proximité grands axes.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Infrastructures Modernes</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Familles trouvent infrastructures modernes établissements scolaires appréciés tissu pavillonnaire varié. Beauséjour centre-ville quartier Jalle chemin Blayais avenue 18 Juin près collège Aliénor d'Aquitaine.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Solutions Fiables</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    ClimGO accompagne solutions fiables durables. Intervenons tous types habitations martignassaises installations sur mesure performantes esthétiques.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un cadre de vie recherché entre ville et nature
                    </h3>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Interventions techniques à Martignas
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue de Capeyron :</strong> installation système gainable pour maison familiale à étage avec combles isolés.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Quartier des Palombes :</strong> remplacement ancien chauffage électrique par PAC air/eau avec plancher chauffant.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Chemin de la Jalle :</strong> pose chauffe-eau thermodynamique avec gestion connectée pour optimiser consommation.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une expertise adaptée aux contraintes locales
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Le <strong className="text-gray-900 dark:text-white">sol argilo-sableux et les haies denses typiques des quartiers résidentiels</strong> de Martignas nécessitent des précautions spécifiques pour les unités extérieures.
                      </p>
                      <p>
                        Grâce à une étude d'ensoleillement précise, nous ajustons la puissance des équipements selon l'<strong className="text-gray-900 dark:text-white">exposition réelle du logement, souvent orientée est/ouest</strong> dans la région.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Votre projet énergétique à Martignas-sur-Jalle
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous habitez Martignas ou vous venez d'y acquérir un bien ? Faites confiance à ClimGO pour <strong className="text-gray-900 dark:text-white">moderniser votre confort thermique</strong>.
                      </p>
                      <p>
                        Nos experts se déplacent gratuitement pour évaluer vos besoins et vous proposer un <strong className="text-gray-900 dark:text-white">devis clair et personnalisé</strong>.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Martignas-sur-Jalle ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Martignas-sur-Jalle - Version personnalisée */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-6xl mx-auto mb-12 sm:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous connaissons les <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">besoins spécifiques des foyers de Martignas-sur-Jalle</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous proposons des <strong className="text-[#059669] dark:text-[#10B981]">solutions discrètes, efficaces et adaptées à chaque type de logement</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre équipe vous accompagne aussi dans vos <strong className="text-[#2563EB] dark:text-[#60A5FA]">démarches administratives, avec rigueur et proximité</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Maisons individuelles, pavillons neufs ou logements rénovés</strong> : chaque installation est pensée pour les réalités de Martignas-sur-Jalle.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Martignas-sur-Jalle
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Martignas-sur-Jalle</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat 
        ...
        subtitle="Nos réponses à vos préoccupations les plus courantes sur le chauffage et la climatisation à Martignas-sur-Jalle"
        faqs={[
          {
          ...
          },
          {
            ...
            answer: "Oui, nos équipes se déplacent dans tous les quartiers de Martignas, y compris Beauséjour et les zones pavillonnaires. ClimGO intervient dans tous les secteurs : quartier de la Jalle, chemin du Blayais, avenue du 18 Juin, ou près du collège Aliénor d'Aquitaine."
          },
          {
            question: "Comment adaptez-vous vos installations au sol local de Martignas ?",
            answer: "Le sol argilo-sableux et les haies denses typiques des quartiers résidentiels de Martignas nécessitent des précautions spécifiques pour les unités extérieures. Nos équipes anticipent les risques d'humidité et de vibration pour chaque installation."
          }
        ]}
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Martignas-sur-Jalle,France&zoom=13&center=44.8442,-0.7839`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Martignas-sur-Jalle, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Martignas-sur-Jalle et ses quartiers"
