            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Capitale du vin et joyau du patrimoine architectural, <strong className="text-gray-900 dark:text-white">Bordeaux</strong> allie charme historique et modernité. Ses bâtiments en pierre blonde et ses appartements haussmanniens exigent des installations précises et sur mesure.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous soyez dans le quartier des <strong className="text-gray-900 dark:text-white">Chartrons</strong>, <strong className="text-gray-900 dark:text-white">Saint-Michel</strong> ou <strong className="text-gray-900 dark:text-white">Caudéran</strong>, ClimGO adapte chaque installation aux spécificités thermiques de votre habitat.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Grâce à notre ancrage local et nos certifications, nous garantissons des systèmes <strong className="text-gray-900 dark:text-white">performants, sobres et discrets</strong>, parfaitement intégrés au tissu urbain bordelais.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  <strong className="text-gray-900 dark:text-white">Bordeaux</strong>, joyau d'Aquitaine, séduit autant par son patrimoine que par sa dynamique urbaine. Avec plus de 250 000 habitants, la ville conjugue art de vivre, innovation et exigence thermique.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Entre les ruelles pavées de <strong className="text-gray-900 dark:text-white">Saint-Pierre</strong>, les boulevards animés de <strong className="text-gray-900 dark:text-white">Gambetta</strong> ou les zones résidentielles calmes de <strong className="text-gray-900 dark:text-white">Caudéran</strong>, chaque logement nécessite une approche technique adaptée.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO s'adapte à la diversité du bâti bordelais : <strong className="text-gray-900 dark:text-white">maisons en pierre de taille</strong>, <strong className="text-gray-900 dark:text-white">échoppes du XIXe</strong>, appartements récents ou rénovés, nous maîtrisons les subtilités thermiques du territoire urbain.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Bordeaux impose souvent des contraintes spécifiques : ventilation dans les échoppes, insonorisation dans les immeubles collectifs, respect de la <strong className="text-gray-900 dark:text-white">pierre bordelaise</strong> pour les fixations extérieures.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Chaque PAC est posée avec attention aux <strong className="text-gray-900 dark:text-white">normes de copropriété</strong>, aux gaines existantes et aux possibilités de raccordement électrique, souvent complexes dans l'hyper-centre historique.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Toute la métropole bordelaise</h3>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Service Urbain Adapté</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Excellence & Rigueur</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="hidden md:block absolute right-0 top-0 bottom-0 w-90 bg-gradient-to-l from-white via-white/80 to-transparent dark:from-black dark:via-black/80 z-10 pointer-events-none" />
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous êtes propriétaire à <strong className="text-gray-900 dark:text-white">Bordeaux</strong> ou vous venez d'acquérir un bien à rénover ? ClimGO vous accompagne dans vos démarches d'amélioration énergétique.
                      </p>
                      <p>
                        Demandez une <strong className="text-gray-900 dark:text-white">étude gratuite</strong> pour une solution thermique à la hauteur de votre cadre de vie.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#2563EB] dark:text-[#60A5FA]">Connaissance approfondie</strong> du tissu urbain bordelais et de ses contraintes architecturales. <strong className="text-[#2563EB] dark:text-[#60A5FA]">Maîtrise parfaite</strong> des spécificités locales.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#f97316]/50 dark:hover:border-[#fb923c] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#f97316] dark:text-[#fb923c]">Équipements sélectionnés</strong> pour garantir efficacité et discrétion. <strong className="text-[#f97316] dark:text-[#fb923c]">Durabilité</strong> même dans les immeubles anciens et échoppes rénovées.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Service rapide</strong> dans toute la métropole bordelaise, <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">finitions propres</strong> et logistique adaptée aux zones d'accès restreint.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">Accompagnement administratif</strong> complet et <strong className="text-[#059669] dark:text-[#10B981]">suivi rigoureux</strong> pour tous vos projets d'amélioration énergétique.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Bordeaux</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
