            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Entre pins et eau douce, <strong className="text-gray-900 dark:text-white">La Teste-de-Buch</strong> se distingue par son équilibre entre nature et commodités. Que vous résidiez vers le port ostréicole, dans les quartiers comme <strong className="text-gray-900 dark:text-white">Cazaux</strong>, ou au cœur du centre-ville, ClimGO s'adapte à chaque profil d'habitat.
                </p>
                ...
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située entre le <strong className="text-gray-900 dark:text-white">Bassin d'Arcachon</strong>, les plages océanes et la forêt landaise, La Teste-de-Buch offre un équilibre rare entre nature, animation et qualité de vie. Avec plus de 27 000 habitants, la commune est l'une des plus vastes de France.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Les quartiers comme <strong className="text-gray-900 dark:text-white">Pyla-sur-Mer</strong>, le <strong className="text-gray-900 dark:text-white">Port</strong>, <strong className="text-gray-900 dark:text-white">La Hume</strong> ou le centre-ville attirent familles, retraités et vacanciers. La ville bénéficie d'un fort dynamisme immobilier, d'écoles, d'un lycée et d'un tissu associatif développé.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Entre humidité saline, vents côtiers et variations de température, les installations à La Teste demandent une vraie expertise. Chez ClimGO, nous utilisons des <strong className="text-gray-900 dark:text-white">matériaux anticorrosion</strong> et des supports renforcés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nous adaptons aussi les puissances et les modes de fonctionnement pour des logements utilisés en continu ou de façon saisonnière, garantissant durabilité et sécurité.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à La Teste-de-Buch
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Du port ostréicole à Cazaux, nous couvrons tous les secteurs de La Teste-de-Buch. Nos solutions s'adaptent aux constructions neuves comme aux maisons anciennes, avec un souci constant d'efficacité et de durabilité.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Toute La Teste-de-Buch</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Interventions dans tous les quartiers : Pyla-sur-Mer, La Hume, le Port, Cazaux et le centre-ville. Service réactif et personnalisé quelle que soit votre localisation.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Expertise Littorale</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Matériaux anticorrosion et supports renforcés pour résister à l'humidité saline et aux vents côtiers. Adaptations pour logements permanents ou saisonniers.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Maisons individuelles neuves, bâtisses traditionnelles rénovées : nous adaptons nos solutions aux contraintes architecturales et énergétiques de chaque logement.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Qualité & Proximité</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Expertise locale, matériaux performants, normes rigoureuses et finitions impeccables. Chaque projet traité avec la plus grande exigence.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un cadre de vie entre océan et forêt
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Située entre le <strong className="text-gray-900 dark:text-white">Bassin d'Arcachon</strong>, les plages océanes et la forêt landaise, La Teste-de-Buch offre un équilibre rare entre nature, animation et qualité de vie.
                      </p>
                      <p>
                        Avec plus de <strong className="text-gray-900 dark:text-white">27 000 habitants</strong>, la commune est l'une des plus vastes de France. Les quartiers comme Pyla-sur-Mer, le Port, La Hume attirent familles et retraités.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Chantiers récents à La Teste-de-Buch
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un savoir-faire pensé pour le littoral
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Entre <strong className="text-gray-900 dark:text-white">humidité saline</strong>, vents côtiers et variations de température, les installations à La Teste demandent une vraie expertise.
                      </p>
                      <p>
                        Chez ClimGO, nous utilisons des <strong className="text-gray-900 dark:text-white">matériaux anticorrosion</strong> et des supports renforcés pour garantir durabilité et sécurité, adaptés aux logements utilisés en continu ou de façon saisonnière.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Discutons de votre projet à La Teste
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous vivez à l'année à <strong className="text-gray-900 dark:text-white">La Teste-de-Buch</strong> ou vous souhaitez équiper votre résidence secondaire ?
                      </p>
                      <p>
                        ClimGO vous accompagne avec des <strong className="text-gray-900 dark:text-white">solutions sur mesure</strong>, adaptées à votre mode de vie et à votre budget.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à La Teste-de-Buch ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à La Teste-de-Buch - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#2563EB] dark:text-[#60A5FA]">Connaissance approfondie</strong> du climat littoral et des contraintes côtières. <strong className="text-[#2563EB] dark:text-[#60A5FA]">Matériaux spécialisés</strong> pour résister à l'humidité saline.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#f97316]/50 dark:hover:border-[#fb923c] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#f97316] dark:text-[#fb923c]">Maisons neuves</strong> comme <strong className="text-[#f97316] dark:text-[#fb923c]">bâtisses traditionnelles</strong> rénovées. Adaptation aux contraintes architecturales et énergétiques de chaque logement.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Étude personnalisée</strong> puis devis gratuit et détaillé. <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Installation soignée</strong> en respectant délais et normes en vigueur.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">Contrats d'entretien</strong> personnalisés avec visites régulières pour vérification, nettoyage et optimisation des performances.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à La Teste-de-Buch
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à La Teste-de-Buch</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=La+Teste-de-Buch,France&zoom=12&center=44.6333,-1.1333`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à La Teste-de-Buch, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à La Teste-de-Buch et ses quartiers"
