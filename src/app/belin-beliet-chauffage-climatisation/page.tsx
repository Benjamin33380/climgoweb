...
export default function BelinBeliet() {
  ...
  return (
    <main className="px-0">
        ...
        <div className="relative z-10 flex h-full items-center">
          ...
          >
            ...
            <p className="text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl text-white/90 sm:text-black/90 dark:text-white/90 mb-3 sm:mb-4 md:mb-6 lg:mb-8 leading-relaxed max-w-[280px] sm:max-w-sm md:max-w-lg lg:max-w-none whitespace-pre-line">
              Val de l'Eyre, village{'\n'}nature entre forêts et rivières
            </p>
      ...
      {/* Section Belin-Béliet - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Val de l'Eyre, Habitant de Belin-Béliet
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Située au cœur du <strong className="text-gray-900 dark:text-white">Val de l'Eyre</strong>, la commune de Belin-Béliet se distingue par son environnement naturel remarquable, entre forêts de pins, rivières et sentiers boisés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nous intervenons dans tous ses quartiers, notamment les lieux-dits <strong className="text-gray-900 dark:text-white">Guiton, le Puch, Pernaud ou encore le Télègraphe</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située entre <strong className="text-gray-900 dark:text-white">forêts et rivières</strong>, Belin-Béliet séduit par son cadre verdoyant, son calme et ses traditions gasconnes.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec près de <strong className="text-gray-900 dark:text-white">5 000 habitants</strong>, la commune accueille de plus en plus de familles venues chercher la tranquillité tout en restant proches de Bordeaux et d'Arcachon.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  La commune est marquée par son tissu résidentiel mêlant <strong className="text-gray-900 dark:text-white">quartiers anciens (Le Bourg, Guiton, Le Puch) et lotissements récents</strong> comme Les Pins ou Le Télegraphe.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nos solutions s'adaptent aussi bien aux <strong className="text-gray-900 dark:text-white">longères traditionnelles qu'aux pavillons RT2012</strong> en tenant compte des contraintes d'isolation et de l'exposition au soleil.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Grâce à notre <strong className="text-gray-900 dark:text-white">proximité géographique et notre connaissance du tissu local</strong>, nous vous accompagnons dans chaque étape de votre projet.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Belin-Béliet
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Notre expertise couvre l'ensemble des quartiers de Belin-Béliet, des lotissements récents aux secteurs traditionnels. Nous garantissons un confort optimal grâce à des équipements performants et durables.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Village Nature Val de l'Eyre</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Environnement naturel remarquable entre forêts de pins, rivières et sentiers boisés. Lieux-dits Guiton, le Puch, Pernaud ou encore le Télègraphe.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Commune Tranquille</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Cadre verdoyant, calme et traditions gasconnes. Près de 5 000 habitants accueille familles venues chercher tranquillité tout en restant proches de Bordeaux et Arcachon.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Tissu Résidentiel Mixte</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Quartiers anciens (Le Bourg, Guiton, Le Puch) et lotissements récents comme Les Pins ou Le Télegraphe. Patrimoine préservé entre vieilles bâtisses en pierre et maisons à colombages.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Solutions Adaptées</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Solutions s'adaptent aussi bien aux longères traditionnelles qu'aux pavillons RT2012 tenant compte contraintes d'isolation et exposition au soleil. Proximité géographique et connaissance du tissu local.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un village nature au cœur du Val de l'Eyre
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        Le <strong className="text-gray-900 dark:text-white">patrimoine y est préservé</strong>, entre vieilles bâtisses en pierre et maisons à colombages.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Interventions techniques locales à Belin
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Le Puch :</strong> PAC air/eau haute température sur plancher chauffant pour maison ancienne rénovée.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Quartier du Bourg :</strong> multisplit mural Daikin dans maison de ville des années 90.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Route de Bayonne :</strong> entretien annuel gainable Mitsubishi dans maison neuve de 2021.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un savoir-faire adapté à Belin-Béliet
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Belin-Béliet impose des <strong className="text-gray-900 dark:text-white">critères techniques précis liés à la forêt environnante</strong> : risques de résine, humidité des sols.
                      </p>
                      <p>
                        Nous prévoyons des <strong className="text-gray-900 dark:text-white">installations sur plots ou rehausses</strong>, avec un dimensionnement sur-mesure selon l'usage.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Échangeons sur votre confort à Belin-Béliet
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous habitez <strong className="text-gray-900 dark:text-white">Belin-Béliet ou ses hameaux</strong> ? Contactez-nous pour un projet thermique sur-mesure.
                      </p>
                      <p>
                        ClimGO se déplace chez vous pour étudier vos besoins et vous proposer une <strong className="text-gray-900 dark:text-white">solution fiable, économe et adaptée</strong> à votre cadre de vie.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Belin-Béliet ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                En faisant appel à ClimGO, vous bénéficiez d'un accompagnement de proximité, pensé pour les spécificités de Belin-Béliet et ses alentours.
              </p>
            </div>
            
            {/* Pourquoi choisir ClimGO à Belin-Béliet - Version personnalisée */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-6xl mx-auto mb-12 sm:mb-16">
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Bénéficiez d'un <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">accompagnement de proximité, pensé pour les spécificités</strong> de Belin-Béliet et ses alentours.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos techniciens sont <strong className="text-[#059669] dark:text-[#10B981]">certifiés RGE et QualiPAC</strong>, garantissant qualité et durabilité des installations.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous utilisons uniquement du <strong className="text-[#2563EB] dark:text-[#60A5FA]">matériel rigoureusement sélectionné</strong> pour sa fiabilité et performance.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Situés à proximité, nous <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">intervenons rapidement, limitant les délais d'attente</strong> pour une prise en charge efficace.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Belin-Béliet
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
                  Nous intervenons aussi bien dans les maisons individuelles neuves que dans les bâtisses traditionnelles rénovées. Notre expérience nous permet d'adapter nos solutions aux contraintes architecturales et énergétiques.
                </p>
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white dark:text-black mb-4 text-center">Aides financières à Belin-Béliet</h3>
                <p className="text-white/90 dark:text-black/90 leading-relaxed text-center text-lg flex-grow">
                  Nous vous accompagnons dans l'obtention des aides telles que MaPrimeRénov', les Certificats d'Économies d'Énergie (CEE), la TVA réduite ou l'Éco-PTZ.
                </p>
      ...
      <FAQChat 
        ...
        subtitle="Nos réponses à vos préoccupations les plus courantes sur le chauffage et la climatisation à Belin-Béliet"
        faqs={[
          {
            question: "Quels services proposez-vous à Belin-Béliet ?",
            answer: "Nous proposons l'installation, l'entretien et la maintenance de systèmes de chauffage, climatisation, chauffe-eau et pompes à chaleur à Belin-Béliet, dans tous les quartiers et lieux-dits."
          },
          {
            question: "Travaillez-vous avec des aides financières ?",
            answer: "Oui, nous vous accompagnons pour bénéficier de MaPrimeRénov', des CEE, de la TVA réduite ou encore de l'Éco-PTZ, afin de rendre vos projets plus accessibles."
          },
          {
            question: "Intervenez-vous dans les zones rurales autour de Belin-Béliet ?",
            answer: "Tout à fait. Nous couvrons Belin-Béliet et ses alentours pour assurer un service de proximité dans tous les lieux-dits comme Guiton, le Puch, Pernaud ou le Télègraphe."
          },
          {
            question: "Comment adaptez-vous vos installations à l'environnement forestier ?",
            answer: "Belin-Béliet impose des critères techniques précis liés à la forêt environnante : risques de résine, humidité des sols, accès parfois difficiles. Nous prévoyons des installations sur plots ou rehausses, avec un dimensionnement sur-mesure selon l'usage."
          }
        ]}
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Belin-Béliet,France&zoom=13&center=44.4944,-0.7847`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Belin-Béliet, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Belin-Béliet et ses quartiers"
