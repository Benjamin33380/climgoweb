          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Des quartiers historiques aux résidences modernes, nous couvrons toute la ville d'Arcachon. Nos solutions respectent l'architecture locale tout en optimisant votre confort thermique.
              </p>
            </div>
              ...
              <div className="hidden md:block absolute right-0 top-0 bottom-0 w-90 bg-gradient-to-l from-white via-white/80 to-transparent dark:from-black dark:via-black/80 z-10 pointer-events-none" />
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        L'air marin, les embruns salés et la proximité de l'océan exigent des équipements spécialement traités. Chez ClimGO, chaque installation bénéficie de protections anticorrosion et de supports adaptés aux conditions côtières.
                      </p>
                      <p>
                        Nous prenons en compte les orientations face à l'océan, les vents dominants et les contraintes de voisinage pour assurer un confort optimal en toute saison.
                      </p>
                    </div>
                  </div>
        ...
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Choisir ClimGO à Arcachon, c'est faire appel à des experts qui connaissent les contraintes spécifiques du climat marin et la richesse architecturale de la ville.
              </p>
            </div>
            
            {/* Pourquoi choisir ClimGO à Arcachon - Version personnalisée */}
              ...
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#2563EB]/50 dark:hover:border-[#60A5FA] min-h-[320px] md:min-h-[380px] lg:min-min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#2563EB] dark:text-[#60A5FA]">Connaissance approfondie</strong> du climat marin et de l'architecture arcachonnaise. <strong className="text-[#2563EB] dark:text-[#60A5FA]">Maîtrise parfaite</strong> des contraintes côtières et patrimoniales.
                  </p>
                </div>
              </div>

              {/* Qualité Premium */}
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#f97316]/50 dark:hover:border-[#fb923c] min-h-[320px] md:min-h-[380px] lg:min-min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#f97316] dark:text-[#fb923c]">Équipements résistants</strong> aux conditions marines et <strong className="text-[#f97316] dark:text-[#fb923c]">normes rigoureuses</strong>. Installation respectant les <strong className="text-[#f97316] dark:text-[#fb923c]">plus hauts standards</strong>.
                  </p>
                </div>
              </div>

              {/* Proximité */}
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#8B5CF6]/50 dark:hover:border-[#A78BFA] min-h-[320px] md:min-h-[380px] lg:min-min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">Intervention rapide</strong> dans tous les quartiers d'Arcachon, <strong className="text-[#8B5CF6] dark:text-[#A78BFA]">dépannages urgents</strong> et <strong className="text-[#8B5CF6] dark:text-[#8B5CF6]">service de proximité</strong> personnalisé.
                  </p>
                </div>
              </div>

              {/* Garantie Complète */}
              <div className="group bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#059669]/50 dark:hover:border-[#10B981] min-h-[320px] md:min-h-[380px] lg:min-min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-[#059669] dark:text-[#10B981]">Garantie étendue</strong> sur tous nos équipements et <strong className="text-[#059669] dark:text-[#10B981]">service après-vente réactif</strong>. <strong className="text-[#059669] dark:text-[#10B981]">Tranquillité d'esprit</strong> assurée.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="relative py-20 overflow-hidden bg-white dark:bg-black z-10">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Arcachon
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              <motion.div 
                className="group relative bg-black dark:bg-white rounded-2xl p-6 md:p-6 md:p-6 md:p-8 shadow-xl hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-500 border-2 border-black dark:border-white min-h-[300px] md:min-h-[380px] lg:min-min-h-[300px] md:min-h-[380px] lg:min-min-h-[300px] md:min-h-[380px] lg:min-h-[400px] flex flex-col"
            ...
            <SimpleWrapper>
              <motion.div 
                className="group relative bg-white dark:bg-black rounded-2xl p-6 md:p-6 md:p-8 shadow-xl hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-500 border-2 border-black dark:border-white min-h-[300px] md:min-h-[380px] lg:min-min-h-[300px] md:min-h-[380px] lg:min-h-[400px] flex flex-col"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                {/* Icône avec effet de brillance */}
            ...
            <SimpleWrapper>
              <motion.div 
                className="group relative bg-black dark:bg-white rounded-2xl p-6 md:p-6 md:p-8 shadow-xl hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-500 border-2 border-black dark:border-white min-h-[300px] md:min-h-[380px] lg:min-min-h-[300px] md:min-h-[380px] lg:min-h-[400px] flex flex-col"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                {/* Icône avec effet de brillance */}
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Arcachon,France&zoom=13&center=44.6617,-1.1663`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Arcachon, Bassin d'Arcachon"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Arcachon et dans le Bassin d'Arcachon"
