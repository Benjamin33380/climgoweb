...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'chauffage arcachon', 'climatisation arcachon', 'pompe à chaleur arcachon',
    'chauffagiste arcachon 33120', 'plombier chauffagiste arcachon',
    
    // Services spécifiques
    'installation pompe à chaleur arcachon', 'dépannage chauffage arcachon',
    'entretien climatisation arcachon', 'réparation PAC arcachon',
    
    // Urgences
    'chauffagiste urgence arcachon', 'dépannage 24h arcachon',
    
    // Certifications
    'artisan RGE arcachon', 'qualipac arcachon'
  ].join(', '),
  ...
  other: {
    ...
    'DC.type': 'Service',
    'DC.format': 'text/html',
    'DC.identifier': 'https://www.climgo.fr/arcachon-chauffage-climatisation',
  ...
  alternates: {
    canonical: 'https://www.climgo.fr/arcachon-chauffage-climatisation',
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Expert chauffage et climatisation à Arcachon. Installation, dépannage et entretien de systèmes de chauffage et pompes à chaleur.",
              "url": "https://www.climgo.fr/arcachon-chauffage-climatisation",
              ...
              "makesOffer": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Installation de pompes à chaleur air/eau et air/air à Arcachon"
                  },
                  "price": "8000",
                  "priceCurrency": "EUR"
                },
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Service de dépannage chauffage 24h/7j à Arcachon"
                  },
                  "price": "120",
                  "priceCurrency": "EUR"
                }
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Quel est le prix d'une pompe à chaleur à Arcachon ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Le prix d'une pompe à chaleur à Arcachon varie entre 8 000€ et 15 000€. ClimGO vous propose un devis gratuit et vous accompagne pour les aides financières."
                  }
                },
                {
                  "@type": "Question",
                  "name": "ClimGO intervient-il en urgence à Arcachon ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Oui, ClimGO propose un service d'urgence 24h/7j à Arcachon. Contactez-nous au 07 66 46 00 08 pour une intervention rapide."
                  }
                }
              ]
            })
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 3,
                  "name": "Arcachon",
                  "item": "https://www.climgo.fr/arcachon-chauffage-climatisation"
                }
              ]
            })
          }}
