...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'entretien climatisation bouliac', 'réparation PAC bouliac',
    
    // Urgences
    'chauffagiste urgence bouliac', 'dépannage 24h bouliac',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LocalBusiness",
              "name": "ClimGO Bouliac",
              "description": "Expert chauffage et climatisation à Bouliac. Installation, dépannage et entretien de systèmes de chauffage et pompes à chaleur.",
              "url": "https://climgo.fr/bouliac-chauffage-climatisation",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Quel est le prix d'une pompe à chaleur à Bouliac ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Le prix d'une pompe à chaleur à Bouliac varie entre 8 000€ et 15 000€. ClimGO vous propose un devis gratuit et vous accompagne pour les aides financières."
                  }
                },
                {
                  "@type": "Question",
                  "name": "ClimGO intervient-il en urgence à Bouliac ?",
                  "acceptedAnswer": {
                    "@type": "Answer",
