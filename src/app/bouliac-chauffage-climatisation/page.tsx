...
export default function Bouliac() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Bouliac - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Bouliac, entre vignobles et panorama sur Bordeaux
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Bouliac offre un <strong className="text-gray-900 dark:text-white">cadre résidentiel paisible avec vue sur Bordeaux</strong>, idéal pour des solutions de chauffage et climatisation haut de gamme.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  ClimGO intervient à Bouliac pour proposer des <strong className="text-gray-900 dark:text-white">équipements thermiques adaptés à l'architecture résidentielle locale</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Bouliac, surnommée le <strong className="text-gray-900 dark:text-white">balcon de Bordeaux</strong>, offre un panorama exceptionnel sur la ville tout en conservant une ambiance de village résidentiel haut de gamme.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Sa situation sur les coteaux attire des <strong className="text-gray-900 dark:text-white">familles en quête de tranquillité et de qualité de vie</strong>.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Entre <strong className="text-gray-900 dark:text-white">demeures en pierre, lotissements récents et maisons d'architectes</strong>, la diversité des logements exige des solutions personnalisées.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Du centre-bourg aux hauteurs du <strong className="text-gray-900 dark:text-white">chemin de Carbonnieu</strong>, avec des équipements discrets, performants et parfaitement intégrés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Notre expérience à Bouliac garantit une <strong className="text-gray-900 dark:text-white">installation discrète, efficace et parfaitement intégrée</strong> à votre cadre de vie.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Balcon de Bordeaux</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Cadre résidentiel paisible avec vue sur Bordeaux, idéal pour solutions chauffage et climatisation haut de gamme. Architecture résidentielle locale adaptée.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Village Résidentiel Haut de Gamme</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Panorama exceptionnel sur la ville conservant ambiance de village résidentiel haut de gamme. Situation sur les coteaux attire familles en quête tranquillité et qualité de vie.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Diversité Logements</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Demeures en pierre, lotissements récents et maisons d'architectes : diversité des logements exige des solutions de chauffage et climatisation personnalisées.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Centre-bourg aux hauteurs du chemin de Carbonnieu : équipements discrets, performants et parfaitement intégrés à l'environnement avec installations discrètes et efficaces.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une commune en belvédère sur Bordeaux
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Bouliac, surnommée le <strong className="text-gray-900 dark:text-white">balcon de Bordeaux</strong>, offre un panorama exceptionnel sur la ville.
                      </p>
                      <p>
                        Sa situation sur les coteaux attire des <strong className="text-gray-900 dark:text-white">familles en quête de tranquillité</strong> et de qualité de vie.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples d'interventions à Bouliac
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue de la Garenne :</strong> remplacement système fioul par PAC air/eau avec plancher chauffant.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Lotissement du Hameau :</strong> climatisation réversible dans maison de plain-pied récente.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Rue de la Libération :</strong> installation split gainable avec régulation pièce par pièce.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une expertise locale adaptée aux coteaux
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Le <strong className="text-gray-900 dark:text-white">relief prononcé et nature argilo-calcaire</strong> du sol imposent une attention particulière à la stabilité.
                      </p>
                      <p>
                        ClimGO adapte chaque installation selon <strong className="text-gray-900 dark:text-white">l'exposition, le vis-à-vis et les contraintes architecturales</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Et si on parlait de votre projet à Bouliac ?
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Vous vivez à Bouliac ou venez d'acquérir une <strong className="text-gray-900 dark:text-white">maison sur les hauteurs</strong> ?
                      </p>
                      <p>
                        Nos équipes sont disponibles pour vous conseiller et établir un <strong className="text-gray-900 dark:text-white">devis gratuit adapté</strong> à votre confort et budget.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Bouliac ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {/* Pourquoi choisir ClimGO à Bouliac - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Faire le choix de la <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">proximité, du conseil et d'un savoir-faire reconnu</strong> à Bouliac.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nos équipements s'intègrent dans tous les types de <strong className="text-gray-900 dark:text-gray-300">logements bouliacais avec discrétion et performance</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    ClimGO vous accompagne de A à Z, avec un <strong className="text-gray-900 dark:text-gray-300">service rapide, soigné et démarches simplifiées</strong> pour vos aides.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Adaptation selon <strong className="text-gray-900 dark:text-gray-300">l'exposition, le vis-à-vis et les contraintes architecturales</strong> du quartier, préservant l'esthétique des façades.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Bouliac
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Bouliac</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="bouliac" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Bouliac,France&zoom=13&center=44.8083,-0.4522`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Bouliac, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Bouliac et ses quartiers"
