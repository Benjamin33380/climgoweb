...
export default function LeBarp() {
  ...
  return (
    <main className="px-0">
        ...
        <div className="relative z-10 flex h-full items-center">
          ...
          >
            ...
            <p className="text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl text-white/90 sm:text-black/90 dark:text-white/90 mb-3 sm:mb-4 md:mb-6 lg:mb-8 leading-relaxed max-w-[280px] sm:max-w-sm md:max-w-lg lg:max-w-none whitespace-pre-line">
              Val de l'Eyre, entre forêts{'\n'}rivières et sentiers boisés
            </p>
      ...
      {/* Section Le Barp - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Val de l'Eyre, Habitant du Barp
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Située au cœur du Val de l'Eyre, la commune du Barp se distingue par son <strong className="text-gray-900 dark:text-white">environnement naturel remarquable</strong>, entre forêts de pins, rivières et sentiers boisés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Ce secteur, prisé pour son <strong className="text-gray-900 dark:text-white">calme et sa qualité de vie</strong>, attire aussi bien les familles que les jeunes actifs souhaitant conjuguer confort et nature.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Situé <strong className="text-gray-900 dark:text-white">entre Cestas et Salles</strong>, Le Barp bénéficie d'une situation privilégiée aux portes du parc naturel régional des Landes de Gascogne.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Le centre-bourg, les lotissements comme <strong className="text-gray-900 dark:text-white">Le Bourdieu ou Les Ecureuils</strong>, ainsi que les zones pavillonnaires récentes profitent d'un bon dynamisme résidentiel.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous résidiez au centre-ville, à Haureuils, ou dans les hameaux environnants, ClimGO vous propose des <strong className="text-gray-900 dark:text-white">solutions de chauffage, climatisation et eau chaude sanitaire</strong> pensées pour répondre aux besoins spécifiques des maisons du Val de l'Eyre.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Entre <strong className="text-gray-900 dark:text-white">humidité, résine de pins et sols instables</strong>, Le Barp exige une installation précise et soignée avec plots béton adaptés.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nos <strong className="text-gray-900 dark:text-white">systèmes sont conçus pour durer</strong> dans le temps, avec des solutions compatibles maison à étage, plain-pied, ou extension bois.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions au Barp
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Notre expertise couvre l'ensemble des quartiers du Barp, des lotissements récents aux secteurs traditionnels. Que vous habitiez dans une maison neuve ou ancienne, nous adaptons nos solutions à chaque type d'habitat.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Village Nature Privilégié</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Environnement naturel remarquable entre forêts de pins, rivières et sentiers boisés. Secteur prisé pour calme et qualité de vie, familles et jeunes actifs conjuguant confort et nature.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Situation Stratégique</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Situé entre Cestas et Salles, situation privilégiée aux portes du parc naturel régional des Landes de Gascogne. Lotissements Le Bourdieu, Les Ecureuils, zones pavillonnaires récentes avec dynamisme résidentiel.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Solutions Spécialisées</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Centre-ville, Haureuils, hameaux environnants : solutions chauffage, climatisation et eau chaude sanitaire pensées pour besoins spécifiques des maisons du Val de l'Eyre.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Expertise Environnement Forestier</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Humidité, résine de pins et sols instables : installation précise et soignée avec plots béton adaptés. Systèmes conçus pour durer, solutions compatibles maison à étage, plain-pied, extension bois.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un village nature entre Bordeaux et Landes
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Situé entre Cestas et Salles, Le Barp bénéficie d'une <strong className="text-gray-900 dark:text-white">situation privilégiée aux portes du parc naturel régional</strong> des Landes de Gascogne.
                      </p>
                      <p>
                        Avec plus de 5 000 habitants, la commune séduit par sa <strong className="text-gray-900 dark:text-white">tranquillité, ses espaces boisés</strong> et son accessibilité directe via la RN250.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions au Barp
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Quartier Le Bourg :</strong> climatisation gainable dans maison en pierre.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Lotissement Les Chênes :</strong> chauffe-eau thermodynamique dans maison neuve RT2012.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Route de Salles :</strong> maintenance complète installation chauffage-clim multi-marques.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une approche technique pour un environnement forestier
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Entre <strong className="text-gray-900 dark:text-white">humidité, résine de pins et sols instables</strong>, Le Barp exige une installation précise et soignée.
                      </p>
                      <p>
                        Chez ClimGO, nous prévoyons <strong className="text-gray-900 dark:text-white">plots béton adaptés, gaines protégées</strong> et équipements traités anticorrosion.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Votre projet au Barp mérite une solution ClimGO
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Pour une <strong className="text-gray-900 dark:text-white">climatisation réversible, une pompe à chaleur</strong> ou un chauffe-eau performant, contactez notre équipe.
                      </p>
                      <p>
                        Nous vous accompagnons <strong className="text-gray-900 dark:text-white">pas à pas dans votre projet thermique</strong> au Barp.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO au Barp ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                En faisant appel à ClimGO, vous bénéficiez d'un accompagnement de proximité, pensé pour les spécificités du Barp et ses alentours. Nos techniciens sont certifiés RGE et QualiPAC.
              </p>
            </div>
            
            {/* Pourquoi choisir ClimGO au Barp - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Bénéficiez d'un <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">accompagnement de proximité</strong>, pensé pour les spécificités du Barp et ses alentours.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Nous utilisons uniquement du <strong className="text-gray-900 dark:text-gray-300">matériel rigoureusement sélectionné</strong> pour sa fiabilité et performance, garantissant qualité et durabilité.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Situés à proximité, nous <strong className="text-gray-900 dark:text-gray-300">intervenons rapidement</strong>, limitant les délais d'attente pour installation neuve ou maintenance.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique au Barp
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières au Barp</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="le-barp" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Le+Barp,France&zoom=13&center=44.6077,-0.7702`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention au Barp, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO au Barp et ses quartiers"
