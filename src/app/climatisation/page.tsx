              ...
              >
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="text-white text-sm mb-1">Appelez directement</p>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="text-white text-sm mb-1">Email professionnel</p>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="text-white text-sm mb-1">Notre localisation</p>
                      <span className="text-base font-medium text-white">28 rue de Cantelaude, 33380 Marcheprime</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="text-white text-sm mb-1">Horaires d'ouverture</p>
                      <span className="text-base font-medium text-white">Lun-Ven: 8h-18h</span>
                    </div>
                  </div>
                </div>
