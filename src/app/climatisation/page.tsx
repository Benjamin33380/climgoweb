    ...
    <div className="min-h-screen bg-[#F8F9F4] dark:bg-black dark:bg-black text-[#03144A] dark:text-white dark:text-white">
      ...
      <section className="py-24 relative">
        <div className="max-w-4xl mx-auto text-center px-6">
          <div className="bg-gradient-to-br from-[#2563EB]/5 to-[#03144A]/5 dark:from-[#2563EB]/10 dark:to-[#03144A]/10 rounded-3xl p-16 border border-[#03144A] dark:border-white/20 backdrop-blur-sm shadow-xl">
