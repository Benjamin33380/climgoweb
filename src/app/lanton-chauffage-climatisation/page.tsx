...
export default function Lanton() {
  ...
  return (
    <main className="px-0">
      ...
      {/* Section Lanton - Texte défilant au scroll */}
      <section className="relative py-12 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 mb-4">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 dark:text-white text-center">
            Bassin d'Arcachon, Habitant de Lanton
          </h2>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6 text-center pt-8 pb-20">
                <p className="text-lg text-gray-800 dark:text-gray-200 leading-normal">
                  Située entre Andernos et Audenge, Lanton est une <strong className="text-gray-900 dark:text-white">commune paisible du bassin d'Arcachon</strong>, réputée pour ses plages et ses sentiers côtiers.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Que vous habitiez à <strong className="text-gray-900 dark:text-white">Taussat, Cassy ou au centre-ville</strong>, ClimGO vous accompagne avec des solutions de chauffage et de climatisation sur mesure.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Située au bord du bassin d'Arcachon, Lanton est une <strong className="text-gray-900 dark:text-white">commune calme et prisée</strong> pour son authenticité et sa qualité de vie.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Avec ses hameaux <strong className="text-gray-900 dark:text-white">(Cassy, Taussat, Blagon, Grand Lanton)</strong>, elle séduit aussi bien les familles que les retraités ou les jeunes actifs.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Nous accompagnons les <strong className="text-gray-900 dark:text-white">familles, retraités et nouveaux arrivants</strong> dans leurs projets d'installation, en respectant les zones naturelles protégées et les spécificités locales.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  L'<strong className="text-gray-900 dark:text-white">humidité de l'air marin, la proximité des pins</strong> et les variations de température imposent une sélection rigoureuse des équipements.
                </p>
                
                <p className="text-base text-gray-800 dark:text-gray-200 leading-normal">
                  Chaque intervention vise à <strong className="text-gray-900 dark:text-white">optimiser la performance énergétique</strong> de votre logement tout en préservant son intégration dans ce cadre naturel exceptionnel.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Nos interventions à Lanton
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                De Taussat à Cassy, nos équipes interviennent sur l'ensemble de Lanton. Nous nous adaptons aux particularités de chaque quartier, qu'il s'agisse de maisons anciennes ou de constructions neuves.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Commune Paisible du Bassin</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Située entre Andernos et Audenge, commune paisible du bassin d'Arcachon réputée pour ses plages et sentiers côtiers. Taussat, Cassy ou centre-ville avec solutions sur mesure.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Hameaux Authentiques</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Hameaux Cassy, Taussat, Blagon, Grand Lanton séduit familles, retraités et jeunes actifs. Équilibre entre maisons anciennes, villas récentes et programmes neufs avec plages paisibles.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center mb-16">
                ...
                <div className="w-5/12 pr-8 text-right">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Accompagnement Personnalisé</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Familles, retraités et nouveaux arrivants dans projets d'installation, respectant zones naturelles protégées et spécificités locales. Performance énergétique préservant intégration naturelle.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-5/12 ml-auto pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Expertise Littorale Adaptée</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    Humidité air marin, proximité pins et variations température imposent sélection rigoureuse équipements. PAC et climatiseurs traités pour résister conditions côtières, pilotage à distance.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex space-x-8 min-w-max px-4" style={{ marginLeft: 'calc(50% - 144px)', marginRight: 'calc(50% - 144px)' }}>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Un village côtier entre tradition et modernité
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      <p>
                        On y trouve un bon équilibre entre <strong className="text-gray-900 dark:text-white">maisons anciennes, villas récentes</strong> et programmes neufs avec plages paisibles.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Exemples concrets d'interventions à Lanton
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Cassy :</strong> installation pompe à chaleur air/air pour pavillon des années 90.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Taussat :</strong> pose chauffe-eau thermodynamique dans maison secondaire près du port.</p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Grand Lanton :</strong> remplacement ancien climatiseur par modèle plus silencieux.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Une expertise pensée pour le Bassin
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        L'<strong className="text-gray-900 dark:text-white">humidité de l'air marin, la proximité des pins</strong> et les variations de température imposent une sélection rigoureuse des équipements.
                      ...
                      <p>
                        Nous choisissons des <strong className="text-gray-900 dark:text-white">PAC et climatiseurs spécialement traités</strong> pour résister aux conditions côtières.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-72 flex-shrink-0 bg-white dark:bg-black rounded-2xl md:shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                      Envie d'un projet bien pensé à Lanton ?
                    </h3>
                    <div className="space-y-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <p>
                        Faites appel à ClimGO pour votre projet de <strong className="text-gray-900 dark:text-white">chauffage, climatisation ou chauffe-eau</strong> à Lanton.
                      </p>
                      <p>
                        Nous vous conseillons avec précision et <strong className="text-gray-900 dark:text-white">intervenons rapidement</strong>, que vous habitiez Cassy, Taussat ou Grand Lanton.
                      </p>
                      <div className="mt-4">
                        <a
                          href="/contact"
      ...
      <section className="relative py-24 overflow-hidden bg-white dark:bg-black" id="why-choose-section">
        <SimpleWrapper>
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-medium text-gray-900 dark:text-white mb-6">
                Pourquoi choisir ClimGO à Lanton ?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Choisir ClimGO à Lanton, c'est s'assurer d'un service de proximité, respectueux de l'environnement local et des contraintes climatiques du bassin.
              </p>
            </div>
            
            {/* Pourquoi choisir ClimGO à Lanton - Version personnalisée */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 md:mb-12 lg:mb-16">
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30 hover:border-[#0ea5e9]/50 dark:hover:border-[#38bdf8] min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    S'assurer d'un <strong className="text-[#0ea5e9] dark:text-[#38bdf8]">service de proximité</strong>, respectueux de l'environnement local et des contraintes climatiques du bassin.
                  </p>
                </div>
              </div>

              {/* Réactivité et Exigence */}
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre <strong className="text-gray-900 dark:text-gray-300">réactivité et notre exigence</strong> font la différence à chaque étape de votre projet à Lanton.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    <strong className="text-gray-900 dark:text-gray-300">Matériaux performants, normes rigoureuses</strong> et finitions impeccables : chaque projet traité avec la plus grande exigence.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-black backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-600/30  min-h-[320px] md:min-h-[380px] lg:min-h-[420px] flex flex-col">
                <div className="text-center flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6 flex-grow">
                    Notre proximité nous permet d'<strong className="text-gray-900 dark:text-gray-300">intervenir rapidement</strong> sur tout Lanton, pour dépannages ou installations urgentes.
                  </p>
                </div>
              </div>
            </div>
          ...
          <SimpleWrapper>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Des solutions complètes et personnalisées pour votre confort thermique à Lanton
              </p>
            </div>
          </SimpleWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <SimpleWrapper>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-black dark:text-white mb-4 text-center">Aides financières à Lanton</h3>
                <p className="text-black/90 dark:text-white/90 leading-relaxed text-center text-lg flex-grow">
      ...
      <FAQChat title="Questions Fréquentes"
        ...
        email="contact@climgo.fr" citySlug="lanton" />
          ...
          <SimpleWrapper>
            <div className="relative w-full">
              ...
              <div className="relative w-full h-[600px] transform hover:scale-[1.02] transition-transform duration-700 ease-out">
                <iframe
                  src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}&q=Lanton,France&zoom=13&center=44.7056,-1.0300`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="ClimGO - Zone d'intervention à Lanton, Gironde"
                  aria-label="Carte Google Maps montrant la zone d'intervention de ClimGO à Lanton et ses quartiers"
